...
void func_106()
{
	iLocal_53 = joaat("s_m_m_strpreach_01");
	StringCopy(&Local_251, "PBJE", 8);
	StringCopy(&Local_253, "JEROME", 16);
	StringCopy(&Local_219, "Special_Ped@jerome", 64);
	...
	StringCopy(&cLocal_341, "special_ped@jerome@base", 64);
	StringCopy(&cLocal_357, "special_ped@jerome@intro", 64);
	bLocal_456 = false;
	iLocal_268 = 6;
	iLocal_272[0] = 9;
	iLocal_272[1] = 9;
