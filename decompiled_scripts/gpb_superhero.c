...
void func_21(char* sParam0)
{
	...
	*sParam0 = { Var0 };
	...
	StringIntConCat(sParam0, iLocal_316[func_22()], 16);
}
...
void func_105()
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_257, false))
	{
		AUDIO::ADD_ENTITY_TO_AUDIO_MIX_GROUP(iLocal_257, "MAG_2_RAGE_PED_GROUP", 0f);
	}
}

void func_106()
{
	iLocal_53 = joaat("u_m_y_imporage");
	StringCopy(&Local_251, "PBSH", 8);
	StringCopy(&Local_253, "IMPORAGE", 16);
	StringCopy(&Local_219, "Special_Ped@Impotent_Rage", 64);
	StringCopy(&Local_235, "Base", 64);
	bLocal_453 = true;
	bLocal_455 = true;
	iLocal_269 = 15;
	iLocal_270 = 6;
	sLocal_320 = "PBSH_INTERACT";
	StringCopy(&Local_329, "PBSH_CONV_M1", 16);
	StringCopy(&Local_333, "PBSH_CONV_T1", 16);
	StringCopy(&Local_337, "PBSH_CONV_F1", 16);
	StringCopy(&cLocal_341, "special_ped@Impotent_Rage@base", 64);
	StringCopy(&cLocal_357, "special_ped@Impotent_Rage@intro", 64);
	iLocal_268 = 11;
	iLocal_272[0] = 4;
	iLocal_272[1] = 3;
	iLocal_272[2] = 4;
