...
void __EntryFunction__()
{
	...
	uLocal_109 = func_304(68);
	iLocal_110 = joaat("landstalker");
	Local_111 = { -1473.376f, 517.8441f, 116.8854f };
	fLocal_114 = 97.3011f;
	iLocal_115 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_114050[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_300(&(Global_114050[Var0.f_0 /*10*/].f_9));
			}
		}
		func_282(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_211(Var0.f_0);
		func_204(&iLocal_115, &(Var0.f_9), Var61);
		if (Var0.f_0 == 8)
		{
			func_200(&Var0, Var61, "DREY1AU", "DREY1_IDLE", 3, "DREYFUSS", 5000, 1101004800);
		}
		if (func_194(&Var0, 0) || func_182())
		{
			if (!func_2(&Var0))
			{
				func_282(&Var0, 1);
...
int func_182()
{
	if (func_185(2))
	{
		if (func_184(PLAYER::PLAYER_PED_ID(), -1459.68f, 485.26f, 116.22f, 1) < 6f && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
		{
			...
			else if ((!func_183(PLAYER::PLAYER_PED_ID(), joaat("script_task_leave_any_vehicle")) && func_138(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_161(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_193()) || Global_33818) || func_192()) || func_191(8, -1)) || func_189()) || func_102()) || func_190()) || func_188()) || Global_114963.f_7697.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_193()) || Global_114010) || Global_33818) || func_192()) || func_191(8, -1)) || func_189()) || func_102()) || func_190()) || func_188()) || Global_114963.f_7697.f_919[bVar0] == 5) || Global_45468 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_193()) || Global_114010) || Global_33818) || func_192()) || func_191(8, -1)) || func_102()) || func_190()) || func_188()) || Global_114963.f_7697.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_193() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_191(8, -1)) || func_188()) || func_187()) || Global_114963.f_7697.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, false, true, 0))
				{
					if (func_138(iParam0->f_28[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], true), true) < 3f)
						{
							if (func_185(2))
							{
								if (func_198(iParam0->f_27))
								{
									func_197(iParam0->f_27, *iParam0);
...
int func_200(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_138(PLAYER::PLAYER_PED_ID()) && func_138(iParam0->f_28[0])) && !func_158()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_184(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_204(int iParam0, char* sParam1, struct<3> Param2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_184(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_207(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_184(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_209(iParam0);
				}
			}
...
void func_282(int iParam0, bool bParam1)
{
	...
	func_283(sVar0);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_110, false);
