...
void __EntryFunction__()
{
	...
	fLocal_230 = 0f;
	iLocal_286 = 1;
	Local_544 = { 0f, -0.7f, 1f };
	Local_547 = { 0f, -0.8f, 1f };
	fLocal_562 = -1f;
	fLocal_563 = -1f;
	iLocal_635 = 3000;
	iLocal_636 = -1;
	...
	bVar2 = true;
	Local_539 = { ENTITY::GET_ENTITY_COORDS(iScriptParam_0, true) };
	Local_539.f_2 = (Local_539.f_2 + 1f);
	if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() != 4)
	{
		Local_550 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iScriptParam_0, Local_544) };
	}
	else
	{
		Local_550 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iScriptParam_0, Local_547) };
	}
	if (MISC::GET_GROUND_Z_FOR_3D_COORD(Local_550, &fVar3, false, false))
	{
		Local_550.f_2 = (fVar3 + 1f);
	}
	SYSTEM::SETTIMERA(0);
	AUDIO::HINT_SCRIPT_AUDIO_BANK("ATM", false, -1);
	while (bVar2)
	{
		iLocal_635 = (iLocal_635 + SYSTEM::ROUND((0f + (1000f * SYSTEM::TIMESTEP()))));
		bVar4 = false;
		SYSTEM::SETTIMERA(0);
		...
		if (((ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false)) && !CUTSCENE::IS_CUTSCENE_PLAYING()) && PLAYER::IS_PLAYER_PLAYING(PLAYER::GET_PLAYER_INDEX()))
		{
			if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == iVar1 && !PED::IS_PED_JUMPING(PLAYER::PLAYER_PED_ID()))
			{
				if (!func_97(15))
				{
					if (!Global_114963.f_20573.f_100)
					{
					...
					{
						Global_114963.f_20573.f_100 = 1;
					}
				}
				if ((((((((((((((!PED::IS_PED_USING_ANY_SCENARIO(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !func_82(0)) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_539, 1f, 1f, 1f, false, true, 1)) && !PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false)) && !func_81()) && !func_80(iScriptParam_0, 0)) && !func_79()) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 4f) && func_76(PLAYER::PLAYER_ID()) != 171) && !func_75(Global_4718592.f_197291)) && !func_74(Global_4718592.f_197291)) && !func_73(Global_4718592.f_197291)) && !BitTest(Global_4718592.f_29, 1)) && !func_72(PLAYER::PLAYER_ID()))
				{
					if (TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_539, 2f, false))
					{
						bVar5 = false;
					}
					bVar6 = false;
					...
					if (TASK::IS_SCENARIO_OCCUPIED(Local_539, 2f, true))
					{
						bVar6 = true;
					}
					if (Global_80337)
					...
					if (!bVar6)
					{
						if (iLocal_636 == -1)
						{
							func_69(&iLocal_636, 4, "FINH_ATMNEAR", 0, 0, 0, 0);
						}
						bVar4 = true;
						if (func_68(iLocal_636, 1))
						{
							Global_45889 = 1;
							...
							if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
							{
								...
								if (func_62(0, &Var7))
								{
									TASK::TASK_GO_STRAIGHT_TO_COORD(PLAYER::PLAYER_PED_ID(), Local_550, 1f, 5000, ENTITY::GET_ENTITY_HEADING(iScriptParam_0), 0.25f);
									iLocal_542 = 0;
								}
							}
							SYSTEM::WAIT(100);
							...
							if (!PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), true))
							{
								if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
								{
									iLocal_558 = func_61(1, 1, 1, 1);
									iLocal_641 = 1;
									if (Global_80337)
									{
										iLocal_599[NETWORK::PARTICIPANT_ID_TO_INT()] = 1;
										...
										if (!PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), true))
										{
											...
											if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
											{
												if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
												{
													...
													if (func_62(3, &Var7))
													{
														if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_543))
														{
															PED::DETACH_SYNCHRONIZED_SCENE(iLocal_543);
															iLocal_543 = -1;
														}
														iLocal_543 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_550, ENTITY::GET_ENTITY_ROTATION(iScriptParam_0, 2), 2, false, false, 1f, 0f, 1f);
														NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_543, &Var7, "exit", 8f, -4f, 5, 0, 1000f, 0);
														NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_543);
														STREAMING::REMOVE_ANIM_DICT(&Var7);
													}
												}
											}
									...
									if (Global_80337)
									{
										iLocal_599[NETWORK::PARTICIPANT_ID_TO_INT()] = 0;
									}
									iLocal_641 = 0;
								}
							}
...
void func_6(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	Global_62244 = 1;
	bVar0 = false;
	iLocal_637 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("ATM");
	iLocal_638 = GRAPHICS::REQUEST_SCALEFORM_MOVIE_INSTANCE("INSTRUCTIONAL_BUTTONS");
	if (func_60(iParam2))
	{
		if (func_59(4))
		{
	...
	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_637) && !func_63(iParam2, 1))
	{
		SYSTEM::WAIT(0);
		func_55();
		func_54(iParam2);
	}
	while (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(iLocal_638) && !func_63(iParam2, 1))
	{
		SYSTEM::WAIT(0);
		func_55();
		func_54(iParam2);
	...
	while (bVar4)
	{
		iLocal_634 = (iLocal_634 + SYSTEM::ROUND((0f + (1000f * SYSTEM::TIMESTEP()))));
		func_39();
		...
		if (MISC::GET_GAME_TIMER() > iVar2)
		{
			GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_638, 255, 255, 255, 255, 0);
			...
			if (((PAD::IS_CONTROL_JUST_PRESSED(2, 202) || PAD::IS_CONTROL_JUST_PRESSED(2, 238)) || iVar6) && bVar5)
			{
				...
				if (Global_80337)
				{
					switch (*iParam1)
					{
						case 0:
							bVar4 = false;
							iLocal_558 = func_61(0, 1, iLocal_558, 1);
							break;
				...
				{
					iLocal_558 = func_61(0, 1, iLocal_558, 0);
					bVar4 = false;
				}
			}
		}
		if (!bVar5)
		{
			if (!Global_80337)
			{
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_637, "SET_DATA_SLOT_EMPTY");
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
				func_31(iLocal_637);
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_637, "UPDATE_TEXT");
				GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			}
			bVar5 = true;
		}
		if (Global_80337)
		{
			if (iLocal_644)
			{
				...
				{
					iLocal_644 = 0;
					func_25(iParam2, iLocal_637, iParam1);
				}
			}
		}
		if (Global_80337)
		...
		if ((!bVar0 && !Global_80337) && !bParam3)
		{
			if (!PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), true))
			{
				TASK::CLEAR_PED_TASKS_IMMEDIATELY(PLAYER::PLAYER_PED_ID());
			}
			TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(PLAYER::PLAYER_PED_ID(), Local_539, 2f, -1);
			bVar0 = true;
		}
		func_54(iParam2);
	}
	...
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_637);
	GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&iLocal_638);
	iLocal_637 = 0;
	iLocal_638 = 0;
	Global_62244 = 0;
}
...
void func_8(int iParam0)
{
	...
	if (PAD::IS_USING_KEYBOARD_AND_MOUSE(2))
	{
		...
		fVar2 = (1f + (Global_77534 * SYSTEM::TIMESTEP()));
...
void func_9(int iParam0, var uParam1)
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_637, "SET_INPUT_SELECT");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_637, "GET_CURRENT_SELECTION");
	...
	iLocal_643 = GRAPHICS::GET_SCALEFORM_MOVIE_METHOD_RETURN_VALUE_INT(iVar0);
	switch (*uParam1)
	{
		case 0:
			switch (iLocal_643)
		...
		case 3:
			...
			else
			{
				switch (iLocal_643)
				{
					...
					case 1:
						func_23(uParam1, 5);
						iLocal_639 = func_20(0, 1);
						break;
					
					case 2:
						func_23(uParam1, 5);
						iLocal_639 = func_20(1, 1);
						break;
					
					case 3:
						func_23(uParam1, 5);
						iLocal_639 = func_20(2, 1);
						break;
					
					case 5:
						func_23(uParam1, 5);
						iLocal_639 = func_20(3, 1);
						break;
					
					case 6:
						func_23(uParam1, 5);
						iLocal_639 = func_20(4, 1);
						break;
					
					case 7:
						func_23(uParam1, 5);
						iLocal_639 = func_20(5, 1);
						break;
					}
			}
			return;
		...
		case 7:
			...
			else
			{
				switch (iLocal_643)
				{
					...
					case 1:
						func_23(uParam1, 9);
						iLocal_639 = func_20(0, 0);
						break;
					
					case 2:
						func_23(uParam1, 9);
						iLocal_639 = func_20(1, 0);
						break;
					
					case 3:
						func_23(uParam1, 9);
						iLocal_639 = func_20(2, 0);
						break;
					
					case 5:
						func_23(uParam1, 9);
						iLocal_639 = func_20(3, 0);
						break;
					
					case 6:
						func_23(uParam1, 9);
						iLocal_639 = func_20(4, 0);
						break;
					
					case 7:
						func_23(uParam1, 9);
						iLocal_639 = func_20(5, 0);
						break;
					}
			}
			return;
...
int func_10(int iParam0, int iParam1)
{
	...
	iLocal_642 = MONEY::WITHDRAW_VC(iParam1);
	bLocal_557 = true;
	if (Global_80337 && NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		func_11(1920, 1, -1);
	...
	if (MISC::IS_PC_VERSION())
	{
		if (iLocal_561 == 0)
		{
			if (PAD::IS_USING_KEYBOARD_AND_MOUSE(2))
			{
				if (fLocal_562 == -1f)
				{
					fLocal_562 = PAD::GET_CONTROL_NORMAL(2, 239);
					fLocal_563 = PAD::GET_CONTROL_NORMAL(2, 240);
				}
				else if (fLocal_562 != PAD::GET_CONTROL_NORMAL(2, 239) || fLocal_563 != PAD::GET_CONTROL_NORMAL(2, 240))
				{
					GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SHOW_CURSOR");
...
void func_25(int iParam0, int iParam1, var uParam2)
{
	...
	switch (*uParam2)
	{
		...
		case 5:
			...
			HUD::ADD_TEXT_COMPONENT_FORMATTED_INTEGER(iLocal_639, true);
			GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam1, "SET_DATA_SLOT");
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
...
int func_28(int iParam0)
{
	...
	iVar1 = (Global_2359296[func_29() /*5574*/].f_5397 - 1);
	if (iVar1 < 0)
	{
		iVar1 = 15;
	}
	...
	while (iVar2 > 0)
	{
		if (Global_2359296[func_29() /*5574*/].f_5397.f_1[iVar1] > 0 && Global_2359296[func_29() /*5574*/].f_5397.f_132[iVar1] != joaat("money_spent_betting"))
		{
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_DATA_SLOT");
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
			iVar3++;
			switch (Global_2359296[func_29() /*5574*/].f_5397.f_115[iVar1])
			{
				case 4:
				case 2:
				case 1:
			...
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_2359296[func_29() /*5574*/].f_5397.f_1[iVar1]);
			switch (Global_2359296[func_29() /*5574*/].f_5397.f_115[iVar1])
			{
				case 0:
				...
				case 2:
					...
					HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(&(Global_2359296[func_29() /*5574*/].f_5397.f_18[iVar1 /*6*/]));
					GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
					break;
				...
				case 5:
					if (Global_2359296[func_29() /*5574*/].f_5397.f_132[iVar1] != 0)
					{
						iVar4 = Global_2359296[func_29() /*5574*/].f_5397.f_132[iVar1];
						switch (iVar4)
						{
				...
				case 6:
					if (Global_2359296[func_29() /*5574*/].f_5397.f_132[iVar1] != 0)
					{
						iVar5 = Global_2359296[func_29() /*5574*/].f_5397.f_132[iVar1];
						switch (iVar5)
						{
...
void func_31(int iParam0)
{
	...
	iVar0 = Global_114963.f_28060[func_33() /*29*/].f_17;
	if (iVar0 == 4 || iVar0 == 3)
	{
		return;
	}
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_DATA_SLOT");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(3);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(SYSTEM::TO_FLOAT(Global_62237[iVar0]));
	func_30("W_BA_BAL");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	iVar1 = 4;
	iVar2 = 0;
	iVar3 = 0;
	iVar4 = 11;
	iVar4 = Global_114963.f_20573.f_233[iVar0 /*69*/];
	if (!iVar4 < 11)
	{
		iVar4 = 11;
	}
	iVar5 = (Global_114963.f_20573.f_233[iVar0 /*69*/].f_1 - 1);
	if (iVar5 > -1)
	{
		iVar2 = 0;
		while (iVar2 < iVar4)
		{
			...
			iVar3 = 0;
			if (Global_114963.f_20573.f_233[iVar0 /*69*/].f_2[iVar5 /*6*/] == 1)
			{
				iVar3 = 1;
			}
			GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iParam0, "SET_DATA_SLOT");
			...
			GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Global_114963.f_20573.f_233[iVar0 /*69*/].f_2[iVar5 /*6*/].f_2);
			func_30(func_32(Global_114963.f_20573.f_233[iVar0 /*69*/].f_2[iVar5 /*6*/].f_1));
			GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
			iVar5 = (iVar5 - 1);
			iVar1++;
			iVar2++;
...
void func_34()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_37(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_35(iVar0) && (!func_97(14) || Global_113909))
			{
				if (Global_114963.f_2370.f_539.f_4321 != iVar0 && func_35(Global_114963.f_2370.f_539.f_4321))
				{
...
void func_39()
{
	...
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(iLocal_637, 255, 255, 255, 255, 0);
	func_49();
	func_43(0);
	func_40(1);
	SYSTEM::WAIT(0);
...
int func_51()
{
	...
	if (iLocal_538 == 0)
	{
		iLocal_538 = ENTITY::GET_ENTITY_HEALTH(iVar0);
		return 0;
	}
...
void func_52(bool bParam0, bool bParam1)
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_638, "CLEAR_ALL");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_638, "SET_CLEAR_SPACE");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(200);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	if (MISC::IS_PC_VERSION())
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_638, "TOGGLE_MOUSE_BUTTONS");
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(true);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	}
	iVar0 = 0;
	if (Global_80337)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_638, "SET_DATA_SLOT");
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iVar0);
	...
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	iVar0++;
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(iLocal_638, "DRAW_INSTRUCTIONAL_BUTTONS");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
}
...
void func_54(int iParam0)
{
	...
	switch (iLocal_542)
	{
		case 0:
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&sVar0))
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(PLAYER::PLAYER_PED_ID(), joaat("script_task_go_straight_to_coord")) == 7 && STREAMING::HAS_ANIM_DICT_LOADED(&sVar0))
				{
					...
					iLocal_543 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_550, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, false, false, 1f, 0f, 1f);
					NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_543, &sVar0, "enter", 4f, -2f, 5, 0, 1000f, 0);
					NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_543);
		...
		case 1:
			...
			iVar65 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iLocal_543);
			...
			{
				iLocal_543 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_550, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, false, true, 1f, 0f, 1f);
				NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_543, &sVar16, "base", 4f, -2f, 5, 0, 1000f, 0);
				NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_543);
				iLocal_542 = 2;
			}
			break;
		...
		case 2:
			...
			iVar65 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iLocal_543);
			if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_543) && !PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar65))
			{
				iLocal_543 = NETWORK::NETWORK_CREATE_SYNCHRONISED_SCENE(Local_550, ENTITY::GET_ENTITY_ROTATION(iParam0, 2), 2, false, true, 1f, 0f, 1f);
				iVar65 = NETWORK::NETWORK_GET_LOCAL_SCENE_FROM_NETWORK_ID(iLocal_543);
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED(&sVar32) && (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iVar65) || PED::GET_SYNCHRONIZED_SCENE_PHASE(iVar65) >= 0.99f))
			{
				...
				if ((((MISC::ARE_STRINGS_EQUAL(&cLocal_553, "idle_a") && iVar66 == 0) || (MISC::ARE_STRINGS_EQUAL(&cLocal_553, "idle_b") && iVar66 == 1)) || (MISC::ARE_STRINGS_EQUAL(&cLocal_553, "idle_c") && iVar66 == 2)) || (MISC::ARE_STRINGS_EQUAL(&cLocal_553, "idle_d") && iVar66 == 3))
				{
					iVar66++;
					if (iVar66 >= iVar64)
					{
				...
				{
					case 0:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_543, &sVar32, "idle_a", 4f, -2f, 5, 0, 1000f, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_543);
						StringCopy(&cLocal_553, "idle_a", 16);
						iLocal_542 = 3;
						break;
					
					case 1:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_543, &sVar32, "idle_b", 4f, -2f, 5, 0, 1000f, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_543);
						StringCopy(&cLocal_553, "idle_b", 16);
						iLocal_542 = 3;
						break;
					
					case 2:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_543, &sVar32, "idle_c", 4f, -2f, 5, 0, 1000f, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_543);
						StringCopy(&cLocal_553, "idle_c", 16);
						iLocal_542 = 3;
						break;
					
					case 3:
						NETWORK::NETWORK_ADD_PED_TO_SYNCHRONISED_SCENE(PLAYER::PLAYER_PED_ID(), iLocal_543, &sVar32, "idle_d", 4f, -2f, 5, 0, 1000f, 0);
						NETWORK::NETWORK_START_SYNCHRONISED_SCENE(iLocal_543);
						StringCopy(&cLocal_553, "idle_d", 16);
						iLocal_542 = 3;
						break;
					
					default:
						StringCopy(&cLocal_553, "idle_XXX", 16);
						break;
					}
			}
			break;
...
void func_58(bool bParam0, bool bParam1)
{
	if (bParam1)
	{
		if (!BitTest(Global_98470, bParam0))
		{
			MISC::SET_BIT(&Global_98470, bParam0);
		}
	}
	else if (BitTest(Global_98470, bParam0))
	{
		MISC::CLEAR_BIT(&Global_98470, bParam0);
	}
}

bool func_59(int iParam0)
{
	return BitTest(Global_98471, iParam0);
}
...
int func_63(int iParam0, int iParam1)
{
	...
	{
		if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_539, 1.5f, 1.5f, 1.5f, false, true, 1))
		{
			return 1;
		}
	}
	...
	if (Global_80337 && func_65())
	{
		return 0;
	}
	if (!Global_80337 && func_64())
	{
		return 0;
	}
	if (Global_80337 && NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		while (iVar1 < 32)
		{
			if (iLocal_599[iVar1] && NETWORK::PARTICIPANT_ID_TO_INT() != iVar1)
			{
				return 1;
			}
			iVar1++;
...
int func_66()
{
	...
	if (iLocal_633 == 0)
	{
		...
		iLocal_633 = SHAPETEST::START_SHAPE_TEST_CAPSULE(Var0, Var0 - Vector(3f, 0f, 0f), 0.33f, 2, PLAYER::PLAYER_PED_ID(), 4);
		return iLocal_632;
	}
	else
	{
		iVar3 = 0;
		iVar11 = SHAPETEST::GET_SHAPE_TEST_RESULT(iLocal_633, &iVar3, &uVar4, &uVar7, &iVar10);
		if (iVar11 == 2)
		{
			iLocal_632 = 0;
			if (iVar3 != 0)
...
void func_102(char* sParam0, int iParam1)
{
	...
	while (iVar0 < Global_114963.f_20419.f_145)
	{
		if (MISC::ARE_STRINGS_EQUAL(sParam0, &(Global_114963.f_20419[iVar0 /*16*/])))
		{
			...
			func_103((Global_114963.f_20419.f_145 - 1));
...
void func_105()
{
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		...
		func_107(0, -1, 0);
		NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&iLocal_564, 35, 0);
		NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&iLocal_599, 33, 0);
		iVar0 = 0;
		while (iVar0 < 32)
		{
			iLocal_564[iVar0] = -1;
