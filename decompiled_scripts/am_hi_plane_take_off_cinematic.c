#region Local Var
	...
	var uLocal_127 = 0;
	var uLocal_128 = 0;
	struct<9> Local_129 = { 0, 0, 0, 0, 0, 1, 0, 0, 1 } ;
	var uLocal_138 = 0;
	var uLocal_139 = 0;
	var uLocal_140 = 0;
	var uLocal_141 = 0;
...
void func_304()
{
	...
	func_307(&Local_129, joaat("nimbus"), "Plane_1");
	ENTITY::SET_ENTITY_VISIBLE(PLAYER::PLAYER_PED_ID(), false, false);
	Local_129.f_8 = 0;
	iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, 100);
	if (iVar0 < 50)
	{
		func_305(&Local_129, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 1, 0);
	}
	else
	{
		func_305(&Local_129, 4105.583f, -4644.602f, 4.1196f, 11.1032f, -0.012f, 107.968f, "HS4_ISD_TAKE_NIMB2", 0, 1, 2, 0);
	}
}
