...
void __EntryFunction__()
{
	...
	uLocal_109 = func_324(58);
	iLocal_110 = joaat("felon2");
	iLocal_112 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_114050[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_320(&(Global_114050[Var0.f_0 /*10*/].f_9));
			}
		}
		func_303(&Var0, 1);
	}
	if (!func_300(&iVar64, &Var0, Var61, 1f))
	{
		func_299();
	...
	if (Var0.f_0 == 27)
	{
		func_269(&uLocal_114, 5, Var0.f_28[0], "JOSH", 0, 1);
	}
	else if (Var0.f_0 == 30)
	{
		func_269(&uLocal_114, 4, Var0.f_28[0], "JOSH", 0, 1);
		func_269(&uLocal_114, 3, Var0.f_28[1], "JOSHCOP", 0, 1);
	...
	while (true)
	{
		...
		if (!func_232(&Var0, 1))
		{
			if (Var0.f_0 == 30)
			{
				if (func_231(PLAYER::PLAYER_PED_ID(), -1102.724f, 290.1463f, 63.23002f, 1) < 200f)
				{
		...
		func_229(Var0.f_0);
		func_222(&iLocal_112, &(Var0.f_9), Var61);
		if (Var0.f_0 == 27)
		{
			func_220(&Var0, Var61, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (Var0.f_0 == 28)
		{
			func_220(&Var0, Var61, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (Var0.f_0 == 29)
		{
			func_220(&Var0, Var61, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (Var0.f_0 == 30)
		{
			if (iLocal_282 == 0)
		...
		if (((func_190(&Var0, 0) || func_189(&Var0)) || func_187(&Var0)) || func_185(&Var0))
		{
			if (func_184(Var0.f_0))
			{
				func_181(Var0.f_0, &iLocal_281);
			}
			if (!func_2(&Var0))
			{
				func_303(&Var0, 1);
...
int func_187(var uParam0)
{
	if (*uParam0 == 29)
	{
		if (func_231(PLAYER::PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			...
			else if ((!func_188(PLAYER::PLAYER_PED_ID(), joaat("script_task_leave_any_vehicle")) && func_219(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_160(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 1f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_189(var uParam0)
{
	if (*uParam0 == 28)
	{
		if (func_231(PLAYER::PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			...
			else if ((!func_188(PLAYER::PLAYER_PED_ID(), joaat("script_task_leave_any_vehicle")) && func_219(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false))) && func_160(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false), 4f, 1, 1056964608, 0, 1, 0))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
	...
	switch (uParam0->f_16)
	{
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					if (func_219(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), false)))
					{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_204()) || Global_114010) || Global_33818) || func_203()) || func_202(8, -1)) || func_102()) || func_201()) || func_200()) || func_199()) || Global_114963.f_7697.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_204()) || Global_33818) || func_203()) || func_202(8, -1)) || func_200()) || func_102()) || func_201()) || func_199()) || Global_114963.f_7697.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_204()) || Global_114010) || Global_33818) || func_203()) || func_202(8, -1)) || func_200()) || func_102()) || func_201()) || func_199()) || Global_114963.f_7697.f_919[bVar0] == 5) || Global_45468 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_204()) || Global_114010) || Global_33818) || func_203()) || func_202(8, -1)) || func_102()) || func_201()) || func_199()) || Global_114963.f_7697.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_204() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_202(8, -1)) || func_199()) || func_198()) || Global_114963.f_7697.f_919[bVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_205()
{
	...
	{
		case 0:
			if ((MISC::GET_GAME_TIMER() - iLocal_279) > 100 && bLocal_280 == 0)
			{
				iLocal_113 = 1;
			}
			break;
		...
		case 1:
			...
			{
				if (func_206(&uLocal_114, "JOSH4AU", "JOSH4_AMB", 8, 0, 0, 0))
				{
					iLocal_113 = 2;
				}
			}
...
int func_220(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_219(PLAYER::PLAYER_PED_ID()) && func_219(iParam0->f_28[0])) && !func_157()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_231(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_269(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
		func_221(&uVar0, cParam4, sParam5, 7, 0, 0);
...
void func_222(int iParam0, char* sParam1, struct<3> Param2)
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_231(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_225(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_231(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_227(iParam0);
				}
			}
...
int func_232(var uParam0, bool bParam1)
{
	...
	if ((func_268(*uParam0) || func_266(*uParam0)) || Global_80583 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_235(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_235(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), ENTITY::GET_ENTITY_COORDS(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					...
					if (func_260(*uParam0))
					{
						if (!func_170(*uParam0))
						{
							if (func_255(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_237(uParam0);
...
bool func_245(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_246(&(Local_54[iVar4 /*4*/]), Var1, iParam1, &(Local_54[iVar4 /*4*/].f_3), iParam0, iParam5);
...
void func_272(int* iParam0, bool bParam1)
{
	...
	func_273(iParam0, iLocal_110, Var0, fVar3);
...
int func_285(var uParam0)
{
	...
	switch (iLocal_108)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_277(&(uParam0->f_28[0]), 58, 566.1639f, -1773.817f, 29f, 14.4f, "JOSH LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
...
{
	func_273(iParam0, iLocal_110, 558.09f, -1765.39f, 28.86f, 335.3252f);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*iParam0, 4);
...
int func_287(var uParam0)
{
	...
	switch (iLocal_108)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_277(&(uParam0->f_28[0]), 58, 565.3901f, -1772.838f, 29.80087f, 62.50156f, "JOSH LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
		...
		case 3:
			if (func_219(uParam0->f_28[0]))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_28[0], iLocal_111, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1000f, 0);
			}
...
int func_300(int iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_301((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_301((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
