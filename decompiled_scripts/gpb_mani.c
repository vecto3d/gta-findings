...
void func_106()
{
	iLocal_53 = joaat("u_m_y_mani");
	StringCopy(&Local_251, "PBMN", 8);
	StringCopy(&Local_253, "MANI", 16);
	StringCopy(&Local_219, "Special_Ped@mani", 64);
	StringCopy(&Local_235, "Base", 64);
	bLocal_453 = !Global_4;
	iLocal_269 = 8;
	sLocal_320 = "PBMN_INTERACT";
	StringCopy(&Local_329, "PBMN_CONV_GM", 16);
	StringCopy(&Local_333, "PBMN_CONV_GT", 16);
	StringCopy(&Local_337, "PBMN_CONV_GF", 16);
	StringCopy(&cLocal_341, "special_ped@mani@base", 64);
	StringCopy(&cLocal_357, "special_ped@mani@intro", 64);
	iLocal_268 = 8;
	iLocal_272[0] = 6;
	iLocal_272[1] = 6;
	iLocal_272[2] = 6;
