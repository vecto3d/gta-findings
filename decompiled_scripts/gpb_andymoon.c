...
void func_106()
{
	iLocal_53 = joaat("u_m_y_hippie_01");
	StringCopy(&Local_251, "PBAM", 8);
	StringCopy(&Local_253, "ANDYMOON", 16);
	StringCopy(&Local_219, "Special_Ped@andy_moon", 64);
	StringCopy(&Local_235, "Base", 64);
	bLocal_453 = !Global_4;
	iLocal_269 = 15;
	sLocal_320 = "PBAM_INTERACT";
	StringCopy(&Local_329, "PBAM_CONV_GM", 16);
	StringCopy(&Local_333, "PBAM_CONV_GT", 16);
	StringCopy(&Local_337, "PBAM_CONV_GF", 16);
	StringCopy(&cLocal_341, "special_ped@andy_moon@base", 64);
	StringCopy(&cLocal_357, "special_ped@andy_moon@intro", 64);
	iLocal_268 = 0;
	iLocal_272[0] = 6;
	iLocal_272[1] = 7;
	iLocal_272[2] = 6;
