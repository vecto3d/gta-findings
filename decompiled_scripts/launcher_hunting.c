...
void __EntryFunction__()
{
	...
	uLocal_109 = func_289(54);
	iLocal_110 = joaat("dune");
	iLocal_111 = WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_sniperrifle"));
	iLocal_112 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(joaat("component_at_scope_large"));
	iLocal_113 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(joaat("component_at_ar_supp_02"));
	Local_114 = { -683.8261f, 5840.81f, 16.566f };
	iLocal_118 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_114050[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_285(&(Global_114050[Var0.f_0 /*10*/].f_9));
			}
		}
		func_273(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_209(Var0.f_0);
		func_202(&iLocal_118, &(Var0.f_9), Var61);
		if (Var0.f_0 == 25)
		{
			func_197(&Var0, Var61, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		}
		...
		if (func_182(&Var0, 0) && MISC::ABSF((Var61.f_2 - Var67.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_273(&Var0, 1);
...
int func_197(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_138(PLAYER::PLAYER_PED_ID()) && func_138(iParam0->f_28[0])) && !func_158()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_201(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_210(int iParam0, bool bParam1)
{
	...
	func_121(*iParam0, &Var0);
	if ((func_247(*iParam0) || func_245(*iParam0)) || Global_80583 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_214(&(iParam0->f_48)) && bParam1)
	{
		func_211(iParam0->f_28[0], &(iParam0->f_48), *iParam0);
	}
	return 1;
}
...
bool func_224(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_225(&(Local_54[iVar4 /*4*/]), Var1, iParam1, &(Local_54[iVar4 /*4*/].f_3), iParam0, iParam5);
...
{
	if ((func_246() && Global_102486.f_11 == 6) && iParam0 == func_180(&(Global_102486.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_249(var uParam0)
{
	...
	switch (iLocal_108)
	{
		...
		case 2:
			...
			{
				func_250(&(uParam0->f_35[0]), -685.2281f, 5833.982f, 16.331f, 313.2204f, 0);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_117))
			{
				iLocal_117 = WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_sniperrifle"), 0, Local_114, false, 1f, 0, 0, 1);
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iLocal_117, joaat("component_at_scope_large"));
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iLocal_117, joaat("component_at_ar_supp_02"));
			}
			if (bVar7)
			{
				iLocal_108 = 3;
		...
		case 3:
			...
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_114, 1f, iLocal_111, false))
			{
				ENTITY::SET_ENTITY_ROTATION(iLocal_117, 0f, -90f, -162.64f, 2, true);
			}
			iVar6 = 0;
			while (iVar6 <= (iVar0 - 1))
			{
...
void func_250(int* iParam0, struct<3> Param1, float fParam4, int iParam5)
{
	func_251(iParam0, iLocal_110, Param1, fParam4);
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
int func_257(var uParam0)
{
	...
	switch (iLocal_108)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_250(&(uParam0->f_35[0]), 1806.732f, 3934.353f, 33.3275f, 76.1155f, 0);
