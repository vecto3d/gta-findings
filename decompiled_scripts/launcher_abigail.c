...
void __EntryFunction__()
{
	...
	Local_109 = { -1593.813f, 5221.235f, 1.94482f };
	Local_112 = { -1603.986f, 5243.624f, 4.940323f };
	uLocal_115 = func_310(16);
	cLocal_116 = "rcmabigail";
	iLocal_117 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_114050[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_306(&(Global_114050[Var0.f_0 /*10*/].f_9));
			}
		}
		func_289(&Var0, 1);
	}
	iVar231[0] = 0;
	iVar231[1] = 1;
	if (!func_286(&iVar231, &Var0, Var61, 1f))
	{
		func_285();
	...
	while (true)
	{
		...
		func_227(Var0.f_0);
		func_220(&iLocal_117, &(Var0.f_9), Var61);
		switch (Var0.f_0)
		{
			case 0:
				func_206(&Var64, &(Var0.f_28[0]), "SONAR_PRE");
				break;
			
			case 1:
				func_201(&Var0, Var61, "SONARAU", "SONAR_CALL", 3, "ABIGAIL", 10000, 1101004800);
				break;
		}
		if (func_186(&Var0, 0))
		{
...
int func_124(int iParam0)
{
	...
	if (func_155(&(iParam0->f_1)))
	{
		...
		{
			func_144(1);
			func_142(iParam0, 1, func_143(*iParam0));
		}
		if (iParam0->f_27)
		{
			if (func_141(*iParam0))
...
int func_201(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	var uVar0;
	
	if ((((func_138(PLAYER::PLAYER_PED_ID()) && func_138(uParam0->f_28[0])) && !func_158()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_205(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_206(int iParam0, var uParam1, char* sParam2)
{
	if (func_138(*uParam1) && func_138(PLAYER::PLAYER_PED_ID()))
	{
		switch (*iParam0)
		{
			case 0:
				...
				func_204(&(iParam0->f_1), 3, *uParam1, "ABIGAIL", 0, 1);
				TASK::TASK_PLAY_ANIM(*uParam1, cLocal_116, "base", 1000f, -8f, -1, 1, 0f, false, false, false);
				*iParam0 = 1;
				break;
			...
			case 1:
				...
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_109, Local_112, 8f, false, true, 0))
					{
						TASK::TASK_PLAY_ANIM(*uParam1, cLocal_116, "intro", 8f, -8f, -1, 2, 0f, false, false, false);
						*iParam0 = 3;
					}
				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_116, "outro", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_116, "outro") > 0.99f)
				{
					TASK::TASK_PLAY_ANIM(*uParam1, cLocal_116, "base", 8f, -8f, -1, 1, 0f, false, false, false);
				}
				break;
			
			case 3:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_116, "intro", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_116, "intro") > 0.99f)
				{
					*iParam0 = 4;
				}
				break;
			...
			case 4:
				if (func_207(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_109, Local_112, 8f, false, true, 0))
					{
						TASK::TASK_PLAY_ANIM(*uParam1, cLocal_116, "loop_talk", 8f, -8f, -1, 1, 0f, false, false, false);
					}
					*iParam0 = 5;
				}
				break;
			...
			case 5:
				if (!func_158())
				{
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_116, "loop_talk", 3))
					{
						if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_116, "loop_talk") > 0.99f)
						{
							iParam0->f_166 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(7000, 10000));
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_109, Local_112, 8f, false, true, 0))
							{
								TASK::TASK_PLAY_ANIM(*uParam1, cLocal_116, "outro", 8f, -8f, -1, 2, 0f, false, false, false);
								*iParam0 = 1;
							}
							else
							{
								TASK::TASK_PLAY_ANIM(*uParam1, cLocal_116, "loop_look", 8f, -8f, -1, 1, 0f, false, false, false);
								*iParam0 = 2;
							}
						}
					}
			...
			case 2:
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam1, cLocal_116, "loop_look", 3) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(*uParam1, cLocal_116, "loop_look") > 0.99f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_109, Local_112, 8f, false, true, 0))
					{
						if (MISC::GET_GAME_TIMER() > iParam0->f_166)
...
int func_267(var uParam0)
{
	...
	switch (iLocal_108)
	{
		case 0:
			...
			func_274(&(uParam0->f_48), cLocal_116, "base", 0);
			iLocal_108 = 1;
			break;
		
		case 1:
			if (!func_273(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_116))
			{
				return 0;
			}
			iLocal_108 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_268(&(uParam0->f_35[0]), iVar0[1], -1584.013f, 5158.539f, 18.6057f, 210.5309f);
...
int func_270(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_271(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
int func_271(int* iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)
{
	int iVar0;
...
void func_274(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_275(var uParam0)
{
	...
	switch (iLocal_108)
	{
		...
		case 1:
			if (!STREAMING::HAS_MODEL_LOADED(iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_116))
			{
				return 0;
			}
			iLocal_108 = 2;
