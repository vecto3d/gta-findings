#region Local Var
	...
	int iLocal_112 = 0;
	int iLocal_113 = 0;
	struct<8> Local_114 = { 5, 0, 0, 0, 0, 0, 0, -1 } ;
	var uLocal_122 = 0;
	var uLocal_123 = 16;
	var uLocal_124 = 0;
	var uLocal_125 = 0;
...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_114050[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_324(&(Global_114050[Var0.f_0 /*10*/].f_9));
			}
		}
		func_307(&Var0, 1);
	}
	if (!func_304(&Var0, Var61, 1f))
	{
		func_303();
	...
	if (Var0.f_0 == 4)
	{
		func_270(&uLocal_123, 3, Var0.f_28[0], "BARRY", 0, 1);
	...
	while (true)
	{
		...
		if (!func_228(&Var0, Var0.f_0 != 2))
		{
			func_307(&Var0, 1);
		}
		func_227(Var0.f_0);
		func_220(&iLocal_110, &(Var0.f_9), Var61);
		if (func_219(Var0.f_28[0]))
		{
			if (Var0.f_0 == 2)
			{
				if (func_217(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
					func_216(&Var0, Local_114, 1, 0);
				}
			}
			else if (Var0.f_0 == 3)
			{
				if (func_217(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0.f_0 == 4)
			{
				func_201(&uLocal_122, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], true), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar64 = 0;
		if (func_200(Var0.f_0))
		{
		...
		if (func_185(&Var0, iVar64))
		{
			if (func_184(Var0.f_0))
			{
				func_181(Var0.f_0, &iLocal_113);
			}
			if (!func_2(&Var0))
			{
				func_307(&Var0, 1);
...
int func_124(int iParam0)
{
	...
	if (func_154(&(iParam0->f_1)))
	{
		...
		func_125(*iParam0);
		iVar0 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&(iParam0->f_1), iParam0, 61, 64500);
	...
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				...
				else if (func_219(iParam0->f_28[0]))
				{
					if (func_187(iParam0))
					{
						if (func_191(2))
...
void func_201(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5)
{
	switch (*uParam0)
	{
		case 0:
		...
		case 1:
			if (func_215(PLAYER::PLAYER_PED_ID(), Param1, 1) <= 20f)
			{
				if (func_202(&uLocal_123, cParam4, sParam5, 8, 0, 0, 0))
				{
					*uParam0 = 2;
				}
			}
		...
		case 2:
			...
			else if (func_215(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 25f)
			{
				func_155();
				*uParam0 = 0;
			}
...
void func_216(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)
{
	int iVar0;
	int iVar1;
	
	iVar1 = 32768;
	if (!func_219(iParam0->f_28[iParam10]))
	{
		return;
	}
	if (bParam9)
...
int func_217(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)
{
	...
	if ((((func_219(PLAYER::PLAYER_PED_ID()) && func_219(iParam0->f_28[0])) && !func_157()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_215(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_270(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
...
int func_228(int iParam0, bool bParam1)
{
	...
	func_121(*iParam0, &Var0);
	if ((func_265(*iParam0) || func_263(*iParam0)) || Global_80583 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_232(&(iParam0->f_48)) && bParam1)
	{
		func_229(iParam0->f_28[0], &(iParam0->f_48), *iParam0);
	}
	return 1;
}
...
bool func_242(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_243(&(Local_54[iVar4 /*4*/]), Var1, iParam1, &(Local_54[iVar4 /*4*/].f_3), iParam0, iParam5);
...
{
	if ((func_264() && Global_102486.f_11 == 6) && iParam0 == func_179(&(Global_102486.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_266()
{
	...
	if (func_219(PLAYER::PLAYER_PED_ID()))
	{
		if (func_267(PLAYER::PLAYER_PED_ID(), Var0, fVar3, 1))
		{
			func_163();
		}
	}
...
bool func_267(int iParam0, struct<3> Param1, float fParam4, bool bParam5)
{
...
int func_272(int iParam0)
{
	...
	{
		func_274(&Local_114);
		func_273(&Local_114, "democ_only_works");
		func_273(&Local_114, "gift_from_god");
		func_273(&Local_114, "rigged_vote");
		func_273(&Local_114, "suck_my");
		func_273(&Local_114, "tyranny");
	}
	func_325("Created initial scene");
	return 1;
}

void func_273(var uParam0, char* sParam1)
{
...
int func_276(var uParam0)
{
	...
	switch (iLocal_108)
	{
		...
		case 2:
			...
			{
				func_278(&(uParam0->f_35[0]), iVar0[0], Var4, fVar16);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
			...
			{
				func_277(&(uParam0->f_41[0]), iVar0[1], Var4 + Var10, 0f);
			...
			{
				func_278(&(uParam0->f_35[1]), iVar0[2], Var7, fVar17);
...
void func_278(int* iParam0, int iParam1, struct<3> Param2, float fParam5)
{
	func_279(iParam0);
...
int func_281(var uParam0)
{
	...
	switch (iLocal_108)
	{
		...
		case 2:
			bVar17 = true;
			func_278(&(uParam0->f_35[0]), iVar0[0], Var5, fVar14);
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_35[0], 1);
				VEHICLE::SET_VEHICLE_ALARM(uParam0->f_35[0], false);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_277(&(uParam0->f_41[0]), iVar0[1], Var5 + Var8, 0f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_278(&(uParam0->f_35[1]), iVar0[2], Var11, fVar15);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				func_282(&(uParam0->f_28[0]), iVar0[3], Var11, fVar15, 6);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[1]))
			{
				func_282(&(uParam0->f_28[1]), iVar0[3], Var11, fVar15, 6);
			}
			if (bVar17)
			{
				iLocal_108 = 3;
...
void func_282(int* iParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)
{
	func_283(iParam0);
...
int func_284(var uParam0)
{
	...
	switch (iLocal_108)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_285(&(uParam0->f_28[0]), 49, Var3, fVar6, "RC LAUNCHER: BARRY 3", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				func_277(&(uParam0->f_41[0]), iVar0[1], Var3 + Vector(0f, 0f, 5f), -115.18f);
...
int func_285(int* iParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)
{
	if (func_286(iParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*iParam0, false))
...
void func_289(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_290(var uParam0)
{
	...
	switch (iLocal_108)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_285(&(uParam0->f_28[0]), 49, Var6, fVar9, "RC LAUNCHER: BARRY 2", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				}
				else
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				if (func_219(uParam0->f_41[0]))
				{
					...
					func_277(&(uParam0->f_41[2]), iVar0[3], 189.7901f, -956.1675f, 29.8229f, func_292(-2.01f));
...
void func_291(int* iParam0, int iParam1)
{
	...
	fVar3 = 23.45f;
	func_277(iParam0, iParam1, Var0, fVar3);
}
...
int func_293(var uParam0)
{
	...
	switch (iLocal_108)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_285(&(uParam0->f_28[0]), 49, Var8, fVar11, "RC LAUNCHER: BARRY 1", 1))
				{
					PED::SET_PED_PROP_INDEX(uParam0->f_28[0], 1, 0, 0, false, 1);
				}
				else
...
int func_304(int iParam0, struct<3> Param1, float fParam4)
{
	int iVar0[4];
	int iVar5;
	...
	if (func_114() == 0)
	{
		if (func_305(2, Param1, fParam4, iParam0))
		{
			return 1;
		}
	}
	...
	{
		if (func_305(3, Param1, fParam4, iParam0))
		{
			return 1;
		}
	}
	...
	while (iVar5 < iVar0)
	{
		if (func_305(iVar0[iVar5], Param1, fParam4, iParam0))
		{
			iVar5 = iVar0;
			return 1;
		}
