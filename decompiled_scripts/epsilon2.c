...
void __EntryFunction__()
{
	...
	fLocal_49 = 180f;
	iLocal_52 = 3;
	uLocal_100 = func_362(60);
	uLocal_101 = func_362(14);
	iLocal_166 = joaat("v_ilev_epsstoredoor");
	...
	while (true)
	{
		...
		SYSTEM::WAIT(0);
		func_223(Local_103.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_164)
		{
			case 0:
				func_46();
...
void func_1()
{
	...
	OBJECT::GET_STATE_OF_CLOSEST_DOOR_OF_TYPE(iLocal_166, 241.3494f, 361.0303f, 105.9036f, &uVar0, &fVar1);
	switch (iLocal_165)
	{
		case 0:
			iLocal_170 = 0;
		...
		case 1:
			...
			{
				if (!iLocal_170 && (MISC::GET_GAME_TIMER() - iLocal_167) > 15000)
				{
				...
				if (!iLocal_172 && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, false, true, 0))
				{
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 240.9832f, 358.8689f, 103.6005f, 246.0318f, 374.3415f, 109.6506f, 9f, false, true, 0))
					{
						...
						if (MISC::ABSF(fVar1) <= 0.05f && !iLocal_172)
						{
							func_3(109, 6);
							func_3(109, 1);
							iLocal_171 = 1;
...
void func_8()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_11(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_9(iVar0) && (!func_13(14) || Global_113909))
			{
...
void func_17(int iParam0, var uParam1)
{
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_18(iParam0) && SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(Global_93249[26 /*34*/].f_6) == 0)
			{
				Global_114963.f_7268[iParam0] = 1;
				OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(uParam1->f_5, Global_114963.f_7268[iParam0], true, true);
			}
...
int func_35(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	...
	else
	{
		...
		iVar20 = 0;
		func_41(&iVar20);
		iVar21 = func_40(Var10, Global_114963.f_7697.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_38(Global_114963.f_7697.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_36(Global_114963.f_7697.f_765[iVar20 /*10*/]))
				{
					Global_114963.f_7697.f_765[iVar20 /*10*/] = { Var10 };
					func_37(&Var10);
					return 1;
...
void func_41(int iParam0)
{
	...
	*iParam0 = 0;
	...
	{
		if (func_40(Global_114963.f_7697.f_765[iVar0 /*10*/], Global_114963.f_7697.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
...
void func_46()
{
	switch (iLocal_165)
	{
		case 0:
			...
			{
				func_212(&Local_103, 0, 1);
				func_198(&Local_103, 1, 0, 0);
				Global_9507 = 1;
				func_190();
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_80120[1 /*14*/] = { func_115(iVar10, iParam1, iParam2, -1) };
		if (!func_114(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_80120[1 /*14*/] = { func_115(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_80120[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_80120[1 /*14*/] = { func_115(iVar10, 14, uVar28[iVar1], -1) };
							func_83(iParam0, Global_80120[1 /*14*/].f_12, Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4);
							func_106(14);
							if (Global_80118 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_73(iVar0), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_73(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_73(iVar0), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, iParam4);
						}
						func_106(iVar0);
						if (Global_80118 == 1)
						{
			...
			{
				Global_80120[1 /*14*/] = { func_115(iVar10, iVar0, func_72(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_80120[1 /*14*/] = { func_115(iVar10, 14, uVar69[iVar1], -1) };
			func_83(iParam0, Global_80120[1 /*14*/].f_12, Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4);
			func_106(14);
			if (Global_80118 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_73(iParam1), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_73(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_73(iParam1), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, iParam4);
		}
		if (Global_80118 == 1)
		{
			iVar2 = 0;
...
int func_64(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_179(iParam0, Global_114963.f_2370.f_539[iVar0 /*65*/].f_64, Global_114963.f_2370.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_80120[1 /*14*/] = { func_115(iParam0, iParam1, iParam2, -1) };
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_179(iParam0, Global_114963.f_2370.f_539[iVar0 /*65*/].f_61, Global_114963.f_2370.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 11, -1, false, -1, func_73(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 11, -1, false, -1, func_73(iParam2));
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_99(&Var1, -99, -99, Global_114963.f_2370.f_539.f_196[0], Global_114963.f_2370.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_99(&Var1, -99, -99, Global_114963.f_2370.f_539.f_196[1], Global_114963.f_2370.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_99(&Var1, -99, -99, Global_114963.f_2370.f_539.f_196[2], Global_114963.f_2370.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_106(int iParam0)
{
	...
	{
		func_113(iParam0, Global_80120[1 /*14*/].f_5, Global_80120[1 /*14*/].f_2, 2, Global_80120[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_80120[1 /*14*/].f_6, 1) && BitTest(Global_80120[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_117(int iParam0)
{
	...
	func_118(&(Global_80120[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_111(func_121(iParam1, uParam0->f_2), Global_80117);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 1);
			}
			uVar0 = func_111(func_120(iParam1, uParam0->f_2), Global_80117);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_111(iVar1, Global_80117);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_124(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_118(&(Global_80120[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_118(&(Global_80120[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_118(&(Global_80120[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_80318)
		{
			...
			func_118(&(Global_80120[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 11, -1, false, -1, func_73(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_179(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_80120[1 /*14*/] = { func_115(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_80120[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_179(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_179(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_80120[2 /*14*/] = { func_115(iVar0, 14, iVar4, -1) };
									if (Global_80120[2 /*14*/].f_12 == iVar3)
									{
										if (func_179(iParam0, 14, iVar4))
										{
											if (!func_69(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_80120[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_80120[2 /*14*/] = { func_115(iVar0, iVar2, iVar1, -1) };
						if (!func_69(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_80120[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_80120[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_73(iParam1)) && Global_80120[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_73(iParam1)))
	{
		return 1;
	}
	return 0;
	...
	if (Global_80592 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_226(Global_80593, Global_80595, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_238(0) || Global_80608) || Global_80596 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_80592)
...
{
	return func_240(iParam0, Global_44921);
}
...
struct<5> func_249(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			Var0.f_3 = func_250(&(Global_4718592.f_236570[0 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
		
		case 244:
			Var0 = { Global_4718592.f_236570[1 /*160*/].f_16 };
			Var0.f_3 = func_250(&(Global_4718592.f_236570[1 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
		
		case 245:
			Var0 = { Global_4718592.f_236570[2 /*160*/].f_16 };
			Var0.f_3 = func_250(&(Global_4718592.f_236570[2 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
		
		case 246:
			Var0 = { Global_4718592.f_236570[3 /*160*/].f_16 };
			Var0.f_3 = func_250(&(Global_4718592.f_236570[3 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
		
		case 247:
			Var0 = { Global_4718592.f_236570[4 /*160*/].f_16 };
			Var0.f_3 = func_250(&(Global_4718592.f_236570[4 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
...
int func_256(int iParam0, int iParam1, int iParam2, char* sParam3)
{
	...
	while (iVar1 < 8)
	{
		...
		{
			if (Global_56889[iVar0 /*53*/] == iParam1 && Global_56889[iVar0 /*53*/].f_1 == iParam2)
			{
				if (iParam0 == Global_56889[iVar0 /*53*/].f_3)
				{
					Global_56889[iVar0 /*53*/].f_5 = 1;
					StringCopy(&(Global_56889[iVar0 /*53*/].f_6), sParam3, 16);
				}
				return 1;
			}
		}
...
void func_261(int iParam0, bool bParam1)
{
	...
	{
		func_300(&(Global_114050[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_264()
{
	...
	{
		func_327(13, SYSTEM::FLOOR(Global_114963.f_10203.f_3853));
	}
...
int func_286(int iParam0, int iParam1, int iParam2)
{
	...
	else
	{
		...
		Global_80120[1 /*14*/] = { func_115(iVar0, iParam1, uVar31[iParam1], -1) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_73(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_73(iParam1), Global_80120[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_73(iParam1), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, 0);
		}
	}
...
void func_291(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (iParam0 != -1)
	{
		...
		func_292(&sVar32, Var0.f_3, Global_102523, bParam1, bParam2);
	}
}
...
void func_294()
{
	...
	{
		func_8();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_295(Global_114963.f_2370.f_539.f_4321));
	}
	else
	{
...
{
	func_305(iParam0, 1);
	Global_114963.f_18583[iParam0 /*6*/].f_3 = func_304();
		...
		if (bParam2)
		{
			if (!Global_80337)
			{
				if (iParam1 != 4)
				{
					...
					{
						Global_10178[iParam1 /*4*/] = { func_330(iParam0) };
					...
					{
						Global_10129[1 /*6*/] = { func_330(iParam0) };
...
int func_340()
{
	...
	iVar0 = func_341(&(Global_102486.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_344()
{
	...
	{
		if (func_339(&(Global_102486.f_3)) > -1)
		{
			return 1;
		}
	}
