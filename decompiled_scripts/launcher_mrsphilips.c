...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_114050[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_272(&(Global_114050[Var0.f_0 /*10*/].f_9));
			}
		}
		func_259(&Var0, 1);
	}
	...
	func_244(&Var0);
	iLocal_109 = PED::ADD_SCENARIO_BLOCKING_AREA(Var61 - Vector(20f, 20f, 20f), Var61 + Vector(20f, 20f, 20f), false, true, true, true, 1);
	...
	while (true)
	{
		...
		func_205(Var0.f_0);
		func_197(&iLocal_108, &(Var0.f_9), Var61);
		if (func_182(&Var0, 0))
		{
			if (Var0.f_0 == 35)
			{
...
int func_206(var uParam0, bool bParam1)
{
	...
	if ((func_243(*uParam0) || func_241(*uParam0)) || Global_80583 == 1)
	{
		return 1;
	}
...
bool func_220(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_221(&(Local_54[iVar4 /*4*/]), Var1, iParam1, &(Local_54[iVar4 /*4*/].f_3), iParam0, iParam5);
