#region Local Var
	...
	int iLocal_149 = 0;
	struct<19> Local_150[6];
	struct<6> Local_265[6];
	struct<6> Local_302 = { 0, 0, 0, 0, 0, 0 } ;
	struct<9> Local_308[4];
	struct<7> Local_345[1];
	struct<7> Local_353 = { 0, 0, 0, 0, 0, 0, 0 } ;
	var uLocal_360 = 0;
	struct<6> Local_361 = { 0, 0, 0, 0, 0, 0 } ;
	struct<6> Local_367 = { 0, 0, 0, 0, 0, 0 } ;
	struct<6> Local_373 = { 0, 0, 0, 0, 0, 0 } ;
	struct<6> Local_379 = { 0, 0, 0, 0, 0, 0 } ;
	int iLocal_385 = 0;
	int iLocal_386 = 0;
	int iLocal_387 = 0;
	int iLocal_388 = 0;
	int iLocal_389[3] = { 0, 0, 0 };
	int iLocal_393 = 0;
	int iLocal_394 = 0;
	int iLocal_395 = 0;
	int iLocal_396 = 0;
	...
	char* sLocal_453[3] = { NULL, NULL, NULL };
	char[] cLocal_457[8] = 0;
	char[] cLocal_458[8] = 0;
...
void __EntryFunction__()
{
	...
	sLocal_459 = "Trevor";
	sLocal_460 = "Maude";
	sLocal_461 = "maude_criminal_1";
	sLocal_462 = "maude_chair";
	sLocal_463 = "maude_laptop";
	StringCopy(&Local_630, "", 24);
	StringCopy(&Local_636, "MAUDE_MCS_2", 24);
	...
	if (func_554())
	{
		...
		{
			case 0:
				if (VEHICLE::IS_THIS_MODEL_A_HELI(Global_108504.f_2890.f_12.f_66) || VEHICLE::IS_THIS_MODEL_A_PLANE(Global_108504.f_2890.f_12.f_66))
				{
					func_448(&iLocal_697, 2898.294f, 2796.305f, 53.849f, 162.6353f, 0, 0, 1, 0, 0, joaat("asterope"), 0, 145, 1);
				}
				else
				{
					func_448(&iLocal_697, 2891.459f, 2798.125f, 53.7482f, 206.3925f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				}
				func_447(Local_682, fLocal_422, 1, 0);
				iLocal_118 = 2;
				func_436(1, 0);
				break;
			
			case 1:
				func_448(&iLocal_697, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145, 1);
				func_447(Local_642, 254.9762f, 0, 0);
				func_436(4, 0);
				break;
	...
	else if (func_435(0))
	{
		...
		{
			func_433(PLAYER::PLAYER_PED_ID(), Local_682, fLocal_422, 0, 0);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			Local_645 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true) };
			func_422();
			func_421();
			switch (iLocal_115)
			{
		...
		switch (iLocal_115)
		{
			case 0:
				if (iLocal_117 == 1)
				{
					if (!func_74())
					{
						func_21(PLAYER::PLAYER_PED_ID(), Local_685, fLocal_423, 0, 1);
						if (func_24(Local_129.f_9))
						{
							func_20(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(Local_129.f_9, true));
						}
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_410 == 0)
			...
			case 1:
				...
				if (iLocal_117 == 1)
				{
					if (!func_74())
					{
						func_21(PLAYER::PLAYER_PED_ID(), Local_688, fLocal_424, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_410 == 0)
						{
			...
			case 2:
				...
				if (iLocal_128 == 3)
				{
					if (iLocal_117 == 0)
					{
						if (func_24(Local_129.f_9) && func_7(Local_265[0 /*6*/]))
						{
							if (!PED::IS_PED_IN_VEHICLE(Local_129.f_9, Local_265[0 /*6*/], false))
							{
								PED::SET_PED_INTO_VEHICLE(Local_129.f_9, Local_265[0 /*6*/], -1);
							}
						}
					}
				}
			...
			case 3:
				...
				if (iLocal_117 == 1)
				{
					func_433(Local_129.f_9, Local_642, 0f, 0, 0);
					if (!func_74())
					{
						func_433(PLAYER::PLAYER_PED_ID(), Local_642, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1f);
						if (iLocal_410 == 0)
						{
...
int func_39()
{
	if (func_61(Local_645, Local_353.f_1, 210f))
	{
		if (!iLocal_417)
		{
			if ((func_60(3) && func_59(&Local_361, Local_361.f_5, Local_361.f_1, Local_361.f_4, 1)) && func_59(&Local_367, Local_367.f_5, Local_367.f_1, Local_367.f_4, 1))
			{
				if (func_56(&Local_353, Local_353.f_6, Local_353.f_1, Local_353.f_4, 1, 0, 1))
				{
					func_51();
					iLocal_417 = 1;
				}
		...
		{
			if (func_61(Local_645, Local_373.f_1, 150f))
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_373.f_1, 10f, func_50(), false))
				{
					Local_373.f_0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_373.f_1, 10f, func_50(), true, false, true);
					if (func_434(Local_373.f_0))
					{
						ENTITY::SET_ENTITY_COORDS(Local_373.f_0, func_49(), true, false, false, true);
						ENTITY::SET_ENTITY_HEADING(Local_373.f_0, func_48());
						ENTITY::FREEZE_ENTITY_POSITION(Local_373.f_0, true);
					}
				}
			}
		}
		if (!ENTITY::DOES_ENTITY_EXIST(Local_379.f_0))
		{
			if (func_61(Local_645, Local_379.f_1, 150f))
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_379.f_1, 10f, func_47(), false))
				{
					Local_379.f_0 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_379.f_1, 10f, func_47(), true, false, true);
				}
			}
		}
	}
	else if (!CAM::IS_SPHERE_VISIBLE(Local_353.f_1, 2.5f))
	{
		func_44(&Local_353, 1);
...
void func_51()
{
	...
	if (func_24(Local_353.f_0))
	{
		if (func_434(Local_361.f_0))
		{
			if (func_60(3))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(Local_353.f_0, iVar0, func_43(), func_53(), 1000f, -8f, 4688, 0, 1000f, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_361.f_0, iVar0, func_52(), func_43(), 1000f, -8f, iVar1, 1000f);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_353.f_0, true);
				PED::SET_PED_MONEY(Local_353.f_0, 0);
				PED::SET_PED_CAN_BE_TARGETTED(Local_353.f_0, false);
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_353.f_0, joaat("player"));
				TASK::SET_PED_PATH_CAN_USE_CLIMBOVERS(Local_353.f_0, false);
				TASK::SET_PED_PATH_CAN_DROP_FROM_HEIGHT(Local_353.f_0, false);
				PED::SET_PED_KEEP_TASK(Local_353.f_0, true);
				PED::SET_PED_CONFIG_FLAG(Local_353.f_0, 118, false);
			}
		}
	}
}
...
int func_60(int iParam0)
{
	switch (iParam0)
	{
		...
		case 2:
			STREAMING::REQUEST_MODEL(Local_302.f_5);
			if (STREAMING::HAS_MODEL_LOADED(Local_302.f_5))
			{
				return 1;
			}
			break;
...
void func_70()
{
	if (func_434(Local_129.f_9))
	{
		if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
		{
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(sLocal_461, Local_129.f_9, 0);
		}
	}
	if (func_434(Local_353.f_0))
	{
		if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
		{
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(sLocal_460, Local_353.f_0, 0);
		}
	}
}
	...
	switch (iLocal_117)
	{
		case 0:
			...
			if (iLocal_119 == 4)
			{
				if (func_24(Local_353.f_0))
				{
					func_117(&uLocal_464, 4);
					func_116(Local_353.f_0, 0);
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_353.f_0))
					{
						if (func_115(Local_353.f_0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), 35f, 1))
						{
							AUDIO::STOP_PED_SPEAKING(Local_353.f_0, false);
							func_113(Local_353.f_0, "GENERIC_FRIGHTENED_HIGH", "MAUDE", 3, 0);
						}
					}
				}
				if (ENTITY::DOES_ENTITY_EXIST(Local_367.f_0))
				{
					ENTITY::FREEZE_ENTITY_POSITION(Local_367.f_0, false);
				}
				if (ENTITY::DOES_ENTITY_EXIST(Local_373.f_0))
				{
					ENTITY::FREEZE_ENTITY_POSITION(Local_373.f_0, false);
				}
				STREAMING::REQUEST_ANIM_DICT(func_112());
				if (func_110(&Local_353, &Local_361, &iLocal_445))
				{
					iLocal_411 = 1;
				}
			}
			...
			{
				iLocal_401 = 0;
				StringCopy(&Local_630, "BBC_T12", 24);
			}
			if (func_24(Local_129.f_9))
			{
			...
			iVar1 = 0;
			while (iVar1 <= (iLocal_437 - 1))
			{
				func_109(Local_150[iVar1 /*19*/], 1);
				iVar1++;
			}
			switch (iLocal_119)
			{
			...
			else
			{
				if (!iLocal_401)
				{
					...
					if (iLocal_119 == 4)
					{
						if (func_24(Local_353.f_0))
						{
							if (func_115(Local_353.f_0, Local_645, 35f, 1))
							{
								func_101(&uLocal_464, 4, Local_353.f_0, "MAUDE", 0, 1);
								if (func_78(&uLocal_464, cLocal_458, &Local_630, 4, 0, 0, 0))
								{
									iLocal_401 = 1;
								}
							}
					...
					else if (func_78(&uLocal_464, cLocal_458, &Local_630, 4, 0, 0, 0))
					{
						iLocal_401 = 1;
					}
				}
				if (iLocal_119 == 4)
				{
					...
					else if (func_24(Local_353.f_0))
					{
						if (!func_66(Local_353.f_0, joaat("script_task_smart_flee_ped")))
						{
							if (!PED::IS_PED_FLEEING(Local_353.f_0))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_353.f_0, func_112(), func_77(), 3))
								{
									func_76(&Local_353);
									TASK::TASK_SMART_FLEE_PED(Local_353.f_0, PLAYER::PLAYER_PED_ID(), 50f, -1, false, false);
									PED::SET_PED_KEEP_TASK(Local_353.f_0, true);
								}
							}
						}
...
void func_92()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_95(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_93(iVar0) && (!func_97(14) || Global_113909))
			{
				if (Global_114963.f_2370.f_539.f_4321 != iVar0 && func_93(Global_114963.f_2370.f_539.f_4321))
				{
...
void func_100(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_102(bool bParam0)
{
	...
	{
		iVar0 = 0;
		while (iVar0 <= (iLocal_432 - 1))
		{
			func_40(&(Local_308[iVar0 /*9*/]), bParam0);
			iVar0++;
		}
	}
	if (iLocal_435 > 0)
	{
		iVar0 = 0;
		while (iVar0 <= (iLocal_435 - 1))
		{
			func_106(&(Local_345[iVar0 /*7*/]));
			iVar0++;
		}
	}
	func_40(&Local_361, bParam0);
	func_40(&Local_367, bParam0);
	func_40(&Local_373, 0);
	func_40(&Local_379, 0);
	if (func_24(Local_129.f_9))
	{
	...
	func_44(&(Local_129.f_9), bParam0);
	if (func_24(Local_353.f_0))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_353.f_0, false);
		PED::SET_PED_KEEP_TASK(Local_353.f_0, true);
	}
	func_44(&Local_353, bParam0);
	if (iLocal_437 > 0)
	{
		iVar0 = 0;
		while (iVar0 <= (iLocal_437 - 1))
		{
			if (iLocal_128 == 4)
			{
				if (func_24(Local_150[iVar0 /*19*/]))
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_150[iVar0 /*19*/], -2065892691);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_150[iVar0 /*19*/], false);
					if (Global_113667 == 0)
					{
						PED::SET_PED_KEEP_TASK(Local_150[iVar0 /*19*/], false);
					}
					else
					{
						PED::SET_PED_KEEP_TASK(Local_150[iVar0 /*19*/], true);
					}
				}
			}
			func_44(&(Local_150[iVar0 /*19*/]), bParam0);
			iVar0++;
		}
	}
	if (iLocal_433 > 0)
	{
		iVar0 = 0;
		while (iVar0 <= (iLocal_433 - 1))
		{
			func_103(&(Local_265[iVar0 /*6*/]), bParam0);
			iVar0++;
		}
	}
}
			...
			if (!PED::IS_PED_RAGDOLL(*iParam0) || TASK::IS_PED_GETTING_UP(*iParam0))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED(func_112()))
				{
					*iParam2 = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
					...
					TASK::TASK_SYNCHRONIZED_SCENE(*iParam0, *iParam2, func_112(), func_77(), 1000f, -4f, 4626, 0, 1000f, 0);
...
void func_121(int iParam0)
{
	...
	{
		func_119(&(Local_150[iVar0 /*19*/].f_6), 0);
		iVar0++;
	}
}
		...
		case 1:
			if (func_123(iLocal_442, 500))
			{
				if (!bLocal_402)
				{
					...
					if (func_78(&uLocal_464, cLocal_458, "BBC_PK1", 4, 0, 0, 0))
					{
						bLocal_402 = true;
					}
				}
...
{
	if (func_24(Local_150[iParam0 /*19*/]))
	{
		TASK::CLEAR_PED_SECONDARY_TASK(Local_150[iParam0 /*19*/]);
		TASK::CLEAR_PED_TASKS(Local_150[iParam0 /*19*/]);
		TASK::TASK_CLEAR_LOOK_AT(Local_150[iParam0 /*19*/]);
		if (func_125(1, 0, 1))
		{
			func_109(Local_150[iParam0 /*19*/], 1);
			Local_150[iParam0 /*19*/].f_14 = 4;
			func_119(&(Local_150[iParam0 /*19*/].f_6), 0);
		}
		else if (PED::GET_PED_RELATIONSHIP_GROUP_HASH(Local_150[iParam0 /*19*/]) == iLocal_629)
		{
			PED::SET_PED_HEARING_RANGE(Local_150[iParam0 /*19*/], 30f);
			PED::SET_PED_SEEING_RANGE(Local_150[iParam0 /*19*/], 30f);
			PED::SET_PED_ID_RANGE(Local_150[iParam0 /*19*/], 30f);
			PED::SET_PED_COMBAT_RANGE(Local_150[iParam0 /*19*/], 0);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_150[iParam0 /*19*/], 1, false);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_150[iParam0 /*19*/], 3, true);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_150[iParam0 /*19*/], 5, true);
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_150[iParam0 /*19*/], 0, false);
			PED::SET_PED_FLEE_ATTRIBUTES(Local_150[iParam0 /*19*/], 512, true);
			TASK::TASK_LOOK_AT_ENTITY(Local_150[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_150[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_150[iParam0 /*19*/], true);
			Local_150[iParam0 /*19*/].f_14 = 2;
		}
		else
		{
			PED::SET_PED_COMBAT_ATTRIBUTES(Local_150[iParam0 /*19*/], 5, false);
			TASK::TASK_LOOK_AT_ENTITY(Local_150[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_150[iParam0 /*19*/], PLAYER::PLAYER_PED_ID(), -1);
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_150[iParam0 /*19*/], false);
			Local_150[iParam0 /*19*/].f_14 = 4;
		}
	}
}
...
{
	func_25(500, 1);
	func_127(func_133(Local_120.f_4), 0, 0);
	if (iParam0 == 2)
	{
		Global_113667 = 1;
	}
...
void func_128()
{
	...
	{
		func_131(13, SYSTEM::FLOOR(Global_114963.f_10203.f_3853));
	}
	...
	switch (iLocal_117)
	{
		case 0:
			...
			if (func_39())
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), sLocal_459, 0, 0, 0);
					if (func_434(Local_353.f_0))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_353.f_0, sLocal_460, 0, 0, 0);
					}
					if (func_434(Local_129.f_9))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_129.f_9, sLocal_461, 0, 0, 0);
					}
					if (func_434(Local_361.f_0))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_361.f_0, sLocal_462, 0, 0, 0);
					}
					if (func_434(Local_367.f_0))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_367.f_0, sLocal_463, 0, 0, 0);
					}
		...
		case 1:
			if (func_434(Local_361.f_0))
			{
				if (func_24(Local_353.f_0))
				{
					if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_460, 0) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_462, 0))
					{
						func_51();
					}
				}
			}
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_459, 0))
			{
		...
		case 2:
			...
			else
			{
				...
				func_44(&(Local_129.f_9), 1);
				if (func_24(Local_353.f_0))
				{
					TASK::TASK_LOOK_AT_ENTITY(Local_353.f_0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					PED::SET_PED_KEEP_TASK(Local_353.f_0, true);
				}
				func_45(&Local_353, 1, 0, 1);
				func_135(5);
			}
			break;
	}
...
void func_136(struct<3> Param0, float fParam3, int iParam4, int iParam5)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_105520.f_4))
	{
		...
		{
			if (func_190(24) != Global_105520.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_187(ENTITY::GET_ENTITY_COORDS(Global_105520.f_4, true), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_137(Global_105520.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_137(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_173(iParam5, &Var0, Param1, fParam4, func_179(iParam0));
		func_138(iParam5, iParam0, 0);
	}
}
...
void func_138(int iParam0, int iParam1, int iParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, false))
		{
			...
			if (iParam0 == 24)
			{
				Global_114963.f_32759.f_4801 = func_159();
			}
...
void func_139(int iParam0, int iParam1)
{
	...
	func_181(iParam0, &(Global_114963.f_32759.f_5510));
}

int func_140(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_157(iParam0, 0, 0)) || func_157(iParam0, 1, 0)) || func_157(iParam0, 2, 0)) || func_179(iParam0) != 145) || func_156(iParam0)) || func_155(iParam0)) || func_154(iParam0)) || func_153(iParam0)) || !func_141(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_155(iParam0))
		{
		}
...
int func_170(var uParam0, int iParam1)
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (BitTest(uParam0->f_9, 10))
	{
		...
		if (!func_180(Global_114963.f_32759.f_1864[uParam0->f_14 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_180(Global_114963.f_2370.f_539.f_3588[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_180(Global_114963.f_2370.f_539.f_3588[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f, 0))
		{
...
void func_173(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_170(&(Global_79127.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_178(iParam0);
			func_177(uParam1, &(Global_114963.f_32759.f_69[Global_79127.f_555[0 /*21*/].f_14 /*78*/]));
...
{
	return func_199(Global_105520.f_2890.f_12.f_66, Param0, iParam3);
}
...
int func_205(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	...
	if (iParam5 == 0)
	{
		Global_80120[1 /*14*/] = { func_257(iVar10, iParam1, iParam2, -1) };
		if (!func_256(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_80120[1 /*14*/] = { func_257(iVar10, iVar0, uVar11[iVar0], -1) };
				if (BitTest(Global_80120[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_80120[1 /*14*/] = { func_257(iVar10, 14, uVar28[iVar1], -1) };
							func_225(iParam0, Global_80120[1 /*14*/].f_12, Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4);
							func_248(14);
							if (Global_80118 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_215(iVar0), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_215(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_215(iVar0), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, iParam4);
						}
						func_248(iVar0);
						if (Global_80118 == 1)
						{
			...
			{
				Global_80120[1 /*14*/] = { func_257(iVar10, iVar0, func_214(iParam0, iVar0, -1), -1) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_80120[1 /*14*/] = { func_257(iVar10, 14, uVar69[iVar1], -1) };
			func_225(iParam0, Global_80120[1 /*14*/].f_12, Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4);
			func_248(14);
			if (Global_80118 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_215(iParam1), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_215(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_215(iParam1), Global_80120[1 /*14*/].f_3, Global_80120[1 /*14*/].f_4, iParam4);
		}
		if (Global_80118 == 1)
		{
			iVar2 = 0;
...
int func_206(int iParam0, int iParam1, int iParam2)
{
	...
	{
		if (!func_321(iParam0, Global_114963.f_2370.f_539[iVar0 /*65*/].f_64, Global_114963.f_2370.f_539[iVar0 /*65*/].f_63))
		{
...
{
	Global_80120[1 /*14*/] = { func_257(iParam0, iParam1, iParam2, -1) };
...
int func_213(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		if (!func_321(iParam0, Global_114963.f_2370.f_539[iVar0 /*65*/].f_61, Global_114963.f_2370.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_227(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	else
	{
		...
		iVar37 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 11, -1, false, -1, func_215(iParam2));
		if (iVar37 <= iVar36)
		{
			return -1;
		}
...
int func_232(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 11, -1, false, -1, func_215(iParam2));
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_241(&Var1, -99, -99, Global_114963.f_2370.f_539.f_196[0], Global_114963.f_2370.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_241(&Var1, -99, -99, Global_114963.f_2370.f_539.f_196[1], Global_114963.f_2370.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_241(&Var1, -99, -99, Global_114963.f_2370.f_539.f_196[2], Global_114963.f_2370.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_248(int iParam0)
{
	...
	{
		func_255(iParam0, Global_80120[1 /*14*/].f_5, Global_80120[1 /*14*/].f_2, 2, Global_80120[1 /*14*/].f_1, 1, 0);
	}
	if (BitTest(Global_80120[1 /*14*/].f_6, 1) && BitTest(Global_80120[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_259(int iParam0)
{
	...
	func_260(&(Global_80120[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			uVar0 = func_253(func_263(iParam1, uParam0->f_2), Global_80117);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), true);
			}
			uVar0 = func_253(func_262(iParam1, uParam0->f_2), Global_80117);
			if (BitTest(uVar0, uParam0->f_1))
			{
				MISC::SET_BIT(&(uParam0->f_6), 2);
			}
			...
			{
				uVar0 = func_253(iVar1, Global_80117);
				if (!BitTest(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 4);
				}
...
void func_266(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam0 == 12)
	{
		...
		if (iVar17 >= 0)
		{
			...
			if (iVar18 > iVar17)
			{
				...
				func_260(&(Global_80120[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
				return;
			}
		}
	}
	...
	{
		func_260(&(Global_80120[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		if (iVar37 >= 0)
		{
			...
			if (iVar38 > iVar37)
			{
				...
				func_260(&(Global_80120[0 /*14*/]), iParam0, iParam1, &(Var19.f_9), Var19.f_3, Var19.f_4, Var19.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var19.f_1, joaat("outfit_only"), 0), iVar36, 2, Var19.f_1 != 0);
				return;
			}
		}
	}
	else
	{
		...
		if (iParam3 != -1 && Global_80318)
		{
			...
			func_260(&(Global_80120[0 /*14*/]), iParam0, iParam1, &(Var39.f_9), Var39.f_3, Var39.f_4, Var39.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var39.f_1, joaat("outfit_only"), 0), -1, 2, Var39.f_1 != 0);
			return;
		}
		iVar56 = (iParam1 - iParam2);
		if (iVar56 >= 0)
		{
			iVar57 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 11, -1, false, -1, func_215(iParam0));
			if (iVar57 > iVar56)
			{
...
int func_321(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_80120[1 /*14*/] = { func_257(iVar0, iParam1, iParam2, -1) };
	if (!BitTest(Global_80120[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_321(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_321(iParam0, 14, uVar22[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_80120[2 /*14*/] = { func_257(iVar0, 14, iVar4, -1) };
									if (Global_80120[2 /*14*/].f_12 == iVar3)
									{
										if (func_321(iParam0, 14, iVar4))
										{
											if (!func_211(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_80120[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_80120[2 /*14*/] = { func_257(iVar0, iVar2, iVar1, -1) };
						if (!func_211(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_80120[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_80120[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_215(iParam1)) && Global_80120[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_215(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_323()
{
	...
	if (func_24(Local_129.f_9))
	{
		...
		func_390(Local_129.f_9, &iLocal_438, 1126825984, 7);
		func_382(Local_129.f_9, &(Local_129.f_19), 1126825984, 7);
		func_370();
		switch (iLocal_117)
		{
			case 0:
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("player"), iLocal_629);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_629, joaat("player"));
				iLocal_443 = ENTITY::GET_ENTITY_HEALTH(Local_129.f_9);
				Local_691 = { ENTITY::GET_ENTITY_COORDS(Local_129.f_9, false) };
				func_369(&Local_694, Local_691);
				func_368(Local_129.f_9);
				...
				if (func_24(Local_129.f_9))
				{
					...
					{
						Local_129.f_8 = func_367(Local_129.f_9, 1, 0, 5);
					}
				...
				func_366(&(Local_129.f_8), "", "", &iLocal_430, iLocal_431, 0);
				iLocal_117 = 1;
				break;
			...
			case 1:
				...
				{
					func_366(&(Local_129.f_8), "", "", &iLocal_430, iLocal_431, 0);
					func_338(&uLocal_61, Local_129.f_9, 0, 0, 1, 1, 1);
					if (Local_129.f_10 == 13 || Local_129.f_10 == 14)
					{
						if (iLocal_440 == -1)
						{
						...
						else if (func_123(iLocal_439, 8000))
						{
							bVar0 = true;
						}
						if (func_335(Local_129.f_9, Local_645, bVar0, 0, 1, iLocal_443))
						{
							if ((func_123(iLocal_440, 5000) || func_180(Local_694, 0f, 0f, 0f, 0)) || (!func_61(Var1, Local_694, 8.5f) && !func_61(Var1, Local_691, 8.5f)))
							{
								func_334();
								Local_129.f_17 = MISC::GET_GAME_TIMER();
								func_332(&uLocal_61, 0, 0, 0);
								iLocal_414 = 1;
							}
						}
						else
						{
							if (!iLocal_385)
							{
								if (!func_123(iLocal_427, 2500))
								{
									if (!func_64())
									{
										if (func_115(Local_129.f_9, Local_645, 30f, 1))
										{
											if (func_78(&uLocal_464, cLocal_457, "BB1_J7", 4, 0, 0, 0))
											{
												iLocal_427 = MISC::GET_GAME_TIMER();
												iLocal_385 = 1;
											}
							...
							{
								if (func_123(iLocal_427, MISC::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_115(Local_129.f_9, Local_645, 30f, 1))
									{
										if (PED::IS_PED_FLEEING(Local_129.f_9))
										{
											...
											{
												if (func_78(&uLocal_464, cLocal_458, "BBC_T13", 4, 0, 0, 0))
												{
													iLocal_427 = MISC::GET_GAME_TIMER();
												}
											}
											else if (func_78(&uLocal_464, cLocal_457, "BB1_FLEE", 4, 0, 0, 0))
											{
												iLocal_427 = MISC::GET_GAME_TIMER();
											}
										}
							...
							func_331(Local_129.f_9, Local_645, iLocal_440, 925353388);
						}
					}
					else
					{
				...
				{
					func_334();
					if (!func_115(Local_129.f_9, Local_645, 10f, 1))
					{
						if (!iLocal_404)
						{
							if (!func_329(sLocal_452, 1))
							{
								func_327(&(Local_129.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_430, &iLocal_431, 1, 1);
								iLocal_404 = 1;
							}
						}
						else
						{
							func_366(&(Local_129.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_430, iLocal_431, 1);
						}
					}
					else
					{
						if (!iLocal_386)
						{
							if (!PED::IS_PED_RAGDOLL(Local_129.f_9) && !PED::IS_PED_IN_ANY_VEHICLE(Local_129.f_9, false))
							{
								...
								if (func_78(&uLocal_464, cLocal_457, sLocal_452, 4, 0, 0, 0))
								{
									iLocal_386 = 1;
								}
							}
			...
			case 2:
				...
				iLocal_386 = 1;
				func_334();
				PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("player"), iLocal_629);
				PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_629, joaat("player"));
				func_120(&(Local_129.f_8));
				iLocal_386 = 1;
				Local_129.f_17 = MISC::GET_GAME_TIMER();
				func_332(&uLocal_61, 0, 0, 0);
...
int func_347(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if ((func_354() || func_353(Global_4718592.f_197291)) || func_352())
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
...
int func_348(int iParam0)
{
	if (iParam0 != func_86())
	{
		...
		else if ((Global_1575095 && iParam0 == PLAYER::PLAYER_ID()) && func_349(iParam0, 1, 0))
		{
			return Global_2658293[iParam0 /*468*/].f_325.f_8 != -1;
		}
	}
...
{
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(iParam0, iLocal_629);
...
void func_370()
{
	...
	if (func_24(Local_129.f_9))
	{
		if (iLocal_149 == 0)
		{
			func_381(&(Local_129.f_9), &bLocal_420);
			if (func_380())
			{
				if (iLocal_414 || iLocal_115 == 7)
				{
					if (bLocal_420)
					{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_129.f_10)
			{
				case 0:
					if (func_115(Local_129.f_9, Local_645, 30f, 1))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_129.f_9, "ODDJOBS@BAILBOND_QUARRY", "prem_producer_argue_a", 3))
						{
							ENTITY::STOP_ENTITY_ANIM(Local_129.f_9, "prem_producer_argue_a", "ODDJOBS@BAILBOND_QUARRY", -2f);
						}
						Local_129.f_10 = 1;
					}
					break;
				...
				case 1:
					...
					{
						func_40(&Local_302, 1);
						if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(Local_129.f_9))
						{
							TASK::TASK_START_SCENARIO_IN_PLACE(Local_129.f_9, "WORLD_HUMAN_SMOKING", 0, true);
				...
				case 2:
					if (func_115(Local_129.f_9, Local_645, 20f, 1))
					{
				...
				case 4:
					if (!func_66(Local_129.f_9, joaat("script_task_turn_ped_to_face_entity")))
					{
				...
				case 6:
					if (!func_115(Local_129.f_9, Local_645, 3.5f, 1))
					{
						if (!func_66(Local_129.f_9, joaat("script_task_go_to_entity")))
						{
							Local_129.f_10 = 5;
						}
						else
					...
					else if (!func_66(Local_129.f_9, joaat("script_task_turn_ped_to_face_entity")))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_129.f_9, PLAYER::PLAYER_PED_ID(), -1);
					}
					break;
				...
				case 8:
					if (!func_66(Local_129.f_9, joaat("script_task_combat")))
					{
						Local_129.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						Local_129.f_10 = 7;
					}
				...
				case 10:
					if (!PED::IS_PED_RAGDOLL(Local_129.f_9))
					{
						if (!func_66(Local_129.f_9, joaat("script_task_cower")) && !func_66(Local_129.f_9, joaat("script_task_hands_up")))
						{
				...
				case 30:
					if (!func_66(Local_129.f_9, joaat("script_task_perform_sequence")))
					{
						fVar3 = MISC::GET_RANDOM_FLOAT_IN_RANGE(5f, 8f);
						TASK::OPEN_SEQUENCE_TASK(&iLocal_449);
						...
						TASK::CLOSE_SEQUENCE_TASK(iLocal_449);
						TASK::TASK_PERFORM_SEQUENCE(Local_129.f_9, iLocal_449);
						TASK::CLEAR_SEQUENCE_TASK(&iLocal_449);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_129.f_9, true);
					}
					break;
				...
				case 13:
					if (func_123(Local_129.f_18, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_129.f_9))
						{
							PED::SET_PED_PANIC_EXIT_SCENARIO(Local_129.f_9, Local_645);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_129.f_9, &iVar0, true);
						if (iVar0 != joaat("weapon_unarmed"))
						{
				...
				case 14:
					if (!func_66(Local_129.f_9, joaat("script_task_smart_flee_ped")) && !PED::IS_PED_FLEEING(Local_129.f_9))
					{
						Local_129.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						Local_129.f_10 = 13;
					}
				...
				case 15:
					...
					if (func_7(Local_265[0 /*6*/]))
					{
						if (((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_265[0 /*6*/], false) && func_115(Local_265[0 /*6*/], Local_265[0 /*6*/].f_1, 3f, 1)) && func_377(ENTITY::GET_ENTITY_HEADING(Local_265[0 /*6*/]), Local_265[0 /*6*/].f_4, 20f)) && !func_376(Local_265[0 /*6*/], 2))
						{
							if (PED::IS_PED_IN_VEHICLE(Local_129.f_9, Local_265[0 /*6*/], false) && !PED::IS_PED_BEING_JACKED(Local_129.f_9))
							{
								Local_129.f_10 = 16;
							}
							else if (func_123(Local_129.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								...
								if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_129.f_9, "ODDJOBS@BAILBOND_QUARRY", "prem_producer_argue_a", 3))
								{
									ENTITY::STOP_ENTITY_ANIM(Local_129.f_9, "prem_producer_argue_a", "ODDJOBS@BAILBOND_QUARRY", -4f);
								}
								else if (PED::IS_PED_USING_ANY_SCENARIO(Local_129.f_9))
								{
									PED::SET_PED_PANIC_EXIT_SCENARIO(Local_129.f_9, Local_645);
								}
								else
								...
								TASK::TASK_ENTER_VEHICLE(Local_129.f_9, Local_265[0 /*6*/], 25000, -1, 3f, 8388608, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_129.f_9, true);
								Local_129.f_10 = 16;
							}
						}
				...
				case 16:
					...
					else if ((((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_265[0 /*6*/], true) || PED::IS_PED_BEING_JACKED(Local_129.f_9)) || !func_115(Local_265[0 /*6*/], Local_265[0 /*6*/].f_1, 3f, 1)) || !func_377(ENTITY::GET_ENTITY_HEADING(Local_265[0 /*6*/]), Local_265[0 /*6*/].f_4, 20f)) || func_376(Local_265[0 /*6*/], 2))
					{
						Local_129.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						Local_129.f_10 = 13;
					}
					else if (PED::IS_PED_SITTING_IN_VEHICLE(Local_129.f_9, Local_265[0 /*6*/]))
					{
						Local_129.f_10 = 33;
					}
					else if (!func_66(Local_129.f_9, joaat("script_task_enter_vehicle")))
					{
						Local_129.f_10 = 15;
					}
					break;
				...
				case 17:
					if (func_7(Local_265[0 /*6*/]) && PED::IS_PED_SITTING_IN_VEHICLE(Local_129.f_9, Local_265[0 /*6*/]))
					{
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(Local_129.f_9, Local_265[0 /*6*/], PLAYER::PLAYER_PED_ID(), 8, 30f, 786468, 350f, 30f, true);
				...
				case 18:
					if (!func_66(Local_129.f_9, joaat("script_task_vehicle_mission")))
					{
						Local_129.f_10 = 17;
					}
					break;
				...
				case 20:
					if (!PED::IS_PED_RAGDOLL(Local_129.f_9))
					{
						if (!func_66(Local_129.f_9, joaat("script_task_cower")))
						{
							Local_129.f_10 = 19;
						}
					}
				...
				case 21:
					if (func_375(Local_129.f_9, Local_129.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_374())
					{
						Local_129.f_10 = 23;
					}
					else if (PED::DOES_GROUP_EXIST(func_373()))
					{
						...
						if (!PED::IS_PED_GROUP_MEMBER(Local_129.f_9, func_373()))
						{
							PED::SET_PED_AS_GROUP_MEMBER(Local_129.f_9, func_373());
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (func_372())
							{
								...
								if (!PED::IS_PED_IN_VEHICLE(Local_129.f_9, iVar1, false))
								{
									...
									if (fVar4 < 1.75f && func_115(Local_129.f_9, Local_645, 8f, 1))
									{
										if (!func_66(Local_129.f_9, joaat("script_task_enter_vehicle")))
										{
											iVar2 = -1;
				...
				case 23:
					if (func_375(Local_129.f_9, Local_129.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_374())
					{
						...
						if (((!PED::IS_PED_RAGDOLL(Local_129.f_9) && !PED::IS_PED_BEING_STUNNED(Local_129.f_9, 0)) && !PED::IS_PED_BEING_JACKED(Local_129.f_9)) && !func_66(Local_129.f_9, joaat("script_task_leave_any_vehicle")))
						{
							TASK::TASK_LOOK_AT_ENTITY(Local_129.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							if ((!func_371(Local_129.f_19, 10) && func_115(Local_129.f_9, Local_645, 50f, 1)) || !func_123(iLocal_446, 2000))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_129.f_9, false))
								{
									TASK::TASK_LEAVE_ANY_VEHICLE(Local_129.f_9, 0, 0);
								}
								else if (((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && !PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_129.f_9)) && !func_374()) || ENTITY::IS_ENTITY_IN_WATER(Local_129.f_9))
								{
									TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_129.f_9, PLAYER::PLAYER_PED_ID(), -1);
								}
				...
				case 24:
					if (func_375(Local_129.f_9, Local_129.f_19, 100f, 1, 1090519040, 1097859072, 0) || func_374())
					{
						if (!func_66(Local_129.f_9, joaat("script_task_hands_up")))
						{
							if (!func_66(Local_129.f_9, joaat("script_task_turn_ped_to_face_entity")))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_129.f_9, false))
								{
									if (!func_371(Local_129.f_19, 10) && func_115(Local_129.f_9, Local_645, 50f, 1))
									{
										TASK::TASK_LEAVE_ANY_VEHICLE(Local_129.f_9, 0, 0);
										Local_129.f_10 = 23;
									}
							...
							else if (!func_371(Local_129.f_19, 10) && func_115(Local_129.f_9, Local_645, 50f, 1))
							{
								if ((WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), Local_129.f_9)) || func_374())
								{
									Local_129.f_10 = 23;
								}
							}
				...
				case 25:
					if (func_375(Local_129.f_9, Local_129.f_19, 100f, 1, 1090519040, 1097859072, 0))
					{
						Local_129.f_10 = 23;
					}
					else
...
int func_375(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)
{
	...
	if (func_24(iParam0))
	{
		...
		if (func_115(iParam0, Local_645, fParam2, 1))
		{
...
bool func_383(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_384(&(Local_73[iVar4 /*4*/]), Var1, iParam1, &(Local_73[iVar4 /*4*/].f_3), iParam0, iParam5);
...
void func_391()
{
	if (func_61(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_642, 100f))
	{
		if (!func_392())
		{
			CUTSCENE::REQUEST_CUTSCENE(&Local_636, 8);
			func_70();
			iLocal_418 = 1;
		}
	}
	...
	{
		if (!func_61(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_642, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
		...
		switch (iLocal_117)
		{
			...
			case 1:
				if (!iLocal_415)
				{
					...
					func_120(&(Local_129.f_8));
					if (!func_115(Local_129.f_9, Local_645, 25f, 1))
					{
						...
						if (func_371(iLocal_438, 10))
						{
							if (!func_64())
							{
								if (!func_371(iLocal_438, 10))
								{
									if (func_78(&uLocal_464, cLocal_458, "BBC_T9", 4, 0, 0, 0))
									{
										iLocal_427 = MISC::GET_GAME_TIMER();
									}
								}
					...
					else if (!iLocal_387)
					{
						if (!func_329(sLocal_452, 1))
						{
							if (func_78(&uLocal_464, cLocal_458, "BBC_T5", 4, 0, 0, 0))
							{
								iLocal_387 = 1;
							}
						}
				...
				else if (func_115(Local_129.f_9, Local_645, 8f, 1))
				{
					...
					if (!func_64())
					{
						if (Local_129.f_10 == 21 || Local_129.f_10 == 22)
						{
							...
							{
								if (func_78(&uLocal_464, cLocal_458, "BBC_T10", 4, 0, 0, 0))
								{
									iLocal_427 = MISC::GET_GAME_TIMER();
								}
							}
							else if (func_78(&uLocal_464, cLocal_457, "BB1_J5", 4, 0, 0, 0))
							{
								iLocal_427 = MISC::GET_GAME_TIMER();
							}
						}
				...
				else
				{
					...
					if (!HUD::DOES_BLIP_EXIST(Local_129.f_8))
					{
						Local_129.f_8 = func_367(Local_129.f_9, 1, 1, 5);
					}
					if (!iLocal_407)
					{
...
void func_394()
{
	...
	if (func_24(Local_129.f_9))
	{
		...
		if (!iLocal_395)
		{
			if (func_78(&uLocal_464, cLocal_457, "BB1_J6", 4, 0, 0, 0))
			{
				iLocal_395 = 1;
			}
		}
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
		{
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_129.f_9, false) && PED::GET_VEHICLE_PED_IS_IN(Local_129.f_9, false) == iVar0)
			{
				if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
				{
					...
					{
						if ((MISC::GET_GAME_TIMER() - iLocal_426) > 7500)
						{
							func_397(0);
						}
					}
					...
					{
						if ((MISC::GET_GAME_TIMER() - iLocal_426) > 10000)
						{
							func_397(1);
						}
					}
					else if (!iLocal_389[2])
					{
						if ((MISC::GET_GAME_TIMER() - iLocal_426) > 10000)
						{
							func_397(2);
					...
					if (ENTITY::DOES_ENTITY_EXIST(iVar0))
					{
						if (ENTITY::GET_ENTITY_SPEED(iVar0) < 0.5f)
						{
							if (!iLocal_400)
							{
								if (!func_64())
								{
									if (func_123(iLocal_444, 3500))
									{
										if (func_78(&uLocal_464, cLocal_457, "BB1_STOP", 4, 0, 0, 0))
										{
											iLocal_400 = 1;
										}
									}
				...
				{
					if (func_78(&uLocal_464, cLocal_457, "BB1_J9", 4, 0, 0, 0))
					{
						iLocal_388 = 1;
					}
				}
		...
		else
		{
			...
			if (PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!iLocal_396)
				{
					if (func_372())
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(Local_129.f_9, false))
						{
							...
							{
								if (func_78(&uLocal_464, cLocal_458, "BBC_T6", 4, iVar1, 0, 0))
								{
									iLocal_396 = 1;
								}
							}
					...
					else if (!func_329("BBC_T8", 1) && !func_329("BB1_WTF", 1))
					{
						if (MISC::GET_RANDOM_INT_IN_RANGE(0, 11) < 5)
						{
							if (func_78(&uLocal_464, cLocal_458, "BBC_T8", 4, iVar1, 0, 0))
							{
								iLocal_396 = 1;
							}
						}
						else if (func_78(&uLocal_464, cLocal_457, "BB1_WTF", 4, iVar1, 0, 0))
						{
							iLocal_396 = 1;
						}
					}
				...
				else if (!iLocal_399)
				{
					if (func_395(&iVar0))
					{
						if ((!func_329("BB1_JACK", 1) && !func_329("BBC_T6", 1)) && !func_329("BBC_T8", 1))
						{
							if (func_78(&uLocal_464, cLocal_457, "BB1_JACK", 4, iVar1, 0, 0))
							{
								iLocal_399 = 1;
							}
						}
			...
			else
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(Local_129.f_9, false))
				{
					if (!iLocal_397)
					{
						if (!func_329("BBC_T7", 1) && !func_329("BB1_OUT", 1))
						{
							if (MISC::GET_RANDOM_INT_IN_RANGE(0, 11) < 5)
							{
								if (func_78(&uLocal_464, cLocal_458, "BBC_T7", 4, iVar1, 0, 0))
								{
									iLocal_397 = 1;
								}
							}
							else if (func_78(&uLocal_464, cLocal_457, "BB1_OUT", 4, iVar1, 0, 0))
							{
								iLocal_397 = 1;
							}
						}
				...
				else if (Local_129.f_10 == 24 && func_66(Local_129.f_9, joaat("script_task_hands_up")))
				{
					if (func_115(Local_129.f_9, Local_645, 25f, 1))
					{
						if (!func_329("BB1_J10", 1))
						{
							if (func_123(iLocal_428, MISC::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_64())
								{
									func_3();
								}
								if (func_78(&uLocal_464, cLocal_457, "BB1_J10", 4, 0, 0, 0))
								{
				...
				else
				{
					...
					if (!func_64())
					{
						if (func_123(iLocal_427, MISC::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_115(Local_129.f_9, Local_645, 20f, 1))
							{
								if (func_78(&uLocal_464, cLocal_457, "BB1_J4", 4, 0, 0, 0))
								{
									iLocal_427 = MISC::GET_GAME_TIMER();
								}
							}
...
{
	if (!iLocal_389[iParam0])
	{
		if (func_78(&uLocal_464, cLocal_457, sLocal_453[iParam0], 4, 0, 0, 0))
		{
			iLocal_389[iParam0] = 1;
			iLocal_413 = 0;
			iLocal_426 = 0;
			iLocal_395 = 1;
		}
		...
		switch (iLocal_117)
		{
			...
			case 1:
				if (!iLocal_415)
				{
					...
					else
					{
						if (!HUD::DOES_BLIP_EXIST(iLocal_421))
						{
							if (iLocal_403)
							{
								iLocal_421 = func_403(Local_642, 5, 1);
							}
						}
						if (!iLocal_387)
						{
						...
						{
							func_394();
							func_401(&Local_353, Local_645, &iLocal_429, 5000, 1101004800);
						}
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_642, 4f, 4f, 2f, true, true, 0))
						{
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
						{
							if (func_115(PLAYER::PLAYER_PED_ID(), Local_642, 6.5f, 1))
							{
								iLocal_117 = 2;
							}
						}
						else if (func_115(PLAYER::PLAYER_PED_ID(), Local_642, 2.5f, 1))
						{
							iLocal_117 = 2;
						}
					}
				...
				else
				{
					...
					if (func_115(Local_129.f_9, Local_645, 8f, 1))
					{
						if (Local_129.f_10 == 25 || Local_129.f_10 == 26)
						{
							Local_129.f_18 = MISC::GET_GAME_TIMER();
				...
				if (!bLocal_412)
				{
					bLocal_412 = func_399(Local_645, Local_120, 180f);
				}
				if (func_324(&(Local_129.f_9)))
				{
					iLocal_419 = 1;
			...
			case 2:
				...
				else
				{
					...
					if (!bLocal_412)
					{
						bLocal_412 = func_399(Local_645, Local_120, 0f);
					}
					func_135(4);
				}
				break;
...
int func_399(struct<3> Param0, struct<3> Param3, float fParam6)
{
	...
	if (!func_400(Param0, Param3, fParam6))
	{
		...
		if (iLocal_437 > 0)
		{
			...
			while (iVar0 <= (iLocal_437 - 1))
			{
				func_45(&(Local_150[iVar0 /*19*/]), 1, 0, 1);
				iVar0++;
			}
		}
		if (iLocal_433 > 0)
...
int func_401(int iParam0, struct<3> Param1, int iParam4, int iParam5, float fParam6)
{
	struct<3> Var0;
	var uVar3;
	char[] cVar168[8];
	...
	if (func_24(*iParam0))
	{
		if (!func_64())
		{
			...
			if (SYSTEM::VDIST2(Param1, Var0) < (fParam6 * fParam6))
			{
				...
				{
					uVar3 = 16;
					func_101(&uVar3, 4, *iParam0, "MAUDE", 0, 1);
					cVar168 = "BBCAUD";
					sVar169 = "BBC_loiter";
					func_402(&uVar3, cVar168, sVar169, 4, 0, 0);
					*iParam4 = MISC::GET_GAME_TIMER();
					return 1;
				}
			}
...
void func_402(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
	func_100(uParam0, 145, sParam1, iParam4, iParam5, 0);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
void func_404()
{
	...
	if (func_24(Local_129.f_9))
	{
		...
		{
			case 0:
				if (Local_129.f_10 != 15 && Local_129.f_10 != 16)
				{
					Local_129.f_18 = MISC::GET_GAME_TIMER();
					Local_129.f_10 = 15;
				}
			...
			case 1:
				if (!iLocal_414)
				{
					...
					if (Local_129.f_10 == 13 || Local_129.f_10 == 14)
					{
						...
						else if (func_123(iLocal_439, 5000))
						{
							bVar0 = true;
						}
						if (func_335(Local_129.f_9, Local_645, bVar0, 0, 1, 170))
						{
							func_334();
							Local_129.f_17 = MISC::GET_GAME_TIMER();
							func_332(&uLocal_61, 0, 0, 0);
					...
					else
					{
						if (Local_129.f_10 == 15 || Local_129.f_10 == 16)
						{
							if (!iLocal_385)
							{
								if (!func_64())
								{
									if (func_115(Local_129.f_9, Local_645, 30f, 1))
									{
										if (func_78(&uLocal_464, cLocal_457, sLocal_451, 4, 0, 0, 0))
										{
											Local_129.f_17 = MISC::GET_GAME_TIMER();
											iLocal_427 = MISC::GET_GAME_TIMER();
											iLocal_385 = 1;
						...
						if (func_7(Local_265[0 /*6*/]))
						{
							if ((Local_129.f_10 == 34 || Local_129.f_10 == 17) || Local_129.f_10 == 18)
							{
								if (func_409(Local_129.f_9, Local_265[0 /*6*/], &iLocal_441, 2))
								{
									if (!func_64())
									{
										func_334();
								...
								{
									if (func_408(Local_129.f_9, Local_265[0 /*6*/], Local_265[0 /*6*/].f_5, &Local_648, &iLocal_425, iLocal_436))
									{
										if (Local_129.f_10 == 34)
										{
											Local_129.f_10 = 17;
										}
									}
									func_407(Local_129.f_8, Local_129.f_9, 150f, 0.65f, 0);
									func_406(Local_129.f_9, Local_265[0 /*6*/], Local_645);
								}
							}
						}
						else
...
void func_406(int iParam0, int iParam1, struct<3> Param2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_407(int iParam0, int iParam1, float fParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_408(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	if (iLocal_425 >= iParam5)
	{
		return 1;
	}
	if (!func_115(iParam1, *(uParam3[*iParam4 /*3*/]), 15f, 1))
	{
...
void func_410()
{
	if (func_24(Local_129.f_9))
	{
		func_390(Local_129.f_9, &iLocal_438, 1126825984, 1);
		func_382(Local_129.f_9, &(Local_129.f_19), 1126825984, 7);
		func_370();
		switch (iLocal_117)
		{
			case 0:
				...
				func_327(&(Local_129.f_8), "", "", &iLocal_430, &iLocal_431, 1, 0);
				iLocal_117 = 1;
				break;
				...
				switch (iLocal_118)
				{
					case 2:
						if (!iLocal_394)
						{
							...
							if (func_78(&uLocal_464, cLocal_458, "BBC_T14", 4, 0, 0, 0))
							{
								Local_129.f_17 = MISC::GET_GAME_TIMER();
								iLocal_394 = 1;
							}
						...
						else if (!iLocal_405)
						{
							...
							{
								func_327(&(Local_129.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_430, &iLocal_431, 1, 1);
								iLocal_405 = 1;
							}
						}
						else
						{
							func_366(&(Local_129.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_430, iLocal_431, 1);
							if (func_115(Local_129.f_9, Local_645, 25f, 1) && func_413(Local_129.f_9, Local_645, 10f))
							{
								if (PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), false))
								{
									if (func_412(&(Local_129.f_19)))
									{
										iLocal_118 = 1;
										iLocal_398 = 0;
								...
								else if (func_411(Local_129.f_9, iLocal_438, 0, 1103626240, 1086324736))
								{
									iLocal_118 = 0;
								}
								else if (func_115(Local_129.f_9, Local_645, 5f, 1))
								{
									iLocal_118 = 0;
								}
								else if (func_412(&(Local_129.f_19)))
								{
									if (func_115(Local_129.f_9, Local_645, (25f - 1.5f), 1))
									{
										iLocal_118 = 1;
										iLocal_398 = 0;
										if (Local_129.f_10 != 3 && Local_129.f_10 != 4)
						...
						if (func_375(Local_129.f_9, Local_129.f_19, 25f, 0, 1090519040, 1097859072, 0))
						{
							iLocal_117 = 2;
						}
						break;
					...
					case 1:
						if (!iLocal_398)
						{
							...
							if (func_78(&uLocal_464, cLocal_457, "BB1_J2", 4, 0, 0, 0))
							{
								Local_129.f_17 = MISC::GET_GAME_TIMER();
								iLocal_427 = MISC::GET_GAME_TIMER();
								iLocal_398 = 1;
						...
						{
							if (!func_329("BBC_T14", 1) && !func_329("BB1_J2", 1))
							{
								if (func_326("BBS_APHEND", 0, 0) || func_326("BBS_APHEND2", 0, 0))
								{
									HUD::CLEAR_PRINTS();
								...
								if (func_78(&uLocal_464, cLocal_458, "BBC_T1", 4, 0, 0, 0))
								{
									Local_129.f_17 = MISC::GET_GAME_TIMER();
									iLocal_393 = 1;
								}
						...
						else if (Local_129.f_10 != 3 && Local_129.f_10 != 4)
						{
							if (func_123(Local_129.f_17, 500))
							{
								Local_129.f_18 = MISC::GET_GAME_TIMER();
								Local_129.f_10 = 3;
								iLocal_117 = 2;
...
int func_411(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)
{
	if (func_434(iParam0))
	{
		if (!func_371(iParam1, 10))
		{
			if (bParam2)
			{
				if (!func_115(Local_129.f_9, Local_645, fParam3, 1))
				{
					return 0;
				}
				if (!func_413(iParam0, Local_645, fParam4))
				{
					return 0;
				}
			}
	...
	if (!uParam0->f_7)
	{
		if (func_418(26, func_420(uParam0->f_4), 0))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					func_101(uParam1, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
					if (func_79(uParam1, func_417(uParam0->f_4), func_416(uParam0->f_4), 4, 0, 0, 0))
					{
						uParam0->f_7 = 1;
					}
				}
...
void func_423()
{
	...
	{
		if (ENTITY::IS_ENTITY_DEAD(Local_353.f_0, false) || PED::IS_PED_INJURED(Local_353.f_0))
		{
			iLocal_119 = 3;
			return;
		}
	...
	if (iLocal_115 == 0)
	{
		if (!SYSTEM::VDIST2(Local_645, Local_120) <= ((Local_120.f_3 + 25f) * (Local_120.f_3 + 25f)))
		{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(Local_129.f_9))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_129.f_9, false) && !PED::IS_PED_INJURED(Local_129.f_9))
		{
			...
			{
				if (!func_115(Local_129.f_9, Local_645, 150f, 1))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_129.f_9))
					{
						iLocal_119 = 2;
			...
			{
				if (!func_115(Local_129.f_9, Local_645, 80f, 1))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_129.f_9))
					{
						iLocal_119 = 2;
...
int func_424(bool bParam0)
{
	if (func_24(Local_353.f_0))
	{
		if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(Local_353.f_0) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(Local_353.f_0)) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(Local_353.f_0))
		{
			return 1;
		}
		if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_361.f_0))
				{
					return 1;
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(Local_373.f_0))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_373.f_0))
				{
					return 1;
				}
			}
			if (ENTITY::DOES_ENTITY_EXIST(Local_367.f_0))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_367.f_0))
				{
					return 1;
				}
			}
		}
		if (PED::HAS_PED_RECEIVED_EVENT(Local_353.f_0, 61))
		{
			return 1;
		}
		if (PED::IS_PED_RAGDOLL(Local_353.f_0))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(Local_353.f_0, PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, false, true, 0))
			{
				return 1;
			}
		}
		if (PED::HAS_PED_RECEIVED_EVENT(Local_353.f_0, 51))
		{
			return 1;
		}
		if (func_430(Local_353.f_0, 1126825984))
		{
			return 1;
		}
		if (func_425(Local_353.f_0, 1, 0, 0, 0))
		{
			return 1;
		}
		if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(Local_353.f_0, true), 15f))
		{
			return 1;
		}
		if (PED::HAS_PED_RECEIVED_EVENT(Local_353.f_0, 73))
		{
			return 1;
		}
		if (bParam0)
...
void func_437()
{
	...
	func_22();
	PED::REMOVE_RELATIONSHIP_GROUP(iLocal_629);
	func_555();
	func_135(0);
}
...
void func_438(bool bParam0, bool bParam1)
{
	...
	if (iLocal_115 > 2)
	{
		func_405(0, &uLocal_448);
	}
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_447, false);
	PED::CLEAR_PED_NON_CREATION_AREA();
	func_117(&uLocal_464, 2);
	func_117(&uLocal_464, 3);
	func_117(&uLocal_464, 4);
	func_332(&uLocal_61, 0, 0, 0);
...
void func_439(bool bParam0)
{
	...
	func_440();
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_302.f_5);
}
		...
		if (Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_508(iParam0, &(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_31), &(Global_114963.f_2370.f_539.f_2407[0 /*295*/][iParam1 /*98*/].f_81));
		...
		else if (Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/] == Var5.f_0)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/], Param2, fParam5, false, false, false);
				...
				func_508(iParam0, &(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_31), &(Global_114963.f_2370.f_539.f_2407[1 /*295*/][iParam1 /*98*/].f_81));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_96);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_450(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((func_93(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, false))
	{
		...
		{
			func_183(iParam1, &(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_31), &(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_81));
			if (bParam3)
			{
				...
				Global_114963.f_20127[iParam0 /*43*/].f_31 = func_453(*iParam1);
				...
				func_451(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_114963.f_20127[iParam0 /*43*/].f_1));
				...
				func_451(Global_114963.f_2370.f_539.f_2407[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_114963.f_20127[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_454(int iParam0, bool bParam1, var uParam2)
{
	...
	*uParam2 = 0;
	...
	if (func_499(1))
	{
		if (func_498(iParam0, 1) && VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("speedo")))
		{
			return 1;
		}
	}
	if ((!func_496(iVar0, bParam1, uParam2) && !func_495(PLAYER::PLAYER_ID())) && !func_467(iParam0))
	{
		return 0;
	}
	...
	if ((((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_460(iParam0)) && !bVar1) && !(func_459(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_458(PLAYER::PLAYER_ID()))) && !(func_457(ENTITY::GET_ENTITY_MODEL(iParam0)) && func_455(PLAYER::PLAYER_ID())))
	{
...
int func_455(int iParam0)
{
	if (iParam0 != func_86())
	{
		if (func_349(iParam0, 1, 1))
		{
			...
			{
				return func_456(Global_2658293[iParam0 /*468*/].f_325.f_8) == 30;
			}
		}
	}
	return 0;
...
int func_458(int iParam0)
{
	if (iParam0 != func_86())
	{
		if (func_349(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_456(Global_2658293[iParam0 /*468*/].f_325.f_8) == 11;
			}
		}
	}
	return 0;
...
int func_461(int iParam0)
{
	if (iParam0 != func_86())
	{
		if (func_349(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_456(Global_2658293[iParam0 /*468*/].f_325.f_8) == 26;
			}
		}
	}
	return 0;
...
int func_462(int iParam0)
{
	if (iParam0 != func_86())
	{
		if (func_349(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_456(Global_2658293[iParam0 /*468*/].f_325.f_8) == 13;
			}
		}
	}
	return 0;
...
int func_463(int iParam0)
{
	if (iParam0 != func_86())
	{
		if (func_349(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_456(Global_2658293[iParam0 /*468*/].f_325.f_8) == 7;
			}
		}
	}
	return 0;
...
int func_464(int iParam0)
{
	...
	if ((((!func_466(PLAYER::PLAYER_ID()) && iParam0 != joaat("thruster")) && iParam0 != joaat("avenger")) && iParam0 != func_465(1)) && !bVar0)
	{
		return 0;
	}
	return 1;
...
int func_468(int iParam0)
{
	...
	if (func_471(PLAYER::PLAYER_ID()) && ((((!func_464(ENTITY::GET_ENTITY_MODEL(iParam0)) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel1"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("openwheel2"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula"))) || VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("formula2"))))
	{
		return 0;
	}
...
int func_469(int iParam0)
{
	...
	{
		iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
		if ((VEHICLE::IS_BIG_VEHICLE(iParam0) && !func_460(iParam0)) || func_470(iVar0))
		{
			return 1;
		}
		switch (iVar0)
...
int func_471(int iParam0)
{
	...
	if (func_495(iParam0) && Global_2658293[iParam0 /*468*/].f_325.f_11 == iParam0)
	{
		return 1;
	}
	return 0;
...
int func_485(int iParam0)
{
	if (PLAYER::PLAYER_ID() != func_86())
	{
		...
		if (((func_489(PLAYER::PLAYER_ID(), 1, 0) && Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_260.f_39 > 0) || BitTest(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_260.f_37, 14)) || BitTest(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_260.f_37, 11))
		{
			return 0;
		}
		if (DECORATOR::DECOR_IS_REGISTERED_AS_TYPE("Player_Vehicle", 3))
		{
			if (DECORATOR::DECOR_EXIST_ON(iParam0, "Player_Vehicle"))
			{
				if (DECORATOR::DECOR_GET_INT(iParam0, "Player_Vehicle") == NETWORK::NETWORK_HASH_FROM_PLAYER_HANDLE(PLAYER::PLAYER_ID()))
				{
					if (func_487() != -1 && func_487() < 607)
					{
						if (!func_486(iParam0) || ENTITY::GET_ENTITY_MODEL(iParam0) != Global_1583771[func_487() /*143*/].f_66)
						{
							return 1;
						}
...
int func_487()
{
	return Global_2359296[func_488() /*5574*/].f_681.f_2;
}
...
{
	if (iParam0 != func_86() && func_349(iParam0, 1, 1))
	{
...
int func_493(int iParam0)
{
	if (iParam0 != func_86())
	{
		if (func_349(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1 && Global_2658293[iParam0 /*468*/].f_325.f_11 != func_86())
			{
				return func_456(Global_2658293[iParam0 /*468*/].f_325.f_8) == 5;
			}
		}
	}
	return 0;
...
int func_494(int iParam0)
{
	if (iParam0 != func_86())
	{
		if (func_349(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1 && Global_2658293[iParam0 /*468*/].f_325.f_11 != func_86())
			{
				return func_456(Global_2658293[iParam0 /*468*/].f_325.f_8) == 8;
			}
		}
	}
	return 0;
...
int func_495(int iParam0)
{
	if (iParam0 != func_86())
	{
		if (func_349(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_456(Global_2658293[iParam0 /*468*/].f_325.f_8) == 9;
			}
		}
	}
	return 0;
...
bool func_499(bool bParam0)
{
	...
	return func_500(PLAYER::PLAYER_ID()) == 0;
}

int func_500(int iParam0)
{
	if (func_504(iParam0) == 373)
	{
		return func_501(iParam0, 373);
	}
	return -1;
}
...
{
	if (func_483(iParam0, 1) && !func_484(iParam0))
	{
		return 1;
	}
	switch (iParam0)
...
void func_517(int iParam0, int iParam1)
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_99792[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_99792[iVar0]) == func_171(iParam0, iParam1))
				{
...
void func_519(int iParam0)
{
	...
	if (func_170(&(Global_79127.f_555[0 /*21*/]), iParam0))
	{
		...
		if (BitTest(Global_79127.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_176(iParam0, 0)) && Global_80036.f_66 == 0) && Global_114963.f_32759.f_1958[Global_79127.f_555[0 /*21*/].f_14] != 0) && Global_114963.f_32759.f_1958[Global_79127.f_555[0 /*21*/].f_14] > 3) && (!func_520(0, Global_79127.f_555[0 /*21*/].f_12) || !func_520(1, Global_79127.f_555[0 /*21*/].f_12)))
			{
				func_177(&(Global_114963.f_32759.f_69[Global_79127.f_555[0 /*21*/].f_14 /*78*/]), &Global_80036);
...
int func_520(int iParam0, int iParam1)
{
	...
	if (iParam0 < 0 || iParam0 >= func_521(&(Global_114963.f_32759.f_5038[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_142(Global_114963.f_32759.f_5038[iVar0 /*157*/][iParam0 /*78*/].f_66, 0, -1);
}
...
{
	return func_523(&(Global_108504.f_2890), Param0, fParam3, 0);
}
...
int func_525(int iParam0, struct<3> Param1, bool bParam4)
{
	...
	{
		case joaat("cargobob"):
			if (func_527(iParam0, Global_79127.f_139[38], 0))
			{
				func_519(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_527(iParam0, Global_79127.f_139[43], 1))
			{
				func_519(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_527(iParam0, uVar1[iVar6], 1) && func_526(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam4 || func_180(Param1, 0f, 0f, 0f, 0)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, true), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], true), true) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_526(struct<3> Param0, struct<3> Param3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_528(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		if ((((func_530() && VEHICLE::IS_THIS_MODEL_A_PLANE(uParam1->f_66)) && VEHICLE::GET_VEHICLE_HAS_LANDING_GEAR(iParam0)) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, joaat("avenger"))) && !VEHICLE::IS_VEHICLE_MODEL(iParam0, func_465(1)))
		{
			if (!BitTest(uParam1->f_77, 23))
			{
				if (!BitTest(uParam1->f_77, 22) && func_529(iParam0, 5f))
				{
...
int func_529(int iParam0, float fParam1)
{
	struct<3> Var0;
	float fVar3;
...
int func_530()
{
	...
	if (func_533(7))
	{
		if (func_532(Global_2673273.f_4.f_16) || func_531(Global_2673273.f_4.f_16))
		{
			return 0;
		}
	}
...
{
	return func_534(&(Global_2673273.f_194), iParam0);
}

var func_534(var uParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_545(var uParam0)
{
	...
	if (uParam0->f_12.f_66 == joaat("stunt") && func_526(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
bool func_546()
{
	return func_544(&(Global_108504.f_2890));
}

void func_547()
{
	func_548(&(Global_108504.f_2890));
}
...
int func_549(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (iParam2 == 0 && func_551(Global_108504.f_2890.f_12.f_66))
	{
		return 0;
	}
...
bool func_552()
{
	return func_545(&(Global_108504.f_2890));
}
...
void func_555()
{
	...
	PED::ADD_RELATIONSHIP_GROUP("ENEMIES", &iLocal_629);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("player"), iLocal_629);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_629, joaat("player"));
	Var0 = { func_562(Local_120) };
	Var3 = { func_561(Local_120) };
	PED::SET_PED_NON_CREATION_AREA(Var0, Var3);
	iLocal_447 = PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var3, false, true, true, true, 1);
	...
	if (func_24(PLAYER::PLAYER_PED_ID()))
	{
		func_101(&uLocal_464, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(PLAYER::PLAYER_PED_ID(), true);
	}
	if (func_24(Local_129.f_9))
	{
		func_101(&uLocal_464, 3, Local_129.f_9, sLocal_450, 0, 1);
...
void func_556()
{
	...
	if (func_24(Local_129.f_9))
	{
		...
		func_368(Local_129.f_9);
		func_557(Local_129.f_9, "TARGET_", 0);
		Local_129.f_10 = 0;
		PED::SET_PED_DEFAULT_COMPONENT_VARIATION(Local_129.f_9);
		TASK::TASK_PLAY_ANIM(Local_129.f_9, "ODDJOBS@BAILBOND_QUARRY", "prem_producer_argue_a", 8f, -2f, -1, 1, 0f, false, false, false);
		if (!ENTITY::DOES_ENTITY_EXIST(Local_302.f_0))
		{
			Local_302.f_0 = OBJECT::CREATE_OBJECT(joaat("prop_phone_ing"), ENTITY::GET_ENTITY_COORDS(Local_129.f_9, false), true, true, false);
		}
		if (func_434(Local_302.f_0))
		{
			ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_302.f_0, Local_129.f_9, PED::GET_PED_BONE_INDEX(Local_129.f_9, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
		}
	}
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		if (func_24(Local_150[iVar0 /*19*/]))
		{
			func_368(Local_150[iVar0 /*19*/]);
			if (Local_150[iVar0 /*19*/].f_5 != 0)
			{
				WEAPON::GIVE_WEAPON_TO_PED(Local_150[iVar0 /*19*/], Local_150[iVar0 /*19*/].f_5, -1, true, true);
			}
			PED::SET_PED_CONFIG_FLAG(Local_150[iVar0 /*19*/], 137, true);
			func_557(Local_150[iVar0 /*19*/], "BACKUP_", iVar0);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= (iLocal_433 - 1))
	{
		if (func_7(Local_265[iVar0 /*6*/]))
		{
			VEHICLE::SET_VEHICLE_ENGINE_ON(Local_265[iVar0 /*6*/], true, true, false);
		}
		iVar0++;
	}
}
...
int func_558()
{
	...
	iVar0 = 0;
	iVar1 = 0;
	if (func_56(&(Local_129.f_9), Local_129.f_11, Local_129.f_13, Local_129.f_16, 1, 0, 0))
	{
		if (func_24(Local_129.f_9))
		{
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_129.f_9, true);
	...
	{
		iVar2 = 0;
		while (iVar2 <= (iLocal_437 - 1))
		{
			if (func_56(&(Local_150[iVar2 /*19*/]), Local_150[iVar2 /*19*/].f_18, Local_150[iVar2 /*19*/].f_1, Local_150[iVar2 /*19*/].f_4, 0, 0, 0))
			{
				if (func_24(Local_150[iVar2 /*19*/]))
				{
					iVar0++;
					iVar1++;
				}
	...
	if (iVar1 == iLocal_437)
	{
		...
		while (iVar2 <= (iLocal_437 - 1))
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_150[iVar2 /*19*/].f_18);
			iVar2++;
		}
	}
	if (iLocal_433 > 0)
	{
		iVar2 = 0;
		while (iVar2 <= (iLocal_433 - 1))
		{
			if (func_560(&(Local_265[iVar2 /*6*/]), Local_265[iVar2 /*6*/].f_5, Local_265[iVar2 /*6*/].f_1, Local_265[iVar2 /*6*/].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	{
		iVar2 = 0;
		while (iVar2 <= (iLocal_432 - 1))
		{
			if (func_59(&(Local_308[iVar2 /*9*/]), Local_308[iVar2 /*9*/].f_8, Local_308[iVar2 /*9*/].f_1, Local_308[iVar2 /*9*/].f_7, 1))
			{
				ENTITY::FREEZE_ENTITY_POSITION(Local_308[iVar2 /*9*/], true);
				iVar0++;
			}
			iVar2++;
		}
	...
	{
		iVar2 = 0;
		while (iVar2 <= (iLocal_435 - 1))
		{
			if (func_559(&(Local_345[iVar2 /*7*/]), Local_345[iVar2 /*7*/].f_5, Local_345[iVar2 /*7*/].f_2, Local_345[iVar2 /*7*/].f_6, Local_345[iVar2 /*7*/].f_1, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iVar0 == ((((iLocal_437 + iLocal_433) + iLocal_434) + iLocal_432) + iLocal_435) + 1)
	{
		return 1;
	}
	return 0;
...
void func_563()
{
	...
	iVar0 = 0;
	iLocal_128 = 3;
	Local_129.f_11 = joaat("s_m_m_trucker_01");
	Local_129.f_13 = { 2945.036f, 2796.254f, 39.693f };
	Local_129.f_16 = 38.6771f;
	...
	func_9();
	iLocal_437 = 0;
	Local_265[0 /*6*/].f_5 = joaat("landstalker");
	Local_265[0 /*6*/].f_1 = { 2950.07f, 2796.39f, 40.35f };
	Local_265[0 /*6*/].f_4 = 338.45f;
	Local_265[1 /*6*/].f_5 = joaat("bjxl");
	Local_265[1 /*6*/].f_1 = { 2945.97f, 2790.77f, 40.37f };
	Local_265[1 /*6*/].f_4 = 28.22f;
	Local_302.f_5 = joaat("prop_phone_ing");
	iLocal_433 = 2;
	iLocal_434 = 0;
	iLocal_432 = 0;
	iLocal_435 = 0;
	Local_648[0 /*3*/] = { 2962.58f, 2817.19f, 42.29f };
	Local_648[1 /*3*/] = { 2942.482f, 2841.708f, 46.4443f };
	Local_648[2 /*3*/] = { 2909.12f, 2820.88f, 52.9f };
	Local_648[3 /*3*/] = { 2860.14f, 2816.9f, 52.56f };
	Local_648[4 /*3*/] = { 2821.638f, 2893.259f, 45.53f };
	Local_648[5 /*3*/] = { 2768.72f, 2950.61f, 39.78f };
	Local_648[6 /*3*/] = { 2712.31f, 2963.74f, 35.79f };
	Local_648[7 /*3*/] = { 2657.573f, 2981.731f, 38.9122f };
	Local_648[8 /*3*/] = { 2623.295f, 3077.358f, 46.24589f };
	iLocal_436 = 9;
	Local_682 = { 2883.023f, 2807.719f, 53.6941f };
	fLocal_422 = 256.3262f;
	Local_685 = { 2938.96f, 2783.275f, 38.5873f };
	fLocal_423 = 355.8176f;
	Local_688 = { 2947.246f, 2787.406f, 39.4516f };
	fLocal_424 = 306.625f;
	Local_691 = { 0f, 0f, 0f };
	Local_694 = { 0f, 0f, 0f };
	iLocal_118 = 4;
	...
	iLocal_443 = 0;
	iLocal_445 = -1;
	Local_642 = { 2722.661f, 4143.105f, 43.0617f };
	StringCopy(&Local_630, "", 24);
	Local_353.f_6 = func_574(62);
	Local_353.f_1 = { func_573() };
	Local_353.f_4 = func_572();
	Local_361.f_5 = func_571();
	Local_361.f_1 = { func_570() };
	Local_361.f_4 = func_569();
	Local_367.f_5 = func_568();
	Local_367.f_1 = { func_567() };
	Local_367.f_4 = func_566();
	Local_373.f_5 = func_50();
	Local_373.f_1 = { func_49() };
	Local_373.f_4 = func_48();
	Local_379.f_5 = func_47();
	Local_379.f_1 = { func_565() };
	Local_379.f_4 = func_564();
	sLocal_450 = "BailBond1Jumper";
	sLocal_451 = "BB1_J1";
	sLocal_452 = "BB1_J3";
	sLocal_453[0] = "BB1_VC1";
	sLocal_453[1] = "BB1_VC2";
	sLocal_453[2] = "BB1_VC3";
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		iLocal_389[iVar0] = 0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_578()) || Global_114010) || Global_33818) || func_584()) || func_99(8, -1)) || func_583()) || func_582()) || func_576()) || func_577()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_578()) || Global_33818) || func_584()) || func_99(8, -1)) || func_576()) || func_583()) || func_582()) || func_577()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_578()) || Global_114010) || Global_33818) || func_584()) || func_99(8, -1)) || func_576()) || func_583()) || func_582()) || func_577()) || Global_114963.f_7697.f_919[iVar0] == 5) || Global_45468 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_578()) || Global_114010) || Global_33818) || func_584()) || func_99(8, -1)) || func_583()) || func_582()) || func_577()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_578() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_99(8, -1)) || func_577()) || func_581()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_99(8, -1) || func_583()) || func_582()) || func_581()) || func_580())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_578()) || Global_33818) || func_584()) || func_99(8, -1)) || func_582()) || func_576()) || func_577()) || Global_114963.f_7697.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || func_578()) || func_582()) || Global_114010) || Global_33818) || func_584()) || Global_46147) || func_99(8, -1)) || func_576()) || func_581()) || func_577()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), true)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_578()) || Global_114010) || Global_33818) || func_584()) || func_99(8, -1)) || func_576()) || func_581()) || func_583()) || func_582()) || func_577())
						{
							return 0;
						}
						break;
...
{
	return func_586(iParam0, Global_44921);
}
...
int func_596()
{
	...
	iVar0 = func_597(&(Global_102486.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_600()
{
	...
	{
		if (func_590(&(Global_102486.f_3)) > -1)
		{
			return 1;
		}
	}
