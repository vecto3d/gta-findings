...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_1935904)
		{
			if (!Global_1935906)
			{
				Global_1935903 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("OPENING_CREDITS");
				Global_1935906 = 1;
			}
			else if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_1935903))
			{
				if (!Global_1935905)
				{
					GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(Global_1935903, 255, 255, 255, 255, 0);
				}
			}
		}
		if (func_1(&iLocal_92, &(Local_81[0 /*5*/].f_4)))
		{
		}
	}
}
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (iParam0->f_6)
		{
			case 0:
				...
				if (!func_223(&(iParam0->f_15)))
				{
					func_222(&(iParam0->f_15), 0, 0);
				}
				GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&Global_1935903);
				Global_1935904 = 0;
				Global_1935906 = 0;
				Global_1935905 = 0;
				Global_1935907 = 0;
			...
			case 2:
				if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
				{
					if (!BitTest(*iParam0, 4))
					{
						...
						{
							STREAMING::CLEAR_FOCUS();
							STREAMING::NEW_LOAD_SCENE_START(754.2219f, 1226.831f, 356.5081f, func_138(-14.367f, 0f, 157.3524f), 100f, 0);
							func_137(&(iParam0->f_17));
							func_222(&(iParam0->f_17), 0, 0);
							MISC::SET_BIT(iParam0, 4);
						}
					}
					else if (AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_START") && (STREAMING::IS_NEW_LOAD_SCENE_LOADED() || func_136(&(iParam0->f_17), 5000, 0)))
					{
			...
			case 14:
				if (BitTest(*iParam0, 15))
				{
					...
					func_126(iParam0);
					func_125(iParam0, "race_camera_1", "mp_intro_seq@", -2237.39f, -333.52f, 12.47f, 0f, 0f, 0f, 0.1982f, 1065353216);
				...
				{
					func_131("FMIC_RACE1", -1);
					MISC::SET_BIT(iParam0, 5);
				}
				func_134(iParam0, 14);
				if (func_132(iParam0, 14, 0))
				{
					func_122(iParam0, 23539f, 0);
					NETWORK::NETWORK_OVERRIDE_CLOCK_TIME(16, 0, 0);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 15;
				}
			...
			case 15:
				if (BitTest(*iParam0, 15))
				{
					func_125(iParam0, "race_camera_2", "mp_intro_seq@", -2237.39f, -333.52f, 12.47f, 0f, 0f, 0f, 0.39f, 1065353216);
					func_123(iParam0, 15);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				...
				else if (func_110(iParam0) && func_103(iParam0))
				{
					func_101(iParam0);
				}
				func_134(iParam0, 15);
				if (func_132(iParam0, 15, 0))
				{
					func_122(iParam0, 28833.33f, 75f);
					NETWORK::NETWORK_OVERRIDE_CLOCK_TIME(16, 0, 0);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 16;
				}
			...
			case 16:
				if (BitTest(*iParam0, 15))
				{
					func_100(iParam0, "race_camera_3a", "mp_intro_seq@", iParam0->f_92[4], 0f, 0f, -0.1f, 0f, 0f, 0f);
					func_123(iParam0, 16);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				if (!BitTest(iParam0->f_3, 0))
				...
				func_134(iParam0, 16);
				if (func_132(iParam0, 16, 0))
				{
					func_122(iParam0, 29700f, 0);
					NETWORK::NETWORK_OVERRIDE_CLOCK_TIME(16, 0, 0);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 17;
				}
			...
			case 17:
				if (BitTest(*iParam0, 15))
				{
					func_125(iParam0, "race_camera_3b", "mp_intro_seq@", -2237.39f, -333.52f, 12.47f, 0f, 0f, 0f, 0, 1065353216);
				...
				func_134(iParam0, 17);
				if (func_132(iParam0, 17, 0))
				{
					func_122(iParam0, 36450f, 0);
					NETWORK::NETWORK_OVERRIDE_CLOCK_TIME(16, 0, 0);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 18;
				}
			...
			case 18:
				if (BitTest(*iParam0, 15))
				{
					func_125(iParam0, "race_camera_4", "mp_intro_seq@", -2237.39f, -333.52f, 12.47f, 0f, 0f, 0f, 0, 1065353216);
					func_123(iParam0, 18);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				if (!BitTest(iParam0->f_3, 0))
				...
				func_134(iParam0, 18);
				if (func_99() && func_132(iParam0, 18, 0))
				{
					func_122(iParam0, 43650f, 0);
					NETWORK::NETWORK_OVERRIDE_CLOCK_TIME(16, 0, 0);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 19;
				}
			...
			case 19:
				if (BitTest(*iParam0, 15))
				{
					...
					func_125(iParam0, "race_camera_5", "mp_intro_seq@", -2237.39f, -333.52f, 12.47f, 0f, 0f, 0f, 0, 1065353216);
					func_123(iParam0, 19);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				if (!BitTest(iParam0->f_3, 0))
				...
				else
				{
					...
					if (func_110(iParam0) && func_103(iParam0))
					{
						func_101(iParam0);
					}
				}
				...
				func_97(iParam0);
				func_134(iParam0, 19);
				if (func_132(iParam0, 19, 0) && BitTest(iParam0->f_3, 0))
				{
				...
				else if (func_132(iParam0, 19, -4968))
				{
					if (!BitTest(*iParam0, 12))
					{
						HUD::CLEAR_HELP(true);
				...
				else if (func_132(iParam0, 19, -5618))
				{
			...
			case 28:
				...
				func_134(iParam0, 28);
				if ((AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_DRIVE_START") && BitTest(iParam0->f_3, 3)) && func_132(iParam0, 28, 0))
				{
					iParam0->f_6 = 29;
				}
				break;
			...
			case 31:
				...
				if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_CAMERA(false))
				{
					...
					func_123(iParam0, 33);
					func_125(iParam0, "LAMAR_CAR_DRIVE_01", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
				}
				...
				if ((func_74(iParam0) && func_73(iParam0)) && !CUTSCENE::IS_CUTSCENE_PLAYING())
				{
					if (iParam0->f_293)
					{
			...
			case 34:
				...
				func_134(iParam0, 34);
				func_44(iParam0);
				if (func_132(iParam0, 34, 0))
				{
					func_76(iParam0, 18966.65f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 35;
				}
				break;
			...
			case 35:
				...
				if (BitTest(*iParam0, 15))
				{
					func_125(iParam0, "LAMAR_CAR_DRIVE_03", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					if (!ENTITY::IS_ENTITY_DEAD(iParam0->f_35, false))
					{
			...
			case 36:
				...
				func_134(iParam0, 36);
				func_44(iParam0);
				if (func_132(iParam0, 36, 0))
				{
					func_76(iParam0, 42700.96f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 37;
				}
				break;
			...
			case 37:
				...
				if (BitTest(*iParam0, 15))
				{
					func_125(iParam0, "LAMAR_CAR_DRIVE_05", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					if (!ENTITY::IS_ENTITY_DEAD(iParam0->f_35, false))
					{
						ENTITY::SET_ENTITY_VISIBLE(iParam0->f_35, true, false);
					}
				...
				func_134(iParam0, 37);
				func_44(iParam0);
				if (func_132(iParam0, 37, 0))
				{
					func_76(iParam0, 51033.28f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 38;
				}
				break;
			...
			case 38:
				...
				if (BitTest(*iParam0, 15))
				{
					func_125(iParam0, "LAMAR_CAR_DRIVE_07", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					func_123(iParam0, 38);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_134(iParam0, 38);
				func_44(iParam0);
				if (func_132(iParam0, 38, 0))
				{
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 39;
				}
			...
			case 39:
				...
				func_134(iParam0, 39);
				func_44(iParam0);
				if (func_132(iParam0, 39, 0))
				{
					func_76(iParam0, 85050f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 40;
				}
				break;
			...
			case 40:
				...
				if (BitTest(*iParam0, 15))
				{
					func_125(iParam0, "LAMAR_CAR_DRIVE_10", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					STREAMING::SET_SRL_READAHEAD_TIMES(9, 12, 9, 12);
					if (!ENTITY::IS_ENTITY_DEAD(iParam0->f_35, false))
					{
						ENTITY::SET_ENTITY_VISIBLE(iParam0->f_35, true, false);
				...
				func_134(iParam0, 40);
				if (func_44(iParam0) && func_132(iParam0, 40, 0))
				{
					func_76(iParam0, 116366.5f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 41;
				}
				break;
			...
			case 41:
				if (BitTest(*iParam0, 15))
				{
					...
					func_125(iParam0, "LAMAR_CAR_DRIVE_12", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0.235f, 0.75f);
					func_123(iParam0, 41);
					MISC::UNLOAD_CLOUD_HAT("CONTRAILS", 0f);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_134(iParam0, 41);
				if (func_132(iParam0, 41, 0))
				{
					GRAPHICS::RENDER_SHADOWED_LIGHTS_WITH_NO_SHADOWS(true);
					func_76(iParam0, 127166.5f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 42;
				}
				break;
			...
			case 42:
				...
				{
					func_43(iParam0);
					func_125(iParam0, "LAMAR_CAR_DRIVE_14", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					func_123(iParam0, 42);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_134(iParam0, 42);
				if (func_132(iParam0, 42, 0))
				{
					GRAPHICS::RENDER_SHADOWED_LIGHTS_WITH_NO_SHADOWS(false);
					func_76(iParam0, 170800f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 43;
				}
				break;
			...
			case 43:
				if (BitTest(*iParam0, 15))
				{
					func_125(iParam0, "LAMAR_CAR_DRIVE_17", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					func_123(iParam0, 43);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_134(iParam0, 43);
				if (func_132(iParam0, 43, 0))
				{
					STREAMING::SET_SRL_READAHEAD_TIMES(9, 12, 9, 12);
					func_76(iParam0, 191799.8f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 44;
				}
				break;
			...
			case 44:
				if (BitTest(*iParam0, 15))
				{
					func_125(iParam0, "LAMAR_CAR_DRIVE_19", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					func_123(iParam0, 44);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_134(iParam0, 44);
				if (func_132(iParam0, 44, 0))
				{
					func_76(iParam0, 196633.1f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 45;
				}
				break;
			...
			case 45:
				if (BitTest(*iParam0, 15))
				{
					func_125(iParam0, "LAMAR_CAR_DRIVE_20", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					func_123(iParam0, 45);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_134(iParam0, 45);
				if (func_132(iParam0, 45, 0))
				{
					func_76(iParam0, 201466.5f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 46;
				}
				break;
			...
			case 46:
				if (BitTest(*iParam0, 15))
				{
					func_125(iParam0, "LAMAR_CAR_DRIVE_21", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					func_123(iParam0, 46);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_134(iParam0, 46);
				if (func_132(iParam0, 46, 0))
				{
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 47;
				}
			...
			case 47:
				...
				func_134(iParam0, 47);
				if (func_132(iParam0, 47, 0))
				{
					func_76(iParam0, 213066.4f);
					MISC::SET_BIT(iParam0, 15);
					iParam0->f_6 = 48;
				}
				break;
			...
			case 48:
				...
				if (BitTest(*iParam0, 15))
				{
					func_125(iParam0, "LAMAR_CAR_DRIVE_24", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					if (!ENTITY::IS_ENTITY_DEAD(iParam0->f_35, false))
					{
						ENTITY::SET_ENTITY_VISIBLE(iParam0->f_35, true, false);
					}
				...
				func_134(iParam0, 48);
				if (func_132(iParam0, 48, 0))
				{
					MISC::SET_BIT(&(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_140), 3);
			...
			case 49:
				...
				if (BitTest(*iParam0, 15))
				{
					func_125(iParam0, "LAMAR_CAR_DRIVE_25", "mp_intro_seq@", -1038.78f, -2732.61f, 19.08f, 0f, 0f, 0f, 0, 1065353216);
					func_123(iParam0, 49);
					MISC::CLEAR_BIT(iParam0, 15);
				}
				func_134(iParam0, 49);
				if (AUDIO::PREPARE_MUSIC_EVENT("FM_INTRO_DRIVE_END") && func_132(iParam0, 49, 0))
				{
			...
			case 50:
				...
				if (BitTest(*iParam0, 15))
				{
					func_125(iParam0, "LAMAR_CAR_DRIVE_26", "mp_intro_seq@", -197.9f, 301f, 96.4f, 0f, 0f, 180f, 0, 1065353216);
					if (iParam0->f_292)
					{
						STREAMING::END_SRL();
				...
				if (func_132(iParam0, 50, 0) && BitTest(*iParam0, 20))
				{
			...
			case 55:
				...
				else if (func_136(&(iParam0->f_17), 10000, 0))
				{
					if (func_32(iParam0))
					{
						func_126(iParam0);
...
void func_3(bool bParam0)
{
	if (bParam0)
	{
		if (!BitTest(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_140, 18))
		{
			MISC::SET_BIT(&(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_140), 18);
		}
	}
	else if (BitTest(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_140, 18))
	{
		MISC::CLEAR_BIT(&(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_140), 18);
	}
}

void func_4()
{
	GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(Global_1576354, 255, 255, 255, 255, 0);
	if (Global_1576360 == 0)
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_1576354, "SET_BIG_LOGO_VISIBLE");
...
void func_34(bool bParam0)
{
	if (bParam0)
	{
		MISC::SET_BIT(&(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_144), 22);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_144), 22);
	}
}

bool func_35(int iParam0)
{
	return BitTest(Global_1845298[iParam0 /*881*/].f_144, 22);
}
...
void func_36(bool bParam0)
{
	if (bParam0)
	{
		MISC::SET_BIT(&(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_140), 4);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_140), 4);
	}
}
		...
		while (iVar0 < 1)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_98[iVar0]))
			{
				if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_92[iVar0]))
				{
					...
					{
						iParam0->f_98[iVar0] = PED::CREATE_PED_INSIDE_VEHICLE(iParam0->f_92[iVar0], 4, func_70(), -1, false, false);
	...
	if (!BitTest(iParam0->f_3, 10))
	{
		...
		if (STREAMING::HAS_MODEL_LOADED(iVar0))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_36))
			{
				...
				func_75(&(iParam0->f_123), 1, iParam0->f_36, "Lamar", 0, 1);
			}
		}
		if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_36))
		{
...
void func_87(int* iParam0)
{
	...
	while (iVar0 < 7)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0->f_104[iVar0], false))
		{
			...
			CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iParam0->f_104[iVar0], func_88(iVar0), 0, 0, 64);
		}
		iVar0++;
	}
}
...
{
	Global_1576360 = 0;
	if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_1576354))
	{
		GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_1576354, "SET_BIG_LOGO_VISIBLE");
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
		GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_BOOL(false);
		GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
		GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&Global_1576354);
	}
}
...
int func_99()
{
	...
	if (!GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_1576354))
	{
		Global_1576354 = GRAPHICS::REQUEST_SCALEFORM_MOVIE("GTAV_ONLINE");
		return 0;
	}
	return 1;
}

void func_100(int* iParam0, char* sParam1, char* sParam2, int iParam3, struct<3> Param4, struct<3> Param7)
{
...
void func_102()
{
	...
	while (iVar0 < 7)
	{
		CUTSCENE::SET_CUTSCENE_ENTITY_STREAMING_FLAGS(func_88(iVar0), 0, 1);
		iVar0++;
	}
}
...
{
	if ((uParam0->f_295 && uParam0->f_112[iParam1] != -1) && func_106(PLAYER::INT_TO_PLAYERINDEX(uParam0->f_112[iParam1]), 0, 1))
	{
		return 1;
	}
	return 0;
...
int func_107(var uParam0, int iParam1)
{
	...
	{
		return func_91(PLAYER::INT_TO_PLAYERINDEX(uParam0->f_112[iParam1]));
	}
...
void func_108(var uParam0)
{
	...
	while (iVar1 < 32)
	{
		...
		if (func_106(iVar2, 0, 1))
		{
			if (PLAYER::PLAYER_ID() != iVar2)
			{
				if (iVar0 < 4)
				{
					uParam0->f_112[func_109(iVar0)] = iVar1;
					iVar0++;
				}
			}
		}
	...
	if (!BitTest(iParam0->f_3, 0))
	{
		...
		if (func_113(iParam0))
		{
			if (func_112(iParam0))
			{
				...
				while (iVar0 < 8)
				{
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_94(iVar0));
					iVar0++;
				}
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_92());
...
int func_113(var uParam0)
{
	...
	if (!BitTest(uParam0->f_2, 31))
	{
		...
		while (bVar5 < 8)
		{
			func_118(bVar5, &Var1, &fVar4);
			if (!func_117(Var1, 0f, 0f, 0f, 0))
			{
...
void func_121()
{
	...
	while (iVar0 < 8)
	{
		STREAMING::REQUEST_MODEL(func_94(iVar0));
		iVar0++;
	}
}

void func_122(int* iParam0, float fParam1, float fParam2)
{
...
void func_123(int* iParam0, int iParam1)
{
	...
	{
		case 14:
			func_124(iParam0, 0, -2997.174f, 330.9234f, 14.2341f, -15.97f, &iVar1, 1);
			func_124(iParam0, 2, -2983.9f, 423.7414f, 14.4122f, -5.25f, &iVar1, 1);
			break;
		
		case 15:
			func_124(iParam0, 1, -2622.208f, -109.3386f, 19.2643f, 39.34f, &iVar1, 1);
			func_124(iParam0, 3, -2583.95f, -143.6469f, 20.6224f, 48.89f, &iVar1, 1);
			func_124(iParam0, 7, -2552.145f, -169.0495f, 19.8664f, 60.04f, &iVar1, 1);
			func_124(iParam0, 8, -2531.474f, -174.4581f, 19.2269f, 58.09f, &iVar1, 1);
			break;
		...
		case 17:
			func_124(iParam0, 0, -2420.618f, -232.2668f, 15.3525f, 57.71f, &iVar1, 1);
			func_124(iParam0, 2, -2399.709f, -249.2471f, 14.9551f, 58.19f, &iVar1, 1);
			func_124(iParam0, 4, -2568.499f, -153.4655f, 20.4075f, 54.1f, &iVar1, 1);
			func_124(iParam0, 5, -2485.392f, -198.0737f, 17.5783f, 63.83f, &iVar1, 1);
			func_124(iParam0, 6, -2469.139f, -206.5518f, 17.0201f, 60.64f, &iVar1, 1);
			func_124(iParam0, 9, -2408.733f, -238.8328f, 15.2055f, 59.84f, &iVar1, 1);
			break;
		
		case 18:
			func_124(iParam0, 1, -2146.384f, -323.4933f, 12.0429f, 14.8813f, &iVar1, 1);
			func_124(iParam0, 3, -2075.444f, -374.131f, 11.556f, 56.66f, &iVar1, 1);
			func_124(iParam0, 7, -2160.252f, -294.0829f, 12.5163f, 163.95f, &iVar1, 1);
			func_124(iParam0, 8, -2191.429f, -335.8769f, 12.7225f, 84.71f, &iVar1, 1);
			break;
		
		case 19:
			func_124(iParam0, 0, -1833.87f, -561.7711f, 11.0989f, 48.11f, &iVar1, 1);
			func_124(iParam0, 1, -1630.587f, -685.6821f, 16.5351f, 58.23f, &iVar1, 1);
			func_124(iParam0, 2, -1668.738f, -662.7587f, 14.7925f, 60.52f, &iVar1, 1);
			func_124(iParam0, 3, -1564.946f, -738.6324f, 10.7672f, 68.32f, &iVar1, 1);
			func_124(iParam0, 4, -1706.507f, -720.8959f, 9.6281f, -132.94f, &iVar1, 1);
			func_124(iParam0, 5, -1626.756f, -769.9745f, 10.2367f, -128.8f, &iVar1, 1);
			func_124(iParam0, 6, -1782.764f, -610.5726f, 10.3008f, 52.34f, &iVar1, 1);
			func_124(iParam0, 7, -1595.258f, -733.587f, 10.8576f, 68.39f, &iVar1, 1);
			func_124(iParam0, 8, -1751.892f, -682.1017f, 9.6795f, -134.89f, &iVar1, 1);
			func_124(iParam0, 9, -1742.098f, -642.5658f, 9.8169f, 48.19f, &iVar1, 1);
			break;
		
		case 33:
			func_124(iParam0, 0, -934.4687f, -2716.038f, 12.7365f, 309.2312f, &iVar1, 0);
			func_124(iParam0, 5, -975.6617f, -2733.517f, 12.8172f, 267.4944f, &iVar1, 0);
			break;
		...
		case 36:
			func_124(iParam0, 6, -850.1183f, -2615.271f, 14.1979f, 327.7461f, &iVar1, 0);
			break;
		...
		case 38:
			func_124(iParam0, 0, -712.0925f, -1983.516f, 25.688f, -167.99f, &iVar1, 0);
			func_124(iParam0, 1, -533.9934f, -2004.727f, 26.9085f, 58.71f, &iVar1, 0);
			func_124(iParam0, 2, -653.3551f, -2047.782f, 27.3566f, -112.14f, &iVar1, 0);
			func_124(iParam0, 3, -663.821f, -1934.85f, 27.1417f, -121.65f, &iVar1, 0);
			func_124(iParam0, 4, -656.6017f, -2009.078f, 30.0188f, -106.53f, &iVar1, 0);
			func_124(iParam0, 5, -502.696f, -2023.068f, 26.2376f, 60.2827f, &iVar1, 0);
			func_124(iParam0, 6, -460.1447f, -2044.032f, 26.2371f, 63.9022f, &iVar1, 0);
			func_124(iParam0, 7, -624.7944f, -1960.975f, 26.29f, 237.3848f, &iVar1, 0);
			func_124(iParam0, 8, -463.0545f, -1998.255f, 36.6533f, 27.85f, &iVar1, 0);
			func_124(iParam0, 9, -473.4099f, -1950.213f, 24.7576f, 37.16f, &iVar1, 0);
			func_124(iParam0, 10, -574.5834f, -1994.9f, 26.2871f, 236.0571f, &iVar1, 0);
			func_124(iParam0, 11, -546.7894f, -2012.781f, 26.3137f, 235.9205f, &iVar1, 0);
			func_124(iParam0, 12, -584.929f, -1970.332f, 26.2437f, 55.8826f, &iVar1, 0);
			func_124(iParam0, 13, -633.4936f, -1937.682f, 26.2413f, 54.9911f, &iVar1, 0);
			func_124(iParam0, 14, -601.2188f, -1941.419f, 17.4986f, 148.6622f, &iVar1, 0);
			break;
		
		case 39:
			func_124(iParam0, 4, -499.2335f, -1906.532f, 16.3534f, 133.5751f, &iVar1, 0);
			func_124(iParam0, 9, -518.8654f, -1918.144f, 16.3355f, 134.6305f, &iVar1, 0);
			break;
		
		case 40:
			func_124(iParam0, 3, -270.2197f, -1499.752f, 29.4309f, -13.07f, &iVar1, 0);
			func_124(iParam0, 7, -313.1461f, -1559.589f, 24.2966f, 145.66f, &iVar1, 0);
			func_124(iParam0, 8, -301.9485f, -1550.052f, 25.5595f, 146.95f, &iVar1, 0);
			break;
		...
		case 43:
			func_124(iParam0, 1, 246.1231f, -238.5137f, 52.9482f, 251.5966f, &iVar1, 0);
			func_124(iParam0, 2, 214.2755f, -202.6486f, 53.5033f, 70.72f, &iVar1, 0);
			func_124(iParam0, 6, 263.1977f, -115.1292f, 69.0366f, 155.02f, &iVar1, 0);
			break;
		
		case 44:
			func_124(iParam0, 0, 392.6941f, 239.868f, 102.5932f, 159.15f, &iVar1, 0);
			func_124(iParam0, 7, 375.2224f, 192.316f, 102.0397f, 160.4247f, &iVar1, 0);
			func_124(iParam0, 12, 377.4185f, 166.3668f, 102.0407f, 337.9135f, &iVar1, 0);
			break;
		
		case 45:
			func_124(iParam0, 1, 267.8363f, 181.3352f, 103.7037f, 71.7724f, &iVar1, 0);
			func_124(iParam0, 3, 216.3894f, 211.8832f, 105.2308f, -19.82f, &iVar1, 0);
			func_124(iParam0, 4, 290.3365f, 172.6194f, 103.7313f, 67.09f, &iVar1, 0);
			func_124(iParam0, 5, 283.6507f, 155.574f, 103.264f, 252.0678f, &iVar1, 0);
			func_124(iParam0, 8, 309.5128f, 156.7439f, 103.3183f, -112.52f, &iVar1, 0);
			func_124(iParam0, 9, 249.0189f, 168.3015f, 104.5421f, -112.05f, &iVar1, 0);
			func_124(iParam0, 11, 313.7221f, 144.8591f, 102.6542f, 249.0527f, &iVar1, 0);
			func_124(iParam0, 13, 171.2032f, 216.4137f, 105.2411f, 69.1778f, &iVar1, 0);
			break;
		...
		case 47:
			func_124(iParam0, 2, 226.2312f, 176.6035f, 104.3217f, 252.5577f, &iVar1, 0);
			func_124(iParam0, 6, 247.4283f, 168.6965f, 103.9378f, 250.2977f, &iVar1, 0);
			func_124(iParam0, 7, 211.375f, 181.7446f, 104.561f, 250.2252f, &iVar1, 0);
			break;
		...
		case 49:
			func_124(iParam0, 2, -192.4192f, 249.71f, 91.7534f, -99.42f, &iVar1, 0);
			func_124(iParam0, 3, -45.3246f, 256.5581f, 105.0516f, 272.9104f, &iVar1, 0);
			func_124(iParam0, 4, -24.1551f, 272.3286f, 106.4563f, 96.6005f, &iVar1, 0);
			func_124(iParam0, 5, 6.5526f, 270.3987f, 108.268f, 84.5591f, &iVar1, 0);
			func_124(iParam0, 6, -124.1576f, 245.0871f, 96.1105f, -89.91f, &iVar1, 0);
			func_124(iParam0, 7, -140.9613f, 262.532f, 94.5308f, 87.51f, &iVar1, 0);
			func_124(iParam0, 9, -83.4766f, 247.5941f, 99.488f, 275.7796f, &iVar1, 0);
			func_124(iParam0, 10, -215.5077f, 252.4543f, 91.0469f, 264.726f, &iVar1, 0);
			break;
...
void func_124(var uParam0, bool bParam1, struct<3> Param2, float fParam5, int* iParam6, bool bParam7)
{
...
void func_125(int* iParam0, char* sParam1, char* sParam2, struct<3> Param3, struct<3> Param6, float fParam9, float fParam10)
{
	if (!CAM::DOES_CAM_EXIST(iParam0->f_8))
	{
		iParam0->f_8 = CAM::CREATE_CAM("DEFAULT_ANIMATED_CAMERA", false);
			...
			while (iVar1 <= 4)
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iParam0->f_98[iVar1]))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_92[iVar1]))
					{
						...
						{
							iParam0->f_98[iVar1] = PED::CREATE_PED_INSIDE_VEHICLE(iParam0->f_92[iVar1], 4, func_70(), -1, false, false);
		...
		if ((STREAMING::HAS_MODEL_LOADED(joaat("asterope")) && STREAMING::HAS_MODEL_LOADED(joaat("sentinel"))) && STREAMING::HAS_MODEL_LOADED(func_70()))
		{
			...
			while (iVar0 < 15)
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_58[iVar0]))
				{
					...
					{
						iParam0->f_74[iVar0] = PED::CREATE_PED_INSIDE_VEHICLE(iParam0->f_58[iVar0], 4, func_70(), -1, false, false);
...
struct<5> func_159(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 243:
			...
			Var0.f_3 = func_161(&(Global_4718592.f_236570[0 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
		
		case 244:
			Var0 = { Global_4718592.f_236570[1 /*160*/].f_16 };
			Var0.f_3 = func_161(&(Global_4718592.f_236570[1 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
		
		case 245:
			Var0 = { Global_4718592.f_236570[2 /*160*/].f_16 };
			Var0.f_3 = func_161(&(Global_4718592.f_236570[2 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
		
		case 246:
			Var0 = { Global_4718592.f_236570[3 /*160*/].f_16 };
			Var0.f_3 = func_161(&(Global_4718592.f_236570[3 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
		
		case 247:
			Var0 = { Global_4718592.f_236570[4 /*160*/].f_16 };
			Var0.f_3 = func_161(&(Global_4718592.f_236570[4 /*160*/]));
			Var0.f_4 = Var0.f_3;
			break;
...
struct<6> func_162(int iParam0, bool bParam1)
{
	struct<6> Var0;
...
int func_163()
{
	return Global_2698552;
}

bool func_164()
{
	return Global_2697070;
}
...
void func_165(bool bParam0, bool bParam1)
{
	if (bParam1)
	{
		MISC::CLEAR_BIT(&(Global_1945897.f_1), 13);
		func_193(bParam0, 0);
	}
	func_191(0);
	func_166(66);
...
void func_166(int iParam0)
{
	...
	if (Global_1575095)
	{
		sVar1 = func_190(iParam0);
		iVar2 = MISC::GET_HASH_KEY(sVar1);
		uVar3 = func_189(&Global_2699700, 1, 0);
		func_188(&Global_2699698, 1, 0);
...
void func_168()
{
	if (Global_2696990)
	{
		...
		{
			Global_2696989 = 1;
			Global_2696998 = MISC::GET_GAME_TIMER();
			Global_2696997 = 1;
			func_169();
		}
	}
...
void func_169()
{
	Global_2733190.f_5852 = MISC::GET_GAME_TIMER();
}
...
int func_170()
{
	...
	if ((Global_2686119.f_6820 || func_187()) || func_186(Global_2673273.f_4.f_16, 1))
	{
		if (Global_2696990)
		{
			if (func_175(0))
			{
				...
				{
					if ((((Global_2686119.f_6844 == 122 || Global_2686119.f_6844 == 123) || Global_2686119.f_6844 == 124) || Global_2686119.f_6844 == 125) || Global_2686119.f_6844 == 154)
					{
						return 1;
					}
					if (Global_2686119.f_6844 > -1)
					{
						iVar0 = func_172(Global_2686119.f_6844);
						if (iVar0 == 24)
						{
							return 1;
						}
					}
					if (func_186(Global_2673273.f_4.f_16, 1))
					{
						return 1;
					}
					if (BitTest(Global_2658293[PLAYER::PLAYER_ID() /*468*/].f_76.f_2, 26))
					{
						return 1;
					}
					if (BitTest(Global_2658293[PLAYER::PLAYER_ID() /*468*/].f_76.f_2, 27))
					{
						return 1;
					}
					if (func_171())
...
{
	if (func_185(PLAYER::PLAYER_ID()) && BitTest(Global_1950702.f_4, 22))
	{
		return 0;
	}
	if (Global_1576363)
	...
	if ((Global_2696991 && func_183()) || Global_2696991 == 0)
	{
		return 1;
	}
	if (Global_2686119.f_6844 == 123 && Global_2696994)
	{
		return 1;
	}
	if (Global_2696992)
	{
		if (Global_2686119.f_6844 == 122)
		{
			return 1;
		}
	}
	...
	if (Global_2696995)
	{
		if (iParam0 == 0)
		{
			if ((Global_2686119.f_6844 == 123 || (Global_2686119.f_6844 == 124 && func_181() == 1)) || Global_2686119.f_6844 == 125)
			{
				return 1;
			}
		}
	}
	if ((Global_2686119.f_6820 || func_179(-1046478848)) && Global_2696996)
	{
		if (iParam0 == 0)
		{
			return 1;
...
{
	return func_178(&(Global_2658293[iParam0 /*468*/].f_447), 0);
}

var func_178(var uParam0, int iParam1)
{
...
int func_185(int iParam0)
{
	if (iParam0 != func_52())
	{
		if (func_106(iParam0, 1, 1))
		{
			...
			{
				return func_172(Global_2658293[iParam0 /*468*/].f_325.f_8) == 13;
			}
		}
	}
	return 0;
...
int func_186(int iParam0, int iParam1)
{
	if (iParam0 != func_52())
	{
		if (iParam1 || func_106(iParam0, 1, 1))
		{
			if (Global_2658293[iParam0 /*468*/].f_325.f_8 != -1)
			{
				return func_172(Global_2658293[iParam0 /*468*/].f_325.f_8) == 33;
			}
		}
	}
	return 0;
...
bool func_187()
{
	return Global_2686119.f_2847.f_235;
}
...
void func_191(int iParam0)
{
	...
	uVar0 = func_192();
	Global_1575021 = iParam0;
}

var func_192()
{
	return Global_1575021;
}
...
void func_208(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	func_209(PLAYER::PLAYER_ID(), 0, iVar0, 0);
	if (bParam5)
	{
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && (PLAYER::IS_PLAYER_PLAYING(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || ((!func_80(PLAYER::PLAYER_ID(), 0) && !func_84()) && !func_83(PLAYER::PLAYER_ID())))
				{
			...
			if (bParam1)
			{
				...
				if (!func_216(iVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar27))
				{
					if (!bVar22)
					{
			...
			else
			{
				if (!func_216(iVar27) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar27))
				{
					...
					if (func_213(Global_4718592.f_197291))
					{
...
void func_217(bool bParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		...
		func_218(joaat("mpply_is_char_spectating"), bParam0);
	}
}
...
void func_224(bool bParam0)
{
	if (bParam0)
	{
		...
		{
			MISC::SET_BIT(&(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_140), 8);
		}
	}
	else if (BitTest(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_140, 8))
	{
		MISC::CLEAR_BIT(&(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_140), 8);
	}
}

bool func_225()
{
	return BitTest(Global_1845298[PLAYER::PLAYER_ID() /*881*/].f_140, 8);
}
...
void func_228(int* iParam0)
{
	...
	else
	{
		...
		if (iParam0->f_6 > 31)
		{
			if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_1935903))
			{
				if (iParam0->f_5 < 23)
				{
					switch (iParam0->f_5)
					{
						case 0:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 33)
								{
									...
									func_232("artdir", "Art Director", 175f, "HUD_COLOUR_FRIENDLY", 1);
									func_231("artdir", "AARON GARBUT", 210f, "|", 1);
									func_230("artdir", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 33, -3390))
							{
						...
						case 1:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (func_132(iParam0, 33, -2940))
								{
									func_233("techdir", 0f, 30f, "left", 0.3f, 0.3f);
									func_232("techdir", "Technical Director", 100f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_231("techdir", "ADAM FOWLER", 185f, "|", 1);
									func_230("techdir", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 33, -450))
							{
						...
						case 2:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 35)
								{
									...
									func_232("assartdir", "Associate Art Directors", 20f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_231("assartdir", "ADAM COCHRANE|MICHAEL KANE", 100f, "|", 1);
						...
						case 3:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 36)
								{
									...
									func_232("asstecdir", "Associate Technical Directors", 0f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_231("asstecdir", "KLAAS SCHILSTRA|PHIL HOOKER", 150f, "|", 1);
									func_230("asstecdir", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 36, -4740))
							{
						...
						case 4:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (func_132(iParam0, 36, -3810))
								{
									func_233("leadprog", 30f, 20f, "right", 0.3f, 0.3f);
									func_232("leadprog", "Lead Programmers", 0f, "HUD_COLOUR_FRIENDLY", 1);
									func_231("leadprog", "DANIEL YELLAND|ROBERT TRICKEY", 145f, "|", 1);
									func_230("leadprog", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 36, -600))
							{
						...
						case 5:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 37)
								{
									...
									func_232("senprog", "Senior Programmers", 20f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_231("senprog", "JOHN HYND|JOHN GURNEY|DAN CONTI|ROSS CHILDS|STEPHEN LaVALLEY", 75f, "|", 1);
									func_230("senprog", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 37, -1350))
							{
						...
						case 6:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 38)
								{
									...
									func_232("prog", "Programmers", 35f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_231("prog", "MIGUEL FREITAS|STUART ROSKELL|ALLAN WALTON|PAU AGUILAR FRUTO", 100f, "|", 1);
									func_230("prog", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 38, -4320))
							{
								func_229("prog", 0.16f);
								iParam0->f_5++;
							}
						...
						case 7:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (func_132(iParam0, 38, -3240))
								{
									...
									func_232("socclub", "Social Club", 0f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_231("socclub", "IAN McFARLAND|KEVIN BACA", 40f, "|", 1);
									func_230("socclub", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 38, -870))
							{
						...
						case 8:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 39)
								{
									...
									func_232("audio", "Audio", 0f, "HUD_COLOUR_FRIENDLY", 1);
									func_231("audio", "MATTHEW SMITH|CRAIG CONNER|ALASTAIR MacGREGOR|JEFFREY WHITCHER", 35f, "|", 1);
									func_230("audio", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 39, -1620))
							{
						...
						case 9:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 40)
								{
									...
									func_232("scrlead", "Script Leads", 0f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_231("scrlead", "BOBBY WRIGHT|KEITH McLEMAN|BRENDA CAREY|ROWAN COCKCROFT|NEIL FERGUSON|RYAN BAKER", 60f, "|", 1);
									func_230("scrlead", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 40, -1470))
							{
						...
						case 10:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 41)
								{
									...
									func_232("script1", "Scripters", 20f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_231("script1", "CONOR McGUIRE|JAMES ADWICK|DAVID WATSON|NEIL BEGGS|WILLIAM KENNEDY", 80f, "|", 1);
									func_230("script1", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 41, -1200))
							{
						...
						case 11:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 42)
								{
									...
									func_232("script2", "Scripters", 20f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_231("script2", "DAVID GENTLES|BEN HINCHLIFFE|KEVIN WONG|CHRISTOPHER SPEIRS|CHRIS McMAHON", 80f, "|", 1);
									func_230("script2", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 42, -1320))
							{
						...
						case 12:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 43)
								{
									...
									func_232("visdes", "Visual Design", 30f, "HUD_COLOUR_FRIENDLY", 1);
									func_231("visdes", "THOMAS DIAKOMICHALIS|KARMEN COKER|LUKE HOWARD| | |", 67f, "|", 1);
									func_232("visdes", "Character Creator", 100f, "HUD_COLOUR_FRIENDLY", 1);
									func_231("visdes", "STUART HANSELL|STEWART WRIGHT|FLAVIUS ALECU", 147f, "|", 1);
									func_230("visdes", 0.05f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 43, -1320))
							{
						...
						case 13:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 44)
								{
									...
									func_232("uides", "UI Design & Development", 0f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_231("uides", "STUART PETRI|STEVE WALSH|GARETH EVANS|JEFFREY KHAN|CHRIS EDWARDS", 110f, "|", 1);
									func_230("uides", 0f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 45, -1650))
							{
						...
						case 14:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 46)
								{
									...
									func_232("concre", "Content Creation", 40f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_231("concre", "CALLUM MUNGALL|CHRIS McCALLUM|JESSE HOLCROFT|JOE STAFFORD", 80f, "|", 1);
									func_231("concre", "JOSHUA MATTYASOVSZKY|MARTIN LOGAN|STEFAN WEBSTER", 80f, "|", 1);
									func_230("concre", 0f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 46, -1950))
							{
						...
						case 15:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 47)
								{
									...
									func_232("devass", "Development Assistants", 0f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_231("devass", "FIONN WRIGHT|KATIE PICA", 100f, "|", 1);
									func_230("devass", 0f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
						...
						case 16:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 48)
								{
									...
									func_232("qasup", "QA Supervisor", 0f, "HUD_COLOUR_FRIENDLY", 1);
									func_231("qasup", "ADAM WHITING| ", 50f, "|", 1);
									func_232("qasup", "Lead Test Analyst", 50f, "HUD_COLOUR_FRIENDLY", 1);
									func_231("qasup", "CHRIS THOMSON", 160f, "|", 1);
									func_230("qasup", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 48, -1320))
							{
						...
						case 17:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (iParam0->f_6 >= 49)
								{
									...
									func_232("senta", "Senior Test Analysts", 30f, "HUD_COLOUR_NET_PLAYER1", 1);
									func_231("senta", "MICHAEL BURTON|ROSS PARKER|SEAN CASEY", 120f, "|", 1);
									func_230("senta", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 49, -5070))
							{
						...
						case 18:
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (func_132(iParam0, 49, -3750))
								{
									func_233("asspro", 20f, 350f, "right", 0.3f, 0.3f);
									func_232("asspro", "Assistant Producer", 0f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_231("asspro", "JOSH NEEDLEMAN", 75f, "|", 1);
									func_230("asspro", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							else if (func_132(iParam0, 49, -720))
							{
							...
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (func_89(iParam0))
								{
									if (CUTSCENE::IS_CUTSCENE_PLAYING() && CUTSCENE::GET_CUTSCENE_TIME() > 2468)
									{
										...
										func_232("animdir", "Animation Director", 110f, "HUD_COLOUR_NET_PLAYER3", 1);
										func_231("animdir", "ROB NELSON", 200f, "|", 1);
								...
								else if (iParam0->f_6 >= 50)
								{
									...
									func_232("animdir", "Animation Director", 0f, "HUD_COLOUR_NET_PLAYER3", 1);
									func_231("animdir", "ROB NELSON", 90f, "|", 1);
									func_230("animdir", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
							...
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (func_89(iParam0))
								{
									if (CUTSCENE::IS_CUTSCENE_PLAYING() && CUTSCENE::HAS_CUTSCENE_CUT_THIS_FRAME())
									{
										...
										func_232("producer", "Producer", 0f, "HUD_COLOUR_FRIENDLY", 1);
										func_231("producer", "ANDY DUTHIE", 20f, "|", 1);
								...
								else if (CUTSCENE::IS_CUTSCENE_PLAYING() && CUTSCENE::GET_CUTSCENE_TIME() > 2452)
								{
									...
									func_232("producer", "Producer", 80f, "HUD_COLOUR_FRIENDLY", 1);
									func_231("producer", "ANDY DUTHIE", 110f, "|", 1);
							...
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (func_89(iParam0))
								{
									if (CUTSCENE::IS_CUTSCENE_PLAYING() && CUTSCENE::GET_CUTSCENE_TIME() > 13265)
									{
										...
										func_232("vpcre", "VP of Creative", 0f, "HUD_COLOUR_NET_PLAYER1", 1);
										func_231("vpcre", "DAN HOUSER", 80f, "|", 1);
							...
							if (!BitTest(iParam0->f_4, iParam0->f_5))
							{
								if (func_89(iParam0))
								{
									if (CUTSCENE::IS_CUTSCENE_PLAYING() && CUTSCENE::GET_CUTSCENE_TIME() > 18077)
									{
										...
										func_232("execpro", "Executive Producer", 70f, "HUD_COLOUR_NET_PLAYER2", 1);
										func_231("execpro", "SAM HOUSER", 165f, "|", 1);
								...
								else if (CUTSCENE::IS_CUTSCENE_PLAYING() && CUTSCENE::GET_CUTSCENE_TIME() > 12358)
								{
									...
									func_232("execpro", "Executive Producer", 100f, "HUD_COLOUR_NET_PLAYER2", 1);
									func_231("execpro", "SAM HOUSER", 190f, "|", 1);
									func_230("execpro", 0.16f);
									MISC::SET_BIT(&(iParam0->f_4), iParam0->f_5);
								}
							}
...
void func_229(char* sParam0, float fParam1)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_1935903, "HIDE");
...
void func_230(char* sParam0, float fParam1)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_1935903, "SHOW_CREDIT_BLOCK");
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(fParam1);
...
void func_231(char* sParam0, char* sParam1, float fParam2, char* sParam3, bool bParam4)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_1935903, "ADD_NAMES_TO_CREDIT_BLOCK");
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
...
void func_232(char* sParam0, char* sParam1, float fParam2, char* sParam3, bool bParam4)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_1935903, "ADD_ROLE_TO_CREDIT_BLOCK");
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
...
void func_233(char* sParam0, float fParam1, float fParam2, char* sParam3, float fParam4, float fParam5)
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_1935903, "SETUP_CREDIT_BLOCK");
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING("STRING");
	HUD::ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(fParam1);
