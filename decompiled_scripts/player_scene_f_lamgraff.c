...
int func_2()
{
	...
	if (!PED::IS_PED_INJURED(Global_102207))
	{
		...
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_102207, &sLocal_263, &cLocal_295, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_102207))
				{
					TASK::STOP_ANIM_PLAYBACK(Global_102207, 0, false);
					TASK::CLEAR_PED_TASKS(Global_102207);
					return 0;
				}
				fVar0 = PED::GET_SYNCHRONIZED_SCENE_PHASE(iLocal_311);
				if (!iLocal_256)
				{
					if (func_3(&uLocal_90, "PRSAUD", "FRAS_IG_7x", 3, 0, 0, 0))
					{
						iLocal_256 = 1;
					}
				}
				...
				else if (fVar0 < 0.4778f)
				{
					if (iLocal_312 == 0)
					{
						iLocal_312 = GRAPHICS::START_PARTICLE_FX_LOOPED_ON_ENTITY("scr_lamgraff_paint_spray", iLocal_257, 0f, 0f, 0f, 0f, 0f, 0f, 1f, false, false, false);
...
int func_27()
{
	...
	if (!PED::IS_PED_INJURED(Global_102207))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_257))
		{
			if (ENTITY::IS_ENTITY_PLAYING_ANIM(Global_102207, &sLocal_263, &cLocal_279, 3))
			{
				if (FIRE::IS_ENTITY_ON_FIRE(Global_102207))
				{
					TASK::STOP_ANIM_PLAYBACK(Global_102207, 0, false);
				...
				else
				{
					...
					{
						iLocal_311 = PED::CREATE_SYNCHRONIZED_SCENE(Local_259, 0f, 0f, fLocal_262, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_311, true);
					}
					TASK::TASK_SYNCHRONIZED_SCENE(Global_102207, iLocal_311, &sLocal_263, &cLocal_295, 8f, -8f, 257, 0, 8f, 0);
					return 1;
				}
			}
			else
			{
				...
				{
					TASK::CLEAR_PED_TASKS(Global_102207);
					PED::CLEAR_RAGDOLL_BLOCKING_FLAGS(Global_102207, 16);
					if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_311))
					{
						iLocal_311 = PED::CREATE_SYNCHRONIZED_SCENE(Local_259, 0f, 0f, fLocal_262, 2);
						PED::SET_SYNCHRONIZED_SCENE_LOOPED(iLocal_311, true);
...
int func_30(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_31(Global_102207) && iParam1 != 0)
		{
			Global_102207 = 0;
		}
	}
...
bool func_32(var uParam0, var uParam1)
{
...
void func_38()
{
	...
	while (!ENTITY::DOES_ENTITY_EXIST(Global_102207) || !STREAMING::HAS_MODEL_LOADED(iLocal_258))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_102207))
	{
		if (!PED::IS_PED_INJURED(Global_102207))
		{
			TASK::TASK_STAND_STILL(Global_102207, -1);
		}
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_102207, joaat("player"));
	}
	ENTITY::SET_ENTITY_AS_MISSION_ENTITY(Global_102207, true, true);
	PED::SET_PED_CONFIG_FLAG(Global_102207, 132, true);
	PED::SET_RAGDOLL_BLOCKING_FLAGS(Global_102207, 16);
	func_40(&Global_102207, Global_97465);
	func_39(&uLocal_90, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	iLocal_257 = OBJECT::CREATE_OBJECT(iLocal_258, ENTITY::GET_ENTITY_COORDS(Global_102207, true), true, true, false);
	ENTITY::ATTACH_ENTITY_TO_ENTITY(iLocal_257, Global_102207, PED::GET_PED_BONE_INDEX(Global_102207, 28422), 0f, 0f, 0f, 0f, 0f, 0f, false, false, false, false, 2, true, 0);
}
...
void func_41()
{
	...
	func_47(iLocal_89, &Local_259, &fLocal_262, &cVar0);
	iLocal_258 = joaat("prop_cs_spray_can");
	Var8.f_1 = -1;
	Var8.f_17 = 4;
	Var8.f_17.f_8 = 4;
	Var8.f_17.f_13 = 4;
	...
	func_44(Var8, &Var117);
	func_42(iLocal_89, &sLocal_263, &cVar237, &cLocal_279, &uVar253, &uVar254);
	StringCopy(&cLocal_295, "Lamar_tagging_EXIT_LOOP_LAMAR", 64);
}

int func_42(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)
{
	*uParam4 = 9;
	*uParam5 = 8;
	switch (iParam0)
...
void func_43(char* sParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)
{
...
int func_44(struct<109> Param0, var uParam109)
{
	uParam109->f_119 = 0;
	switch (Param0.f_2)
	{
		...
		case 80:
			*uParam109 = { Param0 };
			uParam109->f_109 = joaat("script_task_synchronized_scene");
			uParam109->f_110 = joaat("script_task_synchronized_scene");
			func_45(uParam109, 17, joaat("script_task_play_anim"), joaat("script_task_play_anim"), Vector(2.6407f, 8.164f, -14.1564f) + Vector(-1f, 0.03f, -2.16f), (-66f + -56f));
			if (Param0.f_2 == 80)
			{
				func_46(uParam109);
			}
...
void func_45(var uParam0, int iParam1, int iParam2, int iParam3, struct<3> Param4, float fParam7)
{
...
int func_47(int iParam0, var uParam1, var uParam2, char* sParam3)
{
	int iVar0;
...
int func_50(int iParam0, var uParam1, char* sParam2)
{
	struct<3> Var0;
	int iVar3;
	var uVar4;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114963.f_2370.f_539.f_2310[0];
			StringCopy(sParam2, func_54(Global_114963.f_2370.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_114963.f_2370.f_539.f_2310[1];
			StringCopy(sParam2, func_54(Global_114963.f_2370.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_114963.f_2370.f_539.f_2310[2];
			StringCopy(sParam2, func_54(Global_114963.f_2370.f_539.f_2314[2]), 32);
			return 1;
			break;
