...
int func_2()
{
	...
	if (!func_3(&uVar0))
	{
		Var1 = { ENTITY::GET_ENTITY_COORDS(iLocal_90, false) };
		fVar4 = SYSTEM::VDIST2(Local_194 + Local_199, Var1);
		if (fVar4 < (4.5f * 4.5f))
		{
			TASK::TASK_VEHICLE_DRIVE_WANDER(iLocal_90, iLocal_92, fLocal_197, 786599);
			return 1;
		}
	}
	return 0;
...
int func_4()
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_99791))
		{
			...
			if (!func_5(Global_102207, iLocal_92, 2))
			{
				if (fVar1 >= 0.9f)
				{
					PED::SET_PED_INTO_VEHICLE(Global_102207, iLocal_92, 2);
				}
			}
			if (!iLocal_198)
			{
			...
			TASK::TASK_VEHICLE_TEMP_ACTION(iLocal_90, iLocal_92, 6, 50);
		}
		else
		{
			if (!func_5(Global_102207, iLocal_92, 2))
			...
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(iLocal_92, -8f, true);
			SYSTEM::WAIT(100);
			if (!func_3(&uVar0))
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar2);
				TASK::TASK_VEHICLE_TEMP_ACTION(0, iLocal_92, 24, 50);
				TASK::TASK_PAUSE(0, 2000);
				TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, iLocal_92, Local_194 + Local_199, fLocal_197, 0, iLocal_93, 786599, ((4.5f / 2f) - 1f), 10f);
				TASK::CLOSE_SEQUENCE_TASK(iVar2);
				TASK::TASK_PERFORM_SEQUENCE(iLocal_90, iVar2);
...
int func_8(int iParam0, int iParam1)
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_9(Global_102207) && iParam1 != 0)
		{
			Global_102207 = 0;
		}
	}
...
void func_12()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_15(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_13(iVar0) && (!func_17(14) || Global_113909))
			{
...
void func_22()
{
	...
	iLocal_92 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(Local_199 + Local_191, 15f, iLocal_93, 2);
	iVar0 = 0;
	while ((!ENTITY::DOES_ENTITY_EXIST(Global_102207) || !ENTITY::DOES_ENTITY_EXIST(iLocal_92)) || (!STREAMING::HAS_MODEL_LOADED(iLocal_91) && iVar0 < 400))
	{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_92, false))
	{
		...
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_92, 2);
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_92, 5f);
		iLocal_90 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_92, 4, iLocal_91, -1, true, true);
		PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_90, 0);
...
void func_23()
{
	...
	func_44(iLocal_88, &Local_199, &uLocal_202, &cVar0);
	iLocal_91 = joaat("a_m_m_eastsa_02");
	func_29(1, iLocal_88, &iLocal_93, &Local_191, &uVar8, &Local_194, &fLocal_197);
	Var9.f_1 = -1;
	Var9.f_17 = 4;
	Var9.f_17.f_8 = 4;
	Var9.f_17.f_13 = 4;
	...
	Var9.f_0 = 0;
	Var9.f_2 = iLocal_88;
	Var9.f_3 = Global_99939.f_45;
	func_26(Var9, &Var118);
	func_24(iLocal_88, &sLocal_203, &cLocal_219, &cLocal_219, &uVar238, &uVar239);
}
...
int func_31(int iParam0, var uParam1, int iParam2)
{
	...
	if (!func_32(Global_101890[iParam0 /*98*/], 0, -1))
	{
		func_30(iParam0, uParam1, iParam2);
		uParam1->f_91 = iParam2;
		return 1;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_114963.f_2370.f_539.f_2310[0];
			StringCopy(sParam2, func_51(Global_114963.f_2370.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_114963.f_2370.f_539.f_2310[1];
			StringCopy(sParam2, func_51(Global_114963.f_2370.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_114963.f_2370.f_539.f_2310[2];
			StringCopy(sParam2, func_51(Global_114963.f_2370.f_539.f_2314[2]), 32);
			return 1;
			break;
...
void func_52()
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_90, false) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_90, true))
	{
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_90);
	}
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_92, false) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_92, true))
	{
