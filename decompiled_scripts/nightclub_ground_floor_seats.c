...
int func_83()
{
	if (Global_2658293[PLAYER::PLAYER_ID() /*468*/].f_325.f_11 != func_19())
	{
		if (NETWORK::NETWORK_IS_SCRIPT_ACTIVE("nightclub_ground_floor_seats", Global_2658293[PLAYER::PLAYER_ID() /*468*/].f_325.f_11, true, 0))
		{
			return 0;
		}
...
void func_84()
{
	...
	func_85(3, &uLocal_129, 3, 1);
	func_85(5, &uLocal_129, 5, 1);
	func_85(6, &uLocal_129, 6, 2);
	func_85(7, &uLocal_129, 7, 1);
	func_85(8, &uLocal_129, 8, 2);
	func_85(9, &uLocal_129, 9, 1);
}
