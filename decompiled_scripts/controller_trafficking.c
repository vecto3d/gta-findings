...
void __EntryFunction__()
{
	...
	fLocal_43 = 0.17f;
	fLocal_48 = 1E+07f;
	Local_49 = { 2134.06f, 4780.69f, 41.664f };
	iLocal_52 = -1;
	Local_67 = { 2136.133f, 4780.563f, 39.9702f };
	Local_72 = { 2149.737f, 4798.472f, 40.1071f };
	fLocal_75 = 55.4847f;
	...
	while (true)
	{
		...
		if (func_184())
		{
			...
			{
				fLocal_48 = SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_49);
			}
			func_182(&iVar1);
			func_31(&iVar2);
			if (iLocal_64 > 3)
			{
				if (fLocal_48 < 600f)
				{
					if (func_28(0) == 0 && (MISC::GET_GAME_TIMER() - iLocal_98) > 2000)
					{
...
void func_23()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_25(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_13(iVar0) && (!func_24(14) || Global_113909))
			{
...
void func_31(int iParam0)
{
	...
	if (iLocal_70 != 9)
	{
		if (!Global_114963.f_19992.f_13)
		{
			if (Global_114963.f_19992.f_1 == 0 && Global_114963.f_19992.f_2 == 0)
			{
				...
				{
					func_178("MG_TRAF_AVAIL", 0, 0, -1, 10000, 7, 0, 0, 0);
	...
	switch (iLocal_70)
	{
		...
		case 3:
			...
			{
				MISC::CLEAR_AREA_OF_VEHICLES(Local_72, 4f, false, false, false, false, false, false, 0);
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_71))
				{
					VEHICLE::DELETE_VEHICLE(&iLocal_71);
				}
				iLocal_71 = VEHICLE::CREATE_VEHICLE(func_173(), Local_72, fLocal_75, true, true, false);
				AUDIO::SET_VEHICLE_RADIO_ENABLED(iLocal_71, false);
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(func_173());
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_71))
				{
					if (VEHICLE::DOES_EXTRA_EXIST(iLocal_71, 1))
					{
						VEHICLE::SET_VEHICLE_EXTRA(iLocal_71, 1, true);
					}
					if (VEHICLE::DOES_EXTRA_EXIST(iLocal_71, 2))
					{
						VEHICLE::SET_VEHICLE_EXTRA(iLocal_71, 2, false);
					}
					if (VEHICLE::DOES_EXTRA_EXIST(iLocal_71, 3))
					{
						VEHICLE::SET_VEHICLE_EXTRA(iLocal_71, 3, false);
					}
					VEHICLE::SET_VEHICLE_COLOURS(iLocal_71, 0, 0);
				}
				iLocal_70 = 4;
			}
			break;
		...
		case 4:
			...
			if (!bVar0 && !*iParam0)
			{
				...
				if (!iLocal_76)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_45, false))
					{
						iVar1 = PED::GET_VEHICLE_PED_IS_USING(iLocal_45);
						if (iVar1 == iLocal_71)
						{
							iLocal_76 = 1;
			...
			if (*iParam0)
			{
				if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !ENTITY::IS_ENTITY_DEAD(iLocal_71, false))
				{
					PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_71, -1);
				}
			}
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !ENTITY::IS_ENTITY_DEAD(iLocal_71, false))
			{
			...
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_71, false) && !ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					...
					if (iVar2 == iLocal_71)
					{
						if (SYSTEM::VDIST2(Local_72, ENTITY::GET_ENTITY_COORDS(iLocal_45, true)) < 100f)
						{
							SCRIPT::REQUEST_SCRIPT("Traffick_Ground");
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_46) && !ENTITY::IS_ENTITY_DEAD(iLocal_46, false))
							{
								if (ENTITY::GET_ENTITY_MODEL(iLocal_46) != joaat("dune") && ENTITY::GET_ENTITY_MODEL(iLocal_46) != joaat("cuban800"))
								{
									func_144(iLocal_46, 2142.245f, 4823.463f, 40.2769f, 118.4428f, 24, 0);
								}
								else if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
								{
									VEHICLE::SET_PLAYERS_LAST_VEHICLE(iLocal_46);
								}
							}
							iLocal_70 = 6;
						}
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Ground"))
			{
				...
				{
					iVar3 = func_142(&iLocal_52, 6, 9, 0, 0);
					iLocal_62 = 1;
				}
				if (iVar3 == 1)
				{
					...
					Var4.f_85 = 4;
					Var4.f_90 = 6;
					iLocal_47 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Traffick_Ground", &Var4, 97, 64500);
					func_81(16);
					SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("Traffick_Ground");
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_71, true, false);
					ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_71);
		...
		case 7:
			if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_47))
			{
				...
				else
				{
					...
					Global_114963.f_19992.f_12 = iVar101;
					func_1(106, 0, 0);
					Global_114963.f_19992.f_13 = 0;
				}
				*iParam0 = 0;
...
void func_85(char[4] cParam0, int iParam1, int iParam2)
{
	if (Global_102486 != 10 && Global_102486 != 9)
	{
		...
		func_87(&Global_105520, cParam0, 0, "Start", iParam1, iParam2);
		func_86();
		Global_96639 = 0;
	}
}
...
void func_99(int iParam0, bool bParam1)
{
	...
	if (func_13(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_100(iParam0, &(Global_114963.f_2370.f_539.f_298[iVar0 /*477*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_144(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)
{
	struct<60> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false))
	{
		...
		func_164(iParam5, &Var0, Param1, fParam4, func_9(iParam0));
...
void func_146(int iParam0, int iParam1)
{
	...
	func_14(iParam0, &(Global_114963.f_32759.f_5510));
}

int func_147(int iParam0)
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, false)) || func_20(iParam0, 0, 0)) || func_20(iParam0, 1, 0)) || func_20(iParam0, 2, 0)) || func_9(iParam0) != 145) || func_161(iParam0)) || func_160(iParam0)) || func_159(iParam0)) || func_158(iParam0)) || !func_148(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_160(iParam0))
		{
		}
...
void func_164(int iParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)
{
	if (func_163(&(Global_79127.f_555[0 /*21*/]), iParam0))
	{
...
void func_172()
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_46))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
		{
			if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), true), Local_49) < 2500f)
			{
				iLocal_46 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_46))
				{
					iVar0 = ENTITY::GET_ENTITY_MODEL(iLocal_46);
					if (iVar0 == joaat("dune"))
					{
					}
				}
	...
	switch (iLocal_64)
	{
		...
		case 3:
			...
			if (STREAMING::HAS_MODEL_LOADED(joaat("cuban800")))
			{
				...
				{
					MISC::CLEAR_AREA_OF_VEHICLES(Local_67, 8f, false, false, false, false, false, false, 0);
					iLocal_65 = VEHICLE::CREATE_VEHICLE(joaat("cuban800"), Local_67, 25.29f, true, true, false);
					STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("cuban800"));
					VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(iLocal_65, 2);
		...
		case 4:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_65))
			{
				if (ENTITY::IS_ENTITY_DEAD(iLocal_65, false) || ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false))
				{
					iLocal_64 = 9;
					return;
				}
			...
			else if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(joaat("traffick_ground")) == 0)
			{
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_65, false))
				{
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_65, 1);
				}
			}
			if (!bLocal_54)
			{
			...
			if (*iParam0)
			{
				PED::SET_PED_INTO_VEHICLE(iLocal_45, iLocal_65, -1);
			}
			if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID(), false) && !ENTITY::IS_ENTITY_DEAD(iLocal_65, false))
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), false))
				{
					...
					if (iVar2 == iLocal_65)
					{
						...
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_46) && !ENTITY::IS_ENTITY_DEAD(iLocal_46, false))
						{
							if (ENTITY::GET_ENTITY_MODEL(iLocal_46) != joaat("dune") && ENTITY::GET_ENTITY_MODEL(iLocal_46) != joaat("cuban800"))
							{
								if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_46, 2137.12f, 4799.97f, 39.67854f, 2116.64f, 4790.417f, 45.45295f, 25f, false, true, 0))
								{
									func_144(iLocal_46, 2142.245f, 4823.463f, 40.2769f, 118.4428f, 24, 0);
								}
							}
		...
		case 6:
			if (SCRIPT::HAS_SCRIPT_LOADED("Traffick_Air"))
			{
				...
				if (iVar3 == 1)
				{
					...
					iLocal_47 = SYSTEM::START_NEW_SCRIPT("Traffick_Air", 64500);
					func_81(15);
		...
		case 7:
			if (!SCRIPT::IS_THREAD_ACTIVE(iLocal_47))
			{
				...
				else
				{
					...
					Global_114963.f_19992.f_11 = uVar4;
					func_1(105, 0, 0);
					Global_114963.f_19992.f_14 = 0;
					iLocal_64 = 9;
				}
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true) || func_193()) || Global_33818) || func_187()) || func_186(8, -1)) || func_185()) || func_141()) || func_192()) || func_191()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), true)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_193()) || Global_114010) || Global_33818) || func_187()) || func_186(8, -1)) || func_141()) || func_192()) || func_191()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_193() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_186(8, -1)) || func_191()) || func_190()) || Global_114963.f_7697.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_198()
{
	if (!iLocal_97)
	{
		iLocal_96 = PED::ADD_SCENARIO_BLOCKING_AREA(Vector(40.073f, 4788.559f, 2157.109f) - Vector(25f, 25f, 25f), Vector(40.073f, 4788.559f, 2157.109f) + Vector(25f, 25f, 25f), false, true, true, true, 1);
		iLocal_97 = 1;
	}
}
	...
	while (iVar0 < 8)
	{
		if (Global_99394[iVar0 /*17*/] && !Global_99394[iVar0 /*17*/].f_1)
		{
			if (Global_99394[iVar0 /*17*/].f_3 == 0)
			{
				...
				{
					func_202(Global_99394[iVar0 /*17*/].f_5, 1);
				}
			}
		}
		iVar0++;
...
void func_203()
{
	...
	while (iVar0 < 5)
	{
		if (OBJECT::DOES_PICKUP_EXIST(uLocal_84[iVar0]))
		{
			OBJECT::REMOVE_PICKUP(uLocal_84[iVar0]);
		}
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_78[iVar0]))
		{
			OBJECT::DELETE_OBJECT(&(uLocal_78[iVar0]));
		}
		iVar0++;
	}
}
