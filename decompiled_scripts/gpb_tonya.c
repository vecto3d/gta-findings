...
void func_106()
{
	iLocal_53 = joaat("ig_tonya");
	StringCopy(&Local_251, "TOW", 8);
	StringCopy(&Local_253, "TONYA", 16);
	StringCopy(&Local_219, "special_ped@tonya", 64);
	...
	{
		sLocal_320 = "PBTS_INTERACT";
	}
	StringCopy(&Local_329, "TONYA_MIC", 16);
	StringCopy(&Local_333, "TONYA_TRE", 16);
	StringCopy(&Local_337, "", 16);
	StringCopy(&cLocal_341, "special_ped@tonya@base", 64);
	StringCopy(&cLocal_357, "special_ped@tonya@intro", 64);
	bLocal_458 = true;
	iLocal_268 = 13;
	iLocal_464 = 0;
	iLocal_272[0] = 4;
...
int func_107()
{
	if (BitTest(Global_114963.f_18583[58 /*6*/], 0) && !BitTest(Global_114963.f_18583[58 /*6*/], 3))
	{
		return 1;
	}
	return 0;
...
int func_112()
{
	if (BitTest(Global_114963.f_18583[60 /*6*/], 0) && !BitTest(Global_114963.f_18583[60 /*6*/], 3))
	{
		return 0;
	}
	if (BitTest(Global_114963.f_18583[61 /*6*/], 0) && !BitTest(Global_114963.f_18583[61 /*6*/], 3))
	{
		return 0;
	}
	if (BitTest(Global_114963.f_18583[62 /*6*/], 3))
	{
		return 0;
	}
	if ((BitTest(Global_114963.f_18583[58 /*6*/], 2) || BitTest(Global_114963.f_18583[59 /*6*/], 2)) || BitTest(Global_114963.f_18583[62 /*6*/], 2))
	{
		return 1;
	}
	return 0;
...
{
	return func_114(Global_114963.f_20126, uParam0);
}
