#region Local Var
	...
	int iLocal_53 = 0;
	bool bLocal_54 = 0;
	int iLocal_55[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
	int iLocal_64[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
	bool bLocal_73 = 0;
	int iLocal_74 = 0;
	int iLocal_75 = 0;
...
void __EntryFunction__()
{
	...
	func_43();
	func_42(&uLocal_104, 8, 0, "TANNOY", 0, 1);
	while (true)
	{
		SYSTEM::WAIT(0);
		func_41();
				...
				case 0:
					...
					else
					{
						if (iLocal_75)
						{
							...
							while (iLocal_85 < 8)
							{
								if (iLocal_76[iLocal_85])
								{
									if (func_39(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), iLocal_85 + 1, 0, 0))
									{
						...
						{
							bLocal_54 = iLocal_87 + 1;
							if (func_36(bLocal_54, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false)))
							{
								if (!iLocal_55[iLocal_87])
								{
									iLocal_55[iLocal_87] = 1;
								}
								if (func_35(bLocal_54))
								{
									if (!iLocal_64[iLocal_87])
									{
										iLocal_64[iLocal_87] = 1;
									}
									Local_89 = { func_34(bLocal_54) };
									if (SCRIPT::GET_NUMBER_OF_THREADS_RUNNING_THE_SCRIPT_WITH_THIS_HASH(MISC::GET_HASH_KEY(&Local_89)) == 0)
									{
										if (!Global_34031[bLocal_54])
										{
											func_33(bLocal_54, Global_34031[bLocal_54]);
										}
									}
								}
								else if (!Global_34031[bLocal_54])
								{
									if (PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID()))
									{
										...
										if (!bLocal_73)
										{
											if (func_39(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), bLocal_54, 0, 0))
											{
												if ((MISC::GET_GAME_TIMER() - iLocal_95[iLocal_87]) > 8000)
												{
													func_25();
												}
												...
												else if (bLocal_54 != 4)
												{
													if (!iLocal_74)
													{
														if (func_1(&uLocal_104, "FH1AUD", "FH1_TANNOY", 8, 0, 0, 0))
														{
															iLocal_74 = 1;
														}
													}
											...
											{
												iLocal_95[iLocal_87] = MISC::GET_GAME_TIMER();
											}
										}
									}
									else
									{
										...
										if (!bLocal_73)
										{
											if (func_39(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false), bLocal_54, 0, 0))
											{
												if (!bLocal_54 == 4 || (MISC::GET_GAME_TIMER() - iLocal_95[iLocal_87]) > 8000)
												{
													func_25();
												}
											}
							...
							else if (iLocal_55[iLocal_87])
							{
								if (func_35(bLocal_54))
								{
									...
									{
										func_33(bLocal_54, 0);
										iLocal_55[iLocal_87] = 0;
									}
								}
								else if (Global_34031[bLocal_54])
								{
									Global_34031[bLocal_54] = 0;
									iLocal_55[iLocal_87] = 0;
									iLocal_64[iLocal_87] = 0;
									iLocal_74 = 0;
								}
							}
							iLocal_87++;
...
struct<6> func_34(bool bParam0)
{
	return Global_33976[bParam0 /*6*/];
}
...
bool func_36(int iParam0, struct<3> Param1)
{
	return SYSTEM::VDIST2(Param1, func_38(iParam0)) < func_37(iParam0);
}
...
int func_39(struct<3> Param0, bool bParam3, int iParam4, bool bParam5)
{
	struct<3> Var0[15];
	struct<3> Var46[15];
	float fVar92[15];
