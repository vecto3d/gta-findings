...
void func_3()
{
	...
	if (Global_114963.f_9094 || func_19(0))
	{
		if (!func_18())
		{
			iVar0 = func_17();
...
void func_6()
{
	...
	{
		if (func_10(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_9(PLAYER::PLAYER_PED_ID());
			if (func_8(iVar0) && (!func_7(14) || Global_113909))
			{
