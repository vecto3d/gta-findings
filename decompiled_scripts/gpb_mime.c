...
{
	func_50(&uLocal_54, 3, iLocal_257, &Local_253, 0, 1);
	func_33(&uLocal_54, &cLocal_321, "PBMM_ABUSE", 3, 0, 0, 0);
}
...
void func_106()
{
	iLocal_53 = joaat("s_m_y_mime");
	StringCopy(&Local_251, "PBMM", 8);
	StringCopy(&Local_253, "MIME", 16);
	StringCopy(&Local_219, "Special_Ped@mime", 64);
	StringCopy(&Local_235, "Base", 64);
	bLocal_453 = true;
	bLocal_454 = true;
	iLocal_269 = 8;
	sLocal_320 = "";
	StringCopy(&Local_329, "", 16);
	StringCopy(&Local_333, "", 16);
	StringCopy(&Local_337, "", 16);
	StringCopy(&cLocal_341, "special_ped@mime@base", 64);
	StringCopy(&cLocal_357, "special_ped@mime@intro", 64);
	bLocal_456 = false;
	iLocal_268 = 9;
	iLocal_272[0] = 1;
	iLocal_272[1] = 1;
