...
void __EntryFunction__()
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_114050[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_296(&(Global_114050[Var0.f_0 /*10*/].f_9));
			}
		}
		func_280(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_215(Var0.f_0);
		func_208(&iLocal_110, &(Var0.f_9), Var61);
		if (Var0.f_0 == 44)
		{
			func_200(&Var0, Var61, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_111);
			func_199();
		}
		else if (Var0.f_0 == 45)
		{
			func_200(&Var0, Var61, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_112);
			func_197(&Var0);
		}
		if (func_182(&Var0, 0))
		{
...
void func_197(int iParam0)
{
	...
	{
		if (func_138(iParam0->f_28[0]) && !ENTITY::IS_ENTITY_ON_SCREEN(iParam0->f_28[0]))
		{
			if (func_138(PLAYER::PLAYER_PED_ID()) && !func_198(PLAYER::PLAYER_PED_ID(), iParam0->f_28[0], 50f, 1))
			{
...
void func_199()
{
	...
	GRAPHICS::DRAW_SCALEFORM_MOVIE(iLocal_113, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((MISC::GET_GAME_TIMER() - iLocal_115) > 1250)
	{
...
int func_200(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_188(2))
		{
			if (!func_158())
			{
				if ((func_138(PLAYER::PLAYER_PED_ID()) && func_138(iParam0->f_28[0])) && func_207(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
...
int func_216(int iParam0, bool bParam1)
{
	...
	func_121(*iParam0, &Var0);
	if ((func_253(*iParam0) || func_251(*iParam0)) || Global_80583 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
{
	if ((func_252() && Global_102486.f_11 == 6) && iParam0 == func_180(&(Global_102486.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_257(var uParam0)
{
	...
	switch (iLocal_108)
	{
		...
		case 2:
			...
			{
				if (!func_260(&(uParam0->f_28[0]), 69, 2319.443f, 2583.588f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
