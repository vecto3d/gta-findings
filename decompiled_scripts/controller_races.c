...
void func_1()
{
	...
	if (func_11(8))
	{
		...
		{
			iVar1 = func_10(bVar0);
			if (BitTest(Global_114963.f_24988.f_1, bVar0))
			{
				if (BitTest(Global_114963.f_24988.f_3, bVar0))
				{
					...
					if (fVar2 > 43681f)
					{
						if (!func_7(iVar1))
						{
							if (!Global_114937[bVar0])
							{
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								MISC::CLEAR_BIT(&(Global_114963.f_24988.f_3), bVar0);
							}
							else if ((MISC::GET_GAME_TIMER() - Global_114943[bVar0]) > 60000)
							{
								Global_114937[bVar0] = 0;
								Global_114943[bVar0] = MISC::GET_GAME_TIMER();
								func_3(iVar1);
								func_2(iVar1, 1, 1);
								MISC::CLEAR_BIT(&(Global_114963.f_24988.f_3), bVar0);
							}
...
{
	return BitTest(Global_114963.f_9094.f_99.f_219[0], iParam0);
}
...
void func_13()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_17(Global_114963.f_2370.f_539.f_4321) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_15(iVar0) && (!func_14(14) || Global_113909))
			{
...
void func_19()
{
	...
	if (func_11(7))
	{
		...
		{
			iVar1 = func_22(bVar0);
			if (BitTest(Global_114963.f_24985.f_2, bVar0))
			{
				fVar2 = SYSTEM::VDIST2(func_9(PLAYER::PLAYER_ID()), func_8(iVar1, 0));
				if (fVar2 > 43681f)
				{
					if (!func_7(iVar1))
					{
						if (!Global_114927[bVar0])
						{
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							MISC::CLEAR_BIT(&(Global_114963.f_24985.f_2), bVar0);
						}
						else if ((MISC::GET_GAME_TIMER() - Global_114932[bVar0]) > 60000)
						{
							Global_114927[bVar0] = 0;
							Global_114932[bVar0] = MISC::GET_GAME_TIMER();
							func_3(iVar1);
							func_2(iVar1, 1, 1);
							MISC::CLEAR_BIT(&(Global_114963.f_24985.f_2), bVar0);
						}
			...
			else if (!Global_114963.f_24985)
			{
				if (iVar1 == 82)
				{
					func_21(82);
					func_20(65, 1000);
					Global_114963.f_24985 = 1;
				}
			}
			bVar0++;
		}
...
void func_30()
{
	...
	while (iVar0 <= (4 - 1))
	{
		Global_114927[iVar0] = 0;
		Global_114932[iVar0] = MISC::GET_GAME_TIMER();
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= (5 - 1))
	{
		Global_114937[iVar0] = 0;
		iVar0++;
	}
}
