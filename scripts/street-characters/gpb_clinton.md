...
| Total lines | 3,331 |
| Functions | 120 (5 unique, 115 shared) |
| Unique lines | 876 (26.3% of file) |
...
**Animation dictionaries** (3) - `Special_Ped@Clinton`, `special_ped@Clinton@base`, `special_ped@clinton@intro`

**Animations** (1) - `idle_intro`

**Models and props** (1) - `u_m_y_militarybum`

**Speech contexts** (2) - `GENERIC_CURSE_MED`, `SPEECH_PARAMS_FORCE`

**Text labels** (4) - `NULL`, `AUD`, `PBCL`, `CLINTON`
...
`We_Were_On_A_Ridge`, `Theyll_Kill_Ya`, `When_Your_In_The`, `What_Would_You_Do`, `War_Is_Beauty`, `War_Crimes`, `Pow_Pow_Pow`, `War_Is_Hell`, `Let_Me_Tell_All`, `This_Country_Used_To`, `When_Your_Deep_In`, `I_Kill_For_You`, `Charlies_Coming_Back`, `You_Know_What_They`, `At_Least_You_Didnt`, `_RAND_`, `conversation_offset `, `max_conversation_offset `, `conversation_split_offset `, `max_conversation_split_offsets[conversation_offset] `, `talking offset:`, `Base`, `PBCL_INTERACT`, `PBCL_CONV_M1`, `PBCL_CONV_T1`, `PBCL_CONV_F1`, `Im_In_Hell`, `Living_In_This_Plastic`, `Im_Having_Myself`, `Im_Having_Just`

---

Source: `decompiled_scripts/gpb_clinton.c`
