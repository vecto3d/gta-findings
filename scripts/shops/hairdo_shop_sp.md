...
| Category | Shops |
| Total lines | 172,961 |
| Functions | 1,327 (208 unique, 1,119 shared) |
| Unique lines | 23,614 (13.7% of file) |
...
**Animations** (11) - `player_exitchair`, `player_base`, `player_intro`, `amb@prop_human_seat_chair@male@generic@react_cowering`, `idle_front`, `keeper_idle_a`, `keeper_idle_b`, `keeper_exitchair`, `player_enterchair`, `keeper_enterchair`, `customer_tutorial`
...
**Hashed names** (10) - `v_hairdresser`, `v_barbers`, `vw_dlc_casino_apart`, `m25_2_int_mansion`, `Hair_room`, `V_38_BarberRM`, `Apart_Bedroom_Room`, `RM_POOL_SPA`, `wardrobe_sp`, `torsoDecal`

## Native vocabulary

Most-called natives inside the code unique to this script:

`PLAYER_PED_ID` (263), `ROUND` (256), `TO_FLOAT` (212), `NETWORK_IS_GAME_IN_PROGRESS` (175), `SET_BIT` (82), `IS_PED_INJURED` (74), `PLAYER_ID` (63), `GET_ENTITY_MODEL` (56), `GET_GAME_TIMER` (52), `GET_HASH_KEY` (52), `SET_PED_COMPONENT_VARIATION` (51), `PLAY_SOUND_FRONTEND` (46), `GET_NETWORK_TIME` (41), `DOES_ENTITY_EXIST` (38), `IS_CONTROL_JUST_PRESSED` (38), `GET_PED_DRAWABLE_VARIATION` (34), `IS_STRING_NULL_OR_EMPTY` (31), `IS_CONTROL_PRESSED` (24), `NET_TO_ENT` (19), `ARE_STRINGS_EQUAL` (19), `CLEAR_PED_TASKS` (18), `BEGIN_SCALEFORM_MOVIE_METHOD` (18), `END_SCALEFORM_MOVIE_METHOD` (18), `SET_PED_CONFIG_FLAG` (17), `GET_SCRIPT_TASK_STATUS` (15), `TASK_PLAY_ANIM_ADVANCED` (13), `SET_FORCE_FOOTSTEP_UPDATE` (13), `GET_PED_TEXTURE_VARIATION` (13), `FORCE_PED_AI_AND_ANIMATION_UPDATE` (12), `IS_SYNCHRONIZED_SCENE_RUNNING` (12)
...
`mp_m_freemode_01`, `mp_f_freemode_01`, `ITEM_BACK`, `ITEM_MOV_CAM`, `ITEM_BUY`, `ITEM_SELECT`, `ITEM_ZOOM`, `CSHOP_FAIL`, `keeper_base`, `MotionState_Walk`, `HAIR_UNLOCK`, `keeper_idle_a`, `HAIR_UNLOCK_M`, `keeper_enterchair`, `keeper_exitchair`, `keeper_hair_cut_a`, `HAIR_OPTION_2`, `HAIR_BEARD`, `HAIR_LOCK`, `player_base`, `keeper_idle_b`, `keeper_hair_cut_b`, `HAIR_SOFA_STAND`, `player_zero`, `HAIR_LCKPC`, `ITEM_COST`, `ITEM_B_OPACITY`, `DEFAULT_SCRIPTED_CAMERA`, `HAIR_SALE`

---

Source: `decompiled_scripts/hairdo_shop_sp.c`
